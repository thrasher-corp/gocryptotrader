...
@Component({
  ...
  templateUrl: './settings-credentials.component.html',
  styleUrls: ['./settings-credentials.component.scss']
})
export class SettingsCredentialsComponent implements OnInit {
