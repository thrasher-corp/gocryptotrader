...
@Component({
  selector: 'app-settings-wallets',
  templateUrl: './settings-wallets.component.html',
  styleUrls: ['./settings-wallets.component.scss']
})
export class SettingsWalletsComponent implements OnInit {
