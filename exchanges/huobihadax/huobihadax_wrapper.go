...
func (h *HUOBIHADAX) GetWebsocket() (*monitor.Websocket, error) {
...
func (h *HUOBIHADAX) SubscribeToWebsocketChannels(channels []monitor.WebsocketChannelSubscription) error {
...
func (h *HUOBIHADAX) UnsubscribeToWebsocketChannels(channels []monitor.WebsocketChannelSubscription) error {
	h.Websocket.RemoveSubscribedChannels(channels)
	return nil
}

// GetSubscriptions returns a copied list of subscriptions
func (h *HUOBIHADAX) GetSubscriptions() ([]monitor.WebsocketChannelSubscription, error) {
