...
var rateLimits = request.RateLimitDefinitions{
	...
	amendOrderEPL:                            request.NewRateLimitWithWeight(time.Second, 10, 1),
	cancelOrderEPL:                           request.NewRateLimitWithWeight(time.Second, 10, 1),
	cancelSpotEPL:                            request.NewRateLimitWithWeight(time.Second, 20, 1),
	cancelAllEPL:                             request.NewWeightedRateLimitByDuration(time.Second),
	cancelAllSpotEPL:                         request.NewRateLimitWithWeight(time.Second, 20, 1),
	createBatchOrderEPL:                      request.NewRateLimitWithWeight(time.Second, 10, 1),
	amendBatchOrderEPL:                       request.NewRateLimitWithWeight(time.Second, 10, 1),
	cancelBatchOrderEPL:                      request.NewRateLimitWithWeight(time.Second, 10, 1),
	getOrderEPL:                              request.NewRateLimitWithWeight(time.Second, 10, 1),
	getOrderHistoryEPL:                       request.NewRateLimitWithWeight(time.Second, 10, 1),
	getPositionListEPL:                       request.NewRateLimitWithWeight(time.Second, 10, 1),
	getExecutionListEPL:                      request.NewRateLimitWithWeight(time.Second, 10, 1),
	getPositionClosedPNLEPL:                  request.NewRateLimitWithWeight(time.Second, 10, 1),
	postPositionSetLeverageEPL:               request.NewRateLimitWithWeight(time.Second, 10, 1),
	setPositionTPLSModeEPL:                   request.NewRateLimitWithWeight(time.Second, 10, 1),
	...
	getAssetUniversalTransferListEPL:         request.NewRateLimitWithWeight(time.Second, 2, 1),
	getAssetAccountCoinBalanceEPL:            request.NewRateLimitWithWeight(time.Second, 2, 1),
	...
	userDeleteAPIEPL:                         request.NewRateLimitWithWeight(time.Second, 5, 1),
	userDeleteSubAPIEPL:                      request.NewRateLimitWithWeight(time.Second, 5, 1),
	userQuerySubMembersEPL:                   request.NewRateLimitWithWeight(time.Second, 10, 1),
	userQueryAPIEPL:                          request.NewRateLimitWithWeight(time.Second, 10, 1),
	getSpotLeverageTokenOrderRecordsEPL:      request.NewRateLimitWithWeight(time.Second, 50, 1),
	spotLeverageTokenPurchaseEPL:             request.NewRateLimitWithWeight(time.Second, 20, 1),
	spotLeverTokenRedeemEPL:                  request.NewRateLimitWithWeight(time.Second, 20, 1),
	getSpotMarginTradeMaxBorrowableEPL:       request.NewRateLimitWithWeight(time.Second, 50, 1),
	getSpotCrossMarginTradeLoanInfoEPL:       request.NewRateLimitWithWeight(time.Second, 50, 1),
	getSpotCrossMarginTradeAccountEPL:        request.NewRateLimitWithWeight(time.Second, 50, 1),
	getSpotCrossMarginTradeOrdersEPL:         request.NewRateLimitWithWeight(time.Second, 50, 1),
	getSpotCrossMarginTradeRepayHistoryEPL:   request.NewRateLimitWithWeight(time.Second, 50, 1),
	spotCrossMarginTradeLoanEPL:              request.NewRateLimitWithWeight(time.Second, 20, 1),
	spotCrossMarginTradeRepayEPL:             request.NewRateLimitWithWeight(time.Second, 20, 1),
	spotCrossMarginTradeSwitchEPL:            request.NewRateLimitWithWeight(time.Second, 20, 1),
