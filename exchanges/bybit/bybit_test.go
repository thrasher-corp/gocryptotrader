...
func TestGetInstrumentInfo(t *testing.T) {
	t.Parallel()
	_, err := ex.GetInstrumentInfo(t.Context(), "spot", "", "", "", "", 0)
	require.NoError(t, err)
	_, err = ex.GetInstrumentInfo(t.Context(), "linear", "", "", "", "", 0)
	require.NoError(t, err)
	_, err = ex.GetInstrumentInfo(t.Context(), "inverse", "", "", "", "", 0)
	require.NoError(t, err)
	_, err = ex.GetInstrumentInfo(t.Context(), "option", "", "", "", "", 0)
	require.NoError(t, err)
	payload, err := ex.GetInstrumentInfo(t.Context(), "linear", "10000000AIDOGEUSDT", "", "", "", 0)
	require.NoError(t, err)
...
func TestGetKlines(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		t.Run(fmt.Sprintf("%s-%s", tc.category, tc.pair), func(t *testing.T) {
			t.Parallel()
			r, err := ex.GetKlines(t.Context(), tc.category, tc.pair.String(), kline.FiveMin, s, e, tc.reqLimit)
			if tc.expError != nil {
...
func TestGetMarkPriceKline(t *testing.T) {
	...
	_, err := ex.GetMarkPriceKline(t.Context(), "linear", usdtMarginedTradablePair.String(), kline.FiveMin, s, e, 5)
	if err != nil {
		t.Fatal(err)
	}
	_, err = ex.GetMarkPriceKline(t.Context(), "linear", usdcMarginedTradablePair.String(), kline.FiveMin, s, e, 5)
	if err != nil {
		t.Fatal(err)
	}
	_, err = ex.GetMarkPriceKline(t.Context(), "inverse", inverseTradablePair.String(), kline.FiveMin, s, e, 5)
	if err != nil {
		t.Fatal(err)
	}
	_, err = ex.GetMarkPriceKline(t.Context(), "option", optionsTradablePair.String(), kline.FiveMin, s, e, 5)
	if err == nil {
...
func TestGetIndexPriceKline(t *testing.T) {
	...
	_, err := ex.GetIndexPriceKline(t.Context(), "linear", usdtMarginedTradablePair.String(), kline.FiveMin, s, e, 5)
	if err != nil {
		t.Fatal(err)
	}
	_, err = ex.GetIndexPriceKline(t.Context(), "linear", usdcMarginedTradablePair.String(), kline.FiveMin, s, e, 5)
	if err != nil {
		t.Fatal(err)
	}
	_, err = ex.GetIndexPriceKline(t.Context(), "inverse", inverseTradablePair.String(), kline.FiveMin, s, e, 5)
	if err != nil {
		t.Fatal(err)
	}
}
...
func TestGetOrderBook(t *testing.T) {
	t.Parallel()
	_, err := ex.GetOrderBook(t.Context(), "spot", spotTradablePair.String(), 100)
	if err != nil {
		t.Fatal(err)
	}
	_, err = ex.GetOrderBook(t.Context(), "linear", usdtMarginedTradablePair.String(), 100)
	if err != nil {
		t.Fatal(err)
	}
	_, err = ex.GetOrderBook(t.Context(), "linear", usdcMarginedTradablePair.String(), 100)
	if err != nil {
		t.Fatal(err)
	}
	_, err = ex.GetOrderBook(t.Context(), "inverse", inverseTradablePair.String(), 100)
	if err != nil {
		t.Fatal(err)
	}
	_, err = ex.GetOrderBook(t.Context(), "option", optionsTradablePair.String(), 0)
	if err != nil {
		t.Fatal(err)
	}
}
...
func TestGetRiskLimit(t *testing.T) {
	t.Parallel()
	_, err := ex.GetRiskLimit(t.Context(), "linear", usdtMarginedTradablePair.String())
	if err != nil {
		t.Error(err)
	}
	_, err = ex.GetRiskLimit(t.Context(), "linear", usdcMarginedTradablePair.String())
	if err != nil {
		t.Error(err)
	}
	_, err = ex.GetRiskLimit(t.Context(), "inverse", inverseTradablePair.String())
	if err != nil {
		t.Error(err)
	}
	_, err = ex.GetRiskLimit(t.Context(), "option", optionsTradablePair.String())
	assert.ErrorIs(t, err, errInvalidCategory)

	_, err = ex.GetRiskLimit(t.Context(), "spot", spotTradablePair.String())
	assert.ErrorIs(t, err, errInvalidCategory)
}
...
func TestUpdateTicker(t *testing.T) {
	t.Parallel()
	_, err := ex.UpdateTicker(t.Context(), spotTradablePair, asset.Spot)
	if err != nil {
		t.Error(err)
	}
	_, err = ex.UpdateTicker(t.Context(), usdtMarginedTradablePair, asset.USDTMarginedFutures)
	if err != nil {
		t.Error(err)
	}
	_, err = ex.UpdateTicker(t.Context(), usdcMarginedTradablePair, asset.USDCMarginedFutures)
	if err != nil {
		t.Error(err)
	}
	_, err = ex.UpdateTicker(t.Context(), inverseTradablePair, asset.CoinMarginedFutures)
	if err != nil {
		t.Error(err)
	}
	_, err = ex.UpdateTicker(t.Context(), optionsTradablePair, asset.Options)
	if err != nil {
		t.Error(err)
	}
}
...
func TestUpdateOrderbook(t *testing.T) {
	t.Parallel()
	var err error
	_, err = ex.UpdateOrderbook(t.Context(), spotTradablePair, asset.Spot)
	if err != nil {
		t.Error(err)
	}
	_, err = ex.UpdateOrderbook(t.Context(), usdcMarginedTradablePair, asset.USDCMarginedFutures)
	if err != nil {
		t.Error(err)
	}
	_, err = ex.UpdateOrderbook(t.Context(), usdtMarginedTradablePair, asset.USDTMarginedFutures)
	if err != nil {
		t.Error(err)
	}

	_, err = ex.UpdateOrderbook(t.Context(), inverseTradablePair, asset.CoinMarginedFutures)
	if err != nil {
		t.Error(err)
	}
	_, err = ex.UpdateOrderbook(t.Context(), optionsTradablePair, asset.Options)
	if err != nil {
		t.Error(err)
	}
}
...
func TestGetHistoricCandles(t *testing.T) {
	...
	_, err := ex.GetHistoricCandles(t.Context(), spotTradablePair, asset.Spot, kline.OneDay, start, end)
	if err != nil {
		t.Error(err)
	}
	_, err = ex.GetHistoricCandles(t.Context(), usdtMarginedTradablePair, asset.USDTMarginedFutures, kline.OneDay, start, end)
	if err != nil {
		t.Error(err)
	}
	_, err = ex.GetHistoricCandles(t.Context(), usdcMarginedTradablePair, asset.USDCMarginedFutures, kline.OneDay, start, end)
	if err != nil {
		t.Error(err)
	}
	_, err = ex.GetHistoricCandles(t.Context(), inverseTradablePair, asset.CoinMarginedFutures, kline.OneHour, start, end)
	if err != nil {
		t.Error(err)
	}
	_, err = ex.GetHistoricCandles(t.Context(), optionsTradablePair, asset.Options, kline.OneHour, start, end)
...
func TestGetHistoricCandlesExtended(t *testing.T) {
	...
	_, err := ex.GetHistoricCandlesExtended(t.Context(), spotTradablePair, asset.Spot, kline.OneMin, startTime, end)
	if err != nil {
		t.Error(err)
	}
	_, err = ex.GetHistoricCandlesExtended(t.Context(), inverseTradablePair, asset.CoinMarginedFutures, kline.OneHour, startTime, end)
	if err != nil {
		t.Error(err)
	}
	_, err = ex.GetHistoricCandlesExtended(t.Context(), usdtMarginedTradablePair, asset.USDTMarginedFutures, kline.OneDay, time.UnixMilli(1692889428738), time.UnixMilli(1693145028738))
	if err != nil {
		t.Error(err)
	}
	_, err = ex.GetHistoricCandlesExtended(t.Context(), optionsTradablePair, asset.Options, kline.FiveMin, startTime, end)
	assert.ErrorIs(t, err, asset.ErrNotSupported)
}
...
func TestCancelAllOrders(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex, canManipulateRealOrders)
	_, err := ex.CancelAllOrders(t.Context(), &order.Cancel{AssetType: asset.Spot, Pair: spotTradablePair})
	if err != nil {
		t.Error(err)
	}
	_, err = ex.CancelAllOrders(t.Context(), &order.Cancel{Exchange: ex.Name, AssetType: asset.USDTMarginedFutures, Pair: usdtMarginedTradablePair})
	if err != nil {
		t.Error(err)
	}
	_, err = ex.CancelAllOrders(t.Context(), &order.Cancel{Exchange: ex.Name, AssetType: asset.CoinMarginedFutures, Pair: inverseTradablePair})
	if err != nil {
		t.Error(err)
	}
	_, err = ex.CancelAllOrders(t.Context(), &order.Cancel{Exchange: ex.Name, AssetType: asset.Options, Pair: optionsTradablePair})
	if err != nil {
		t.Error(err)
	}
	_, err = ex.CancelAllOrders(t.Context(), &order.Cancel{Exchange: ex.Name, AssetType: asset.Futures, Pair: spotTradablePair})
	assert.ErrorIs(t, err, asset.ErrNotSupported)
}
...
func TestGetOrderInfo(t *testing.T) {
	...
	_, err := ex.GetOrderInfo(t.Context(),
...
func TestGetActiveOrders(t *testing.T) {
	...
	_, err := ex.GetActiveOrders(t.Context(), &getOrdersRequestSpot)
	if err != nil {
		t.Error(err)
	}
	...
	_, err = ex.GetActiveOrders(t.Context(), &getOrdersRequestLinear)
	if err != nil {
		t.Error(err)
	}
	...
	_, err = ex.GetActiveOrders(t.Context(), &getOrdersRequestInverse)
	if err != nil {
		t.Error(err)
	}
	...
	_, err = ex.GetActiveOrders(t.Context(), &getOrdersRequestFutures)
	if err != nil {
		t.Error(err)
	}
...
func TestGetOrderHistory(t *testing.T) {
	...
	_, err := ex.GetOrderHistory(t.Context(), &getOrdersRequestSpot)
	if err != nil {
		t.Error(err)
	}
	...
	_, err = ex.GetOrderHistory(t.Context(), &getOrdersRequestUMF)
	if err != nil {
		t.Error(err)
	}
	...
	_, err = ex.GetOrderHistory(t.Context(), &getOrdersRequestCMF)
	if err != nil {
		t.Error(err)
	}
	...
	_, err = ex.GetOrderHistory(t.Context(), &getOrdersRequestFutures)
	if err != nil {
		t.Error(err)
	}
}
...
func TestGetDepositAddress(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex)
	_, err := ex.GetDepositAddress(t.Context(), currency.USDT, "", currency.ETH.String())
	if err != nil {
		t.Error(err)
	}
}
...
func TestGetAvailableTransferChains(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex)
	_, err := ex.GetAvailableTransferChains(t.Context(), currency.USDT)
	if err != nil {
		t.Error(err)
	}
}
...
func TestUpdateTickers(t *testing.T) {
	t.Parallel()
	ctx := t.Context()
	err := ex.UpdateTickers(ctx, asset.Spot)
	if err != nil {
		t.Fatalf("%v %v\n", asset.Spot, err)
	}
	err = ex.UpdateTickers(ctx, asset.USDTMarginedFutures)
	if err != nil {
		t.Fatalf("%v %v\n", asset.USDTMarginedFutures, err)
	}
	err = ex.UpdateTickers(ctx, asset.CoinMarginedFutures)
	if err != nil {
		t.Fatalf("%v %v\n", asset.CoinMarginedFutures, err)
	}
	err = ex.UpdateTickers(ctx, asset.Options)
	if err != nil {
		t.Fatalf("%v %v\n", asset.Options, err)
	}
}
...
func TestGetTickersV5(t *testing.T) {
	t.Parallel()
	_, err := ex.GetTickers(t.Context(), "bruh", "", "", time.Time{})
	require.ErrorIs(t, err, errInvalidCategory)
	_, err = ex.GetTickers(t.Context(), "option", "BTC-26NOV24-92000-C", "", time.Time{})
	require.NoError(t, err)
	_, err = ex.GetTickers(t.Context(), "spot", "", "", time.Time{})
	require.NoError(t, err)
	_, err = ex.GetTickers(t.Context(), "inverse", "", "", time.Time{})
	require.NoError(t, err)
	_, err = ex.GetTickers(t.Context(), "linear", "", "", time.Time{})
	require.NoError(t, err)
	_, err = ex.GetTickers(t.Context(), "option", "", "BTC", time.Time{})
	require.NoError(t, err)
}

func TestGetFundingRateHistory(t *testing.T) {
	t.Parallel()
	_, err := ex.GetFundingRateHistory(t.Context(), "bruh", "", time.Time{}, time.Time{}, 0)
	assert.ErrorIs(t, err, errInvalidCategory)

	_, err = ex.GetFundingRateHistory(t.Context(), "spot", spotTradablePair.String(), time.Time{}, time.Time{}, 100)
	assert.ErrorIs(t, err, errInvalidCategory)

	_, err = ex.GetFundingRateHistory(t.Context(), "linear", usdtMarginedTradablePair.String(), time.Time{}, time.Time{}, 100)
	if err != nil {
		t.Error(err)
	}
	_, err = ex.GetFundingRateHistory(t.Context(), "linear", usdcMarginedTradablePair.String(), time.Time{}, time.Time{}, 100)
	if err != nil {
		t.Error(err)
	}
	_, err = ex.GetFundingRateHistory(t.Context(), "inverse", inverseTradablePair.String(), time.Time{}, time.Time{}, 100)
	if err != nil {
		t.Error(err)
	}
	_, err = ex.GetFundingRateHistory(t.Context(), "option", optionsTradablePair.String(), time.Time{}, time.Time{}, 100)
	assert.ErrorIs(t, err, errInvalidCategory)
}

func TestGetPublicTradingHistory(t *testing.T) {
	t.Parallel()
	_, err := ex.GetPublicTradingHistory(t.Context(), "spot", spotTradablePair.String(), "", "", 30)
	if err != nil {
		t.Error(err)
	}
	_, err = ex.GetPublicTradingHistory(t.Context(), "linear", usdtMarginedTradablePair.String(), "", "", 30)
	if err != nil {
		t.Error(err)
	}
	_, err = ex.GetPublicTradingHistory(t.Context(), "linear", usdcMarginedTradablePair.String(), "", "", 30)
	if err != nil {
		t.Error(err)
	}
	_, err = ex.GetPublicTradingHistory(t.Context(), "inverse", inverseTradablePair.String(), "", "", 30)
	if err != nil {
		t.Error(err)
	}
	_, err = ex.GetPublicTradingHistory(t.Context(), "option", optionsTradablePair.String(), "BTC", "", 30)
	if err != nil {
		t.Error(err)
	}
}
...
func TestGetOpenInterestData(t *testing.T) {
	t.Parallel()
	_, err := ex.GetOpenInterestData(t.Context(), "spot", spotTradablePair.String(), "5min", time.Time{}, time.Time{}, 0, "")
	assert.ErrorIs(t, err, errInvalidCategory)

	_, err = ex.GetOpenInterestData(t.Context(), "linear", usdtMarginedTradablePair.String(), "5min", time.Time{}, time.Time{}, 0, "")
	if err != nil {
		t.Error(err)
	}
	_, err = ex.GetOpenInterestData(t.Context(), "linear", usdcMarginedTradablePair.String(), "5min", time.Time{}, time.Time{}, 0, "")
	if err != nil {
		t.Error(err)
	}
	_, err = ex.GetOpenInterestData(t.Context(), "inverse", inverseTradablePair.String(), "5min", time.Time{}, time.Time{}, 0, "")
	if err != nil {
		t.Error(err)
	}
	_, err = ex.GetOpenInterestData(t.Context(), "option", optionsTradablePair.String(), "5min", time.Time{}, time.Time{}, 0, "")
	assert.ErrorIs(t, err, errInvalidCategory)
}
...
func TestGetHistoricalVolatility(t *testing.T) {
	...
	_, err := ex.GetHistoricalVolatility(t.Context(), "option", "", 123, start, end)
	if err != nil {
		t.Error(err)
	}
	_, err = ex.GetHistoricalVolatility(t.Context(), "spot", "", 123, start, end)
	assert.ErrorIs(t, err, errInvalidCategory)
}

func TestGetInsurance(t *testing.T) {
	t.Parallel()
	_, err := ex.GetInsurance(t.Context(), "")
	if err != nil {
		t.Error(err)
	}
}
...
func TestGetDeliveryPrice(t *testing.T) {
	t.Parallel()
	_, err := ex.GetDeliveryPrice(t.Context(), "spot", spotTradablePair.String(), "", "", 200)
	assert.ErrorIs(t, err, errInvalidCategory)

	_, err = ex.GetDeliveryPrice(t.Context(), "linear", "", "", "", 200)
	if err != nil {
		t.Error(err)
	}
	_, err = ex.GetDeliveryPrice(t.Context(), "inverse", "", "", "", 200)
	if err != nil {
		t.Error(err)
	}
	_, err = ex.GetDeliveryPrice(t.Context(), "option", "", "BTC", "", 200)
	if err != nil {
		t.Error(err)
	}
}
...
func TestUpdateOrderExecutionLimits(t *testing.T) {
	t.Parallel()
	err := ex.UpdateOrderExecutionLimits(t.Context(), asset.Futures)
	assert.ErrorIs(t, err, asset.ErrNotSupported)
	err = ex.UpdateOrderExecutionLimits(t.Context(), asset.Options)
	assert.NoError(t, err)
	err = ex.UpdateOrderExecutionLimits(t.Context(), asset.USDCMarginedFutures)
	assert.NoError(t, err)
	err = ex.UpdateOrderExecutionLimits(t.Context(), asset.USDTMarginedFutures)
	assert.NoError(t, err)

	err = ex.UpdateOrderExecutionLimits(t.Context(), asset.Spot)
	assert.NoError(t, err)
	availablePairs, err := ex.GetAvailablePairs(asset.Spot)
	if err != nil {
		t.Fatal("Bybit GetAvailablePairs() error", err)
	}
	for x := range availablePairs {
		var limits order.MinMaxLevel
		limits, err = ex.GetOrderExecutionLimits(asset.Spot, availablePairs[x])
		require.NoError(t, err)
...
func TestPlaceOrder(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex, canManipulateRealOrders)
	ctx := t.Context()
	_, err := ex.PlaceOrder(ctx, nil)
	require.ErrorIs(t, err, errNilArgument)

	_, err = ex.PlaceOrder(ctx, &PlaceOrderParams{})
	...
	_, err = ex.PlaceOrder(t.Context(), &PlaceOrderParams{
		Category:         "spot",
		Symbol:           spotTradablePair,
		Side:             "buy",
		OrderType:        "limit",
	...
	_, err = ex.PlaceOrder(t.Context(), arg)
	if err != nil {
		t.Error(err)
	}
	// Spot TP/SL order
...
func TestAmendOrder(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex, canManipulateRealOrders)
	_, err := ex.AmendOrder(t.Context(), nil)
	require.ErrorIs(t, err, errNilArgument)

	_, err = ex.AmendOrder(t.Context(), &AmendOrderParams{})
...
func TestCancelTradeOrder(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex, canManipulateRealOrders)
	_, err := ex.CancelTradeOrder(t.Context(), nil)
	require.ErrorIs(t, err, errNilArgument)

	_, err = ex.CancelTradeOrder(t.Context(), &CancelOrderParams{})
	require.ErrorIs(t, err, errEitherOrderIDOROrderLinkIDRequired)
...
func TestGetOpenOrders(t *testing.T) {
	...
	_, err := ex.GetOpenOrders(t.Context(), "", "", "", "", "", "", "", "", 0, 100)
	require.ErrorIs(t, err, errCategoryNotSet)

	_, err = ex.GetOpenOrders(t.Context(), "spot", "", "", "", "", "", "", "", 0, 0)
	if err != nil {
		t.Error(err)
	}
}
...
func TestCancelAllTradeOrders(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex, canManipulateRealOrders)
	_, err := ex.CancelAllTradeOrders(t.Context(), nil)
	require.ErrorIs(t, err, errNilArgument)

	_, err = ex.CancelAllTradeOrders(t.Context(), &CancelAllOrdersParam{})
	require.ErrorIs(t, err, errCategoryNotSet)

	_, err = ex.CancelAllTradeOrders(t.Context(), &CancelAllOrdersParam{Category: "option"})
	if err != nil {
		t.Error(err)
	}
}
...
func TestGetTradeOrderHistory(t *testing.T) {
	...
	_, err := ex.GetTradeOrderHistory(t.Context(), "", "", "", "", "", "", "", "", "", start, end, 100)
	require.ErrorIs(t, err, errCategoryNotSet)

	_, err = ex.GetTradeOrderHistory(t.Context(), "spot", spotTradablePair.String(), "", "", "BTC", "", "StopOrder", "", "", start, end, 100)
	if err != nil {
		t.Error(err)
	}
}
...
func TestPlaceBatchOrder(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex, canManipulateRealOrders)
	_, err := ex.PlaceBatchOrder(t.Context(), nil)
	require.ErrorIs(t, err, errNilArgument)

	_, err = ex.PlaceBatchOrder(t.Context(), &PlaceBatchOrderParam{})
	require.ErrorIs(t, err, errCategoryNotSet)
...
func TestBatchAmendOrder(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex, canManipulateRealOrders)
	_, err := ex.BatchAmendOrder(t.Context(), "linear", nil)
	require.ErrorIs(t, err, errNilArgument)

	_, err = ex.BatchAmendOrder(t.Context(), "", []BatchAmendOrderParamItem{
		{
			Symbol:                 optionsTradablePair,
	...
	_, err = ex.BatchAmendOrder(t.Context(), "option", []BatchAmendOrderParamItem{
		{
			Symbol:                 optionsTradablePair,
			OrderImpliedVolatility: "6.8",
			OrderID:                "b551f227-7059-4fb5-a6a6-699c04dbd2f2",
...
func TestCancelBatchOrder(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex, canManipulateRealOrders)
	_, err := ex.CancelBatchOrder(t.Context(), nil)
	require.ErrorIs(t, err, errNilArgument)

	_, err = ex.CancelBatchOrder(t.Context(), &CancelBatchOrder{})
	require.ErrorIs(t, err, errInvalidCategory)

	_, err = ex.CancelBatchOrder(t.Context(), &CancelBatchOrder{Category: cOption})
	require.ErrorIs(t, err, errNoOrderPassed)
...
func TestGetBorrowQuota(t *testing.T) {
	...
	_, err := ex.GetBorrowQuota(t.Context(), "", "BTCUSDT", "Buy")
	require.ErrorIs(t, err, errCategoryNotSet)

	_, err = ex.GetBorrowQuota(t.Context(), "spot", "", "Buy")
	require.ErrorIs(t, err, errSymbolMissing)

	_, err = ex.GetBorrowQuota(t.Context(), "spot", spotTradablePair.String(), "")
	assert.ErrorIs(t, err, order.ErrSideIsInvalid)

	_, err = ex.GetBorrowQuota(t.Context(), "spot", spotTradablePair.String(), "Buy")
	if err != nil {
		t.Error(err)
	}
}
...
func TestSetDisconnectCancelAll(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex, canManipulateRealOrders)
	err := ex.SetDisconnectCancelAll(t.Context(), nil)
	require.ErrorIs(t, err, errNilArgument)

	err = ex.SetDisconnectCancelAll(t.Context(), &SetDCPParams{TimeWindow: 300})
	if err != nil {
		t.Fatal(err)
	}
}
...
func TestGetPositionInfo(t *testing.T) {
	...
	_, err := ex.GetPositionInfo(t.Context(), "", "", "", "", "", 20)
	require.ErrorIs(t, err, errCategoryNotSet)

	_, err = ex.GetPositionInfo(t.Context(), "spot", "", "", "", "", 20)
	require.ErrorIs(t, err, errInvalidCategory)

	_, err = ex.GetPositionInfo(t.Context(), "linear", "BTCUSDT", "", "", "", 20)
	if err != nil {
		t.Error(err)
	}
	_, err = ex.GetPositionInfo(t.Context(), "option", "BTC-26NOV24-92000-C", "BTC", "", "", 20)
	if err != nil {
		t.Error(err)
	}
}
...
func TestSetLeverageLevel(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex, canManipulateRealOrders)
	err := ex.SetLeverageLevel(t.Context(), nil)
	assert.ErrorIs(t, err, errNilArgument)

	err = ex.SetLeverageLevel(t.Context(), &SetLeverageParams{})
	require.ErrorIs(t, err, errCategoryNotSet)

	err = ex.SetLeverageLevel(t.Context(), &SetLeverageParams{Category: "spot"})
	require.ErrorIs(t, err, errInvalidCategory)

	err = ex.SetLeverageLevel(t.Context(), &SetLeverageParams{Category: "linear"})
	require.ErrorIs(t, err, errSymbolMissing)

	err = ex.SetLeverageLevel(t.Context(), &SetLeverageParams{Category: "linear", Symbol: "BTCUSDT"})
	require.ErrorIs(t, err, errInvalidLeverage)

	err = ex.SetLeverageLevel(t.Context(), &SetLeverageParams{Category: "linear", Symbol: "BTCUSDT", SellLeverage: 3, BuyLeverage: 3})
	if err != nil {
		t.Error(err)
	}
}
...
func TestSwitchTradeMode(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex, canManipulateRealOrders)
	err := ex.SwitchTradeMode(t.Context(), nil)
	assert.ErrorIs(t, err, errNilArgument)

	err = ex.SwitchTradeMode(t.Context(), &SwitchTradeModeParams{})
	require.ErrorIs(t, err, errCategoryNotSet)

	err = ex.SwitchTradeMode(t.Context(), &SwitchTradeModeParams{Category: "spot"})
	require.ErrorIs(t, err, errInvalidCategory)

	err = ex.SwitchTradeMode(t.Context(), &SwitchTradeModeParams{Category: "linear"})
	require.ErrorIs(t, err, errSymbolMissing)

	err = ex.SwitchTradeMode(t.Context(), &SwitchTradeModeParams{Category: "linear", Symbol: usdtMarginedTradablePair.String()})
	require.ErrorIs(t, err, errInvalidLeverage)

	err = ex.SwitchTradeMode(t.Context(), &SwitchTradeModeParams{Category: "linear", Symbol: usdcMarginedTradablePair.String(), SellLeverage: 3, BuyLeverage: 3, TradeMode: 2})
	require.ErrorIs(t, err, errInvalidTradeModeValue)

	err = ex.SwitchTradeMode(t.Context(), &SwitchTradeModeParams{Category: "linear", Symbol: usdtMarginedTradablePair.String(), SellLeverage: 3, BuyLeverage: 3, TradeMode: 1})
	if err != nil {
		t.Error(err)
	}
}
...
func TestSetTakeProfitStopLossMode(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex, canManipulateRealOrders)
	_, err := ex.SetTakeProfitStopLossMode(t.Context(), nil)
	assert.ErrorIs(t, err, errNilArgument)

	_, err = ex.SetTakeProfitStopLossMode(t.Context(), &TPSLModeParams{})
	require.ErrorIs(t, err, errCategoryNotSet)
	...
	_, err = ex.SetTakeProfitStopLossMode(t.Context(), &TPSLModeParams{Category: "spot"})
	require.ErrorIs(t, err, errInvalidCategory)

	_, err = ex.SetTakeProfitStopLossMode(t.Context(), &TPSLModeParams{Category: "linear"})
	require.ErrorIs(t, err, errSymbolMissing)

	_, err = ex.SetTakeProfitStopLossMode(t.Context(), &TPSLModeParams{Category: "linear", Symbol: "BTCUSDT"})
	require.ErrorIs(t, err, errTakeProfitOrStopLossModeMissing)

	_, err = ex.SetTakeProfitStopLossMode(t.Context(), &TPSLModeParams{Category: "linear", Symbol: "BTCUSDT", TpslMode: "Partial"})
	if err != nil {
		t.Error(err)
	}
}
...
func TestSwitchPositionMode(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex, canManipulateRealOrders)
	err := ex.SwitchPositionMode(t.Context(), nil)
	require.ErrorIs(t, err, errNilArgument)

	err = ex.SwitchPositionMode(t.Context(), &SwitchPositionModeParams{})
	require.ErrorIs(t, err, errCategoryNotSet)

	err = ex.SwitchPositionMode(t.Context(), &SwitchPositionModeParams{Category: "linear"})
	require.ErrorIs(t, err, errEitherSymbolOrCoinRequired)

	err = ex.SwitchPositionMode(t.Context(), &SwitchPositionModeParams{Category: "linear", Symbol: usdtMarginedTradablePair, PositionMode: 3})
	if err != nil {
		t.Error(err)
	}
}
...
func TestSetRiskLimit(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex, canManipulateRealOrders)
	_, err := ex.SetRiskLimit(t.Context(), nil)
	assert.ErrorIs(t, err, errNilArgument)

	_, err = ex.SetRiskLimit(t.Context(), &SetRiskLimitParam{})
	assert.ErrorIs(t, err, errCategoryNotSet)

	_, err = ex.SetRiskLimit(t.Context(), &SetRiskLimitParam{Category: "linear", PositionMode: -2})
	assert.ErrorIs(t, err, errInvalidPositionMode)

	_, err = ex.SetRiskLimit(t.Context(), &SetRiskLimitParam{Category: "linear"})
...
func TestSetTradingStop(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex, canManipulateRealOrders)
	err := ex.SetTradingStop(t.Context(), &TradingStopParams{})
	assert.ErrorIs(t, err, errCategoryNotSet)

	err = ex.SetTradingStop(t.Context(), &TradingStopParams{Category: "spot"})
	assert.ErrorIs(t, err, errInvalidCategory)
...
func TestSetAutoAddMargin(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex, canManipulateRealOrders)
	err := ex.SetAutoAddMargin(t.Context(), &AutoAddMarginParam{
		Category:      "inverse",
...
func TestAddOrReduceMargin(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex, canManipulateRealOrders)
	_, err := ex.AddOrReduceMargin(t.Context(), &AddOrReduceMarginParam{
		Category:      "inverse",
		Symbol:        inverseTradablePair,
		Margin:        -10,
		PositionIndex: 2,
...
func TestGetExecution(t *testing.T) {
	...
	_, err := ex.GetExecution(t.Context(), "spot", "", "", "", "", "Trade", "tpslOrder", "", time.Time{}, time.Time{}, 0)
	if err != nil {
		t.Fatal(err)
	}
}
...
func TestGetClosedPnL(t *testing.T) {
	...
	_, err := ex.GetClosedPnL(t.Context(), "spot", "", "", time.Time{}, time.Time{}, 0)
	require.ErrorIs(t, err, errInvalidCategory)

	_, err = ex.GetClosedPnL(t.Context(), "linear", "", "", time.Time{}, time.Time{}, 0)
	if err != nil {
		t.Fatal(err)
	}
}
...
func TestConfirmNewRiskLimit(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex)
	err := ex.ConfirmNewRiskLimit(t.Context(), "linear", "BTCUSDT")
	if err != nil {
		t.Error(err)
	}
}
...
func TestGetPreUpgradeOrderHistory(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex)
	_, err := ex.GetPreUpgradeOrderHistory(t.Context(), "", "", "", "", "", "", "", "", time.Time{}, time.Time{}, 100)
	require.ErrorIs(t, err, errCategoryNotSet)

	_, err = ex.GetPreUpgradeOrderHistory(t.Context(), "option", "", "", "", "", "", "", "", time.Time{}, time.Time{}, 0)
	require.ErrorIs(t, err, errBaseNotSet)

	_, err = ex.GetPreUpgradeOrderHistory(t.Context(), "linear", "", "", "", "", "", "", "", time.Time{}, time.Time{}, 0)
	if err != nil {
		t.Error(err)
	}
}
...
func TestGetPreUpgradeTradeHistory(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex)
	_, err := ex.GetPreUpgradeTradeHistory(t.Context(), "", "", "", "", "", "", "", time.Time{}, time.Time{}, 0)
	require.ErrorIs(t, err, errCategoryNotSet)

	_, err = ex.GetPreUpgradeTradeHistory(t.Context(), "option", "", "", "", "", "", "", time.Time{}, time.Time{}, 0)
	require.ErrorIs(t, err, errInvalidCategory)

	_, err = ex.GetPreUpgradeTradeHistory(t.Context(), "linear", "", "", "", "", "", "", time.Time{}, time.Time{}, 0)
	if err != nil {
		t.Error(err)
	}
}
...
func TestGetPreUpgradeClosedPnL(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex)
	_, err := ex.GetPreUpgradeClosedPnL(t.Context(), "option", "BTCUSDT", "", time.Time{}, time.Time{}, 0)
	require.ErrorIs(t, err, errInvalidCategory)

	_, err = ex.GetPreUpgradeClosedPnL(t.Context(), "linear", "BTCUSDT", "", time.Time{}, time.Time{}, 0)
	if err != nil {
		t.Error(err)
	}
}
...
func TestGetPreUpgradeTransactionLog(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex)
	_, err := ex.GetPreUpgradeTransactionLog(t.Context(), "option", "", "", "", time.Time{}, time.Time{}, 0)
	require.ErrorIs(t, err, errInvalidCategory)

	_, err = ex.GetPreUpgradeTransactionLog(t.Context(), "linear", "", "", "", time.Time{}, time.Time{}, 0)
	if err != nil {
		t.Error(err)
	}
}
...
func TestGetPreUpgradeOptionDeliveryRecord(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex)
	_, err := ex.GetPreUpgradeOptionDeliveryRecord(t.Context(), "linear", "", "", time.Time{}, 0)
	assert.ErrorIs(t, err, errInvalidCategory)

	_, err = ex.GetPreUpgradeOptionDeliveryRecord(t.Context(), "option", "", "", time.Time{}, 0)
	if err != nil {
		t.Error(err)
	}
}
...
func TestGetPreUpgradeUSDCSessionSettlement(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex)
	_, err := ex.GetPreUpgradeUSDCSessionSettlement(t.Context(), "option", "", "", 10)
	require.ErrorIs(t, err, errInvalidCategory)

	_, err = ex.GetPreUpgradeUSDCSessionSettlement(t.Context(), "linear", "", "", 10)
	if err != nil {
		t.Error(err)
	}
}
...
func TestGetWalletBalance(t *testing.T) {
	...
	r, err := ex.GetWalletBalance(t.Context(), "UNIFIED", "")
...
func TestUpgradeToUnifiedAccount(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex, canManipulateRealOrders)
	_, err := ex.UpgradeToUnifiedAccount(t.Context())
	if err != nil {
		t.Error(err)
	}
}
...
func TestGetBorrowHistory(t *testing.T) {
	...
	_, err := ex.GetBorrowHistory(t.Context(), "BTC", "", time.Time{}, time.Time{}, 0)
	if err != nil {
		t.Error(err)
	}
}
...
func TestSetCollateralCoin(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex, canManipulateRealOrders)
	err := ex.SetCollateralCoin(t.Context(), currency.BTC, false)
	if err != nil {
		t.Error(err)
	}
}
...
func TestGetCollateralInfo(t *testing.T) {
	...
	_, err := ex.GetCollateralInfo(t.Context(), "BTC")
	if err != nil {
		t.Error(err)
	}
}
...
func TestGetCoinGreeks(t *testing.T) {
	...
	_, err := ex.GetCoinGreeks(t.Context(), "BTC")
	if err != nil {
		t.Error(err)
	}
}
...
func TestGetFeeRate(t *testing.T) {
	...
	_, err := ex.GetFeeRate(t.Context(), "something", "", "BTC")
	require.ErrorIs(t, err, errInvalidCategory)

	_, err = ex.GetFeeRate(t.Context(), "linear", "", "BTC")
	if err != nil {
		t.Error(err)
	}
}
...
func TestGetAccountInfo(t *testing.T) {
	...
	_, err := ex.GetAccountInfo(t.Context())
	if err != nil {
		t.Error(err)
	}
}
...
func TestGetTransactionLog(t *testing.T) {
	...
	_, err := ex.GetTransactionLog(t.Context(), "option", "", "", "", time.Time{}, time.Time{}, 0)
	if err != nil {
		t.Error(err)
	}
	_, err = ex.GetTransactionLog(t.Context(), "linear", "", "", "", time.Time{}, time.Time{}, 0)
	if err != nil {
		t.Error(err)
	}
}
...
func TestSetMarginMode(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex, canManipulateRealOrders)
	_, err := ex.SetMarginMode(t.Context(), "PORTFOLIO_MARGIN")
	if err != nil {
		t.Error(err)
	}
}
...
func TestSetSpotHedging(t *testing.T) {
	t.Parallel()
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex, canManipulateRealOrders)
	err := ex.SetSpotHedging(t.Context(), true)
	if err != nil {
		t.Error(err)
	}
}
...
func TestGetSubAccountALLAPIKeys(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex)
	_, err := ex.GetSubAccountAllAPIKeys(t.Context(), "", "", 10)
	assert.ErrorIs(t, err, errMemberIDRequired)

	_, err = ex.GetSubAccountAllAPIKeys(t.Context(), "1234", "", 10)
	if err != nil {
		t.Error(err)
	}
}
...
func TestSetMMP(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex, canManipulateRealOrders)
	err := ex.SetMMP(t.Context(), nil)
	require.ErrorIs(t, err, errNilArgument)

	err = ex.SetMMP(t.Context(), &MMPRequestParam{
		BaseCoin:           "ETH",
		TimeWindowMS:       5000,
		FrozenPeriod:       100000,
...
func TestResetMMP(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex, canManipulateRealOrders)
	err := ex.ResetMMP(t.Context(), "USDT")
	require.ErrorIs(t, err, errNilArgument)

	err = ex.ResetMMP(t.Context(), "BTC")
	if err != nil {
		t.Error(err)
	}
}
...
func TestGetMMPState(t *testing.T) {
	...
	_, err := ex.GetMMPState(t.Context(), "BTC")
	if err != nil {
		t.Error(err)
	}
}
...
func TestGetCoinExchangeRecords(t *testing.T) {
	...
	_, err := ex.GetCoinExchangeRecords(t.Context(), "", "", "", 20)
	if err != nil {
		t.Fatal(err)
	}
}
...
func TestGetDeliveryRecord(t *testing.T) {
	...
	_, err := ex.GetDeliveryRecord(t.Context(), "spot", "", "", expiryTime, 20)
	assert.ErrorIs(t, err, errInvalidCategory)
	_, err = ex.GetDeliveryRecord(t.Context(), "linear", "", "", expiryTime, 20)
...
func TestGetUSDCSessionSettlement(t *testing.T) {
	...
	_, err := ex.GetUSDCSessionSettlement(t.Context(), "option", "", "", 10)
	require.ErrorIs(t, err, errInvalidCategory)

	_, err = ex.GetUSDCSessionSettlement(t.Context(), "linear", "", "", 10)
	if err != nil {
		t.Error(err)
	}
}
...
func TestGetAssetInfo(t *testing.T) {
	...
	_, err := ex.GetAssetInfo(t.Context(), "", "BTC")
	require.ErrorIs(t, err, errMissingAccountType)

	_, err = ex.GetAssetInfo(t.Context(), "SPOT", "BTC")
...
func TestGetAllCoinBalance(t *testing.T) {
	...
	_, err := ex.GetAllCoinBalance(t.Context(), "", "", "", 0)
	require.ErrorIs(t, err, errMissingAccountType)

	_, err = ex.GetAllCoinBalance(t.Context(), "FUND", "", "", 0)
	if err != nil {
		t.Fatal(err)
	}
}
...
func TestGetSingleCoinBalance(t *testing.T) {
	...
	_, err := ex.GetSingleCoinBalance(t.Context(), "", "", "", 0, 0)
	require.ErrorIs(t, err, errMissingAccountType)

	_, err = ex.GetSingleCoinBalance(t.Context(), "SPOT", currency.BTC.String(), "", 0, 0)
	if err != nil {
		t.Fatal(err)
	}
}
...
func TestGetTransferableCoin(t *testing.T) {
	...
	_, err := ex.GetTransferableCoin(t.Context(), "SPOT", "OPTION")
	if err != nil {
		t.Fatal(err)
	}
}
...
func TestCreateInternalTransfer(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex, canManipulateRealOrders)
	_, err := ex.CreateInternalTransfer(t.Context(), nil)
	require.ErrorIs(t, err, errNilArgument)

	_, err = ex.CreateInternalTransfer(t.Context(), &TransferParams{})
	...
	_, err = ex.CreateInternalTransfer(t.Context(), &TransferParams{TransferID: transferID})
...
func TestGetInternalTransferRecords(t *testing.T) {
	...
	_, err = ex.GetInternalTransferRecords(t.Context(), transferIDString, currency.BTC.String(), "", "", time.Time{}, time.Time{}, 0)
	if err != nil {
		t.Error(err)
	}
}
...
func TestEnableUniversalTransferForSubUID(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex, canManipulateRealOrders)
	err := ex.EnableUniversalTransferForSubUID(t.Context())
	...
	err = ex.EnableUniversalTransferForSubUID(t.Context(), transferID1.String(), transferID2.String())
	if err != nil {
		t.Error(err)
	}
}
...
func TestCreateUniversalTransfer(t *testing.T) {
	t.Parallel()
	_, err := ex.CreateUniversalTransfer(t.Context(), nil)
	require.ErrorIs(t, err, errNilArgument)

	_, err = ex.CreateUniversalTransfer(t.Context(), &TransferParams{})
	require.ErrorIs(t, err, errMissingTransferID)
	...
	_, err = ex.CreateUniversalTransfer(t.Context(), &TransferParams{TransferID: transferID})
	require.ErrorIs(t, err, currency.ErrCurrencyCodeEmpty)
...
func TestGetUniversalTransferRecords(t *testing.T) {
	...
	_, err := ex.GetUniversalTransferRecords(t.Context(), transferIDString, currency.BTC.String(), "", "", time.Time{}, time.Time{}, 0)
	if err != nil {
		t.Error(err)
	}
}
...
func TestGetAllowedDepositCoinInfo(t *testing.T) {
	...
	_, err := ex.GetAllowedDepositCoinInfo(t.Context(), "BTC", "", "", 0)
	if err != nil {
		t.Error(err)
	}
}
...
func TestSetDepositAccount(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex, canManipulateRealOrders)
	_, err := ex.SetDepositAccount(t.Context(), "FUND")
	if err != nil {
		t.Error(err)
	}
}
...
func TestGetDepositRecords(t *testing.T) {
	...
	_, err := ex.GetDepositRecords(t.Context(), "", "", time.Time{}, time.Time{}, 0)
	if err != nil {
		t.Error(err)
	}
}
...
func TestGetSubDepositRecords(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex)
	_, err := ex.GetSubDepositRecords(t.Context(), "12345", "", "", time.Time{}, time.Time{}, 0)
	if err != nil {
		t.Error(err)
	}
}
...
func TestInternalDepositRecords(t *testing.T) {
	...
	_, err := ex.GetInternalDepositRecordsOffChain(t.Context(), currency.ETH.String(), "", time.Time{}, time.Time{}, 8)
	if err != nil {
		t.Error(err)
	}
}
...
func TestGetMasterDepositAddress(t *testing.T) {
	...
	_, err := ex.GetMasterDepositAddress(t.Context(), currency.LTC, "")
	if err != nil {
		t.Error(err)
	}
}
...
func TestGetSubDepositAddress(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex)
	_, err := ex.GetSubDepositAddress(t.Context(), currency.LTC, "LTC", "12345")
	if err != nil {
		t.Error(err)
	}
}
...
func TestGetCoinInfo(t *testing.T) {
	...
	_, err := ex.GetCoinInfo(t.Context(), currency.BTC)
	if err != nil {
		t.Error(err)
	}
}
...
func TestGetWithdrawalRecords(t *testing.T) {
	...
	_, err := ex.GetWithdrawalRecords(t.Context(), currency.LTC, "", "", "", time.Time{}, time.Time{}, 10)
	if err != nil {
		t.Error(err)
	}
}
...
func TestGetWithdrawableAmount(t *testing.T) {
	...
	_, err := ex.GetWithdrawableAmount(t.Context(), currency.LTC)
	if err != nil {
		t.Error(err)
	}
}
...
func TestWithdrawCurrency(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex, canManipulateRealOrders)
	_, err := ex.WithdrawCurrency(t.Context(), nil)
	require.ErrorIs(t, err, errNilArgument)

	_, err = ex.WithdrawCurrency(t.Context(), &WithdrawalParam{})
	require.ErrorIs(t, err, currency.ErrCurrencyCodeEmpty)

	_, err = ex.WithdrawCurrency(t.Context(), &WithdrawalParam{Coin: currency.BTC})
	require.ErrorIs(t, err, errMissingChainInformation)

	_, err = ex.WithdrawCurrency(t.Context(), &WithdrawalParam{Coin: currency.LTC, Chain: "LTC"})
	require.ErrorIs(t, err, errMissingAddressInfo)

	_, err = ex.WithdrawCurrency(t.Context(), &WithdrawalParam{Coin: currency.LTC, Chain: "LTC", Address: "234234234"})
	require.ErrorIs(t, err, order.ErrAmountBelowMin)

	_, err = ex.WithdrawCurrency(t.Context(), &WithdrawalParam{Coin: currency.LTC, Chain: "LTC", Address: "234234234", Amount: 123})
	if err != nil {
		t.Fatal(err)
	}
}
...
func TestCancelWithdrawal(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex, canManipulateRealOrders)
	_, err := ex.CancelWithdrawal(t.Context(), "")
	require.ErrorIs(t, err, errMissingWithdrawalID)

	_, err = ex.CancelWithdrawal(t.Context(), "12314")
	if err != nil {
		t.Error(err)
	}
}
...
func TestCreateNewSubUserID(t *testing.T) {
	t.Parallel()
	_, err := ex.CreateNewSubUserID(t.Context(), nil)
	require.ErrorIs(t, err, errNilArgument)

	_, err = ex.CreateNewSubUserID(t.Context(), &CreateSubUserParams{MemberType: 1, Switch: 1, Note: "test"})
	require.ErrorIs(t, err, errMissingUsername)

	_, err = ex.CreateNewSubUserID(t.Context(), &CreateSubUserParams{Username: "Sami", Switch: 1, Note: "test"})
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex, canManipulateRealOrders)
	_, err = ex.CreateNewSubUserID(t.Context(), &CreateSubUserParams{Username: "sami", MemberType: 1, Switch: 1, Note: "test"})
	if err != nil {
		t.Error(err)
	}
}
...
func TestCreateSubUIDAPIKey(t *testing.T) {
	t.Parallel()
	_, err := ex.CreateSubUIDAPIKey(t.Context(), nil)
	require.ErrorIs(t, err, errNilArgument)

	_, err = ex.CreateSubUIDAPIKey(t.Context(), &SubUIDAPIKeyParam{})
...
func TestGetSubUIDList(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex)
	_, err := ex.GetSubUIDList(t.Context())
	if err != nil {
		t.Error(err)
	}
}
...
func TestFreezeSubUID(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex, canManipulateRealOrders)
	err := ex.FreezeSubUID(t.Context(), "1234", true)
	if err != nil {
		t.Error(err)
	}
}
...
func TestGetAPIKeyInformation(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex)
	_, err := ex.GetAPIKeyInformation(t.Context())
	if err != nil {
		t.Error(err)
	}
}
...
func TestGetUIDWalletType(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex)
	_, err := ex.GetUIDWalletType(t.Context(), "234234")
	if err != nil {
		t.Error(err)
	}
}
...
func TestModifyMasterAPIKey(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex, canManipulateRealOrders)
	_, err := ex.ModifyMasterAPIKey(t.Context(), &SubUIDAPIKeyUpdateParam{})
	require.ErrorIs(t, err, errNilArgument)
...
func TestModifySubAPIKey(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex, canManipulateRealOrders)
	_, err := ex.ModifySubAPIKey(t.Context(), &SubUIDAPIKeyUpdateParam{})
	require.ErrorIs(t, err, errNilArgument)
...
func TestDeleteSubUID(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex)
	err := ex.DeleteSubUID(t.Context(), "")
	assert.ErrorIs(t, err, errMemberIDRequired)

	err = ex.DeleteSubUID(t.Context(), "1234")
	if err != nil {
		t.Error(err)
	}
}
...
func TestDeleteMasterAPIKey(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex, canManipulateRealOrders)
	err := ex.DeleteMasterAPIKey(t.Context())
	if err != nil {
		t.Error(err)
	}
}
...
func TestDeleteSubAPIKey(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex, canManipulateRealOrders)
	err := ex.DeleteSubAccountAPIKey(t.Context(), "12434")
	if err != nil {
		t.Error(err)
	}
}
...
func TestGetAffiliateUserInfo(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex)
	_, err := ex.GetAffiliateUserInfo(t.Context(), "1234")
	if err != nil {
		t.Error(err)
	}
}
...
func TestGetLeverageTokenInfo(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex)
	_, err := ex.GetLeverageTokenInfo(t.Context(), currency.NewCode("BTC3L"))
	if err != nil {
		t.Error(err)
	}
}
...
func TestGetLeveragedTokenMarket(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex)
	_, err := ex.GetLeveragedTokenMarket(t.Context(), currency.EMPTYCODE)
	require.ErrorIs(t, err, currency.ErrCurrencyCodeEmpty)

	_, err = ex.GetLeveragedTokenMarket(t.Context(), currency.NewCode("BTC3L"))
	if err != nil {
		t.Error(err)
	}
}
...
func TestPurchaseLeverageToken(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex, canManipulateRealOrders)
	_, err := ex.PurchaseLeverageToken(t.Context(), currency.BTC3L, 100, "")
	if err != nil {
		t.Error(err)
	}
}
...
func TestRedeemLeverageToken(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex, canManipulateRealOrders)
	_, err := ex.RedeemLeverageToken(t.Context(), currency.BTC3L, 100, "")
	if err != nil {
		t.Error(err)
	}
}
...
func TestGetPurchaseAndRedemptionRecords(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex)
	_, err := ex.GetPurchaseAndRedemptionRecords(t.Context(), currency.EMPTYCODE, "", "", time.Time{}, time.Time{}, 0, 0)
	if err != nil {
		t.Error(err)
	}
}
...
func TestToggleMarginTrade(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex, canManipulateRealOrders)
	_, err := ex.ToggleMarginTrade(t.Context(), true)
	if err != nil {
		t.Error(err)
	}
}
...
func TestSetSpotMarginTradeLeverage(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex)
	err := ex.SetSpotMarginTradeLeverage(t.Context(), 3)
	if err != nil {
		t.Error(err)
	}
}
...
func TestGetMarginCoinInfo(t *testing.T) {
	t.Parallel()
	_, err := ex.GetMarginCoinInfo(t.Context(), currency.BTC)
	if err != nil {
		t.Error(err)
	}
}
...
func TestGetVIPMarginData(t *testing.T) {
	t.Parallel()
	_, err := ex.GetVIPMarginData(t.Context(), "", "")
	if err != nil {
		t.Error(err)
	}
}
...
func TestGetBorrowableCoinInfo(t *testing.T) {
	t.Parallel()
	_, err := ex.GetBorrowableCoinInfo(t.Context(), currency.EMPTYCODE)
	if err != nil {
		t.Error(err)
	}
}
...
func TestGetInterestAndQuota(t *testing.T) {
	t.Parallel()
	_, err := ex.GetInterestAndQuota(t.Context(), currency.EMPTYCODE)
	...
	_, err = ex.GetInterestAndQuota(t.Context(), currency.BTC)
	assert.NoError(t, err)
}
...
func TestGetLoanAccountInfo(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex)
	_, err := ex.GetLoanAccountInfo(t.Context())
	assert.NoError(t, err)
}
...
func TestBorrow(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex, canManipulateRealOrders)
	_, err := ex.Borrow(t.Context(), nil)
	assert.ErrorIs(t, err, errNilArgument)

	_, err = ex.Borrow(t.Context(), &LendArgument{})
	assert.ErrorIs(t, err, currency.ErrCurrencyCodeEmpty)

	_, err = ex.Borrow(t.Context(), &LendArgument{Coin: currency.BTC})
	assert.ErrorIs(t, err, order.ErrAmountBelowMin)

	_, err = ex.Borrow(t.Context(), &LendArgument{Coin: currency.BTC, AmountToBorrow: 0.1})
	if err != nil {
		t.Error(err)
	}
}
...
func TestRepay(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex, canManipulateRealOrders)
	_, err := ex.Repay(t.Context(), nil)
	assert.ErrorIs(t, err, errNilArgument)

	_, err = ex.Repay(t.Context(), &LendArgument{})
	assert.ErrorIs(t, err, currency.ErrCurrencyCodeEmpty)

	_, err = ex.Repay(t.Context(), &LendArgument{Coin: currency.BTC})
	assert.ErrorIs(t, err, order.ErrAmountBelowMin)

	_, err = ex.Repay(t.Context(), &LendArgument{Coin: currency.BTC, AmountToBorrow: 0.1})
	if err != nil {
		t.Error(err)
	}
}
...
func TestGetBorrowOrderDetail(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex)
	_, err := ex.GetBorrowOrderDetail(t.Context(), time.Time{}, time.Time{}, currency.BTC, 0, 0)
	assert.NoError(t, err)
}
...
func TestGetRepaymentOrderDetail(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex)
	_, err := ex.GetRepaymentOrderDetail(t.Context(), time.Time{}, time.Time{}, currency.BTC, 0)
	assert.NoError(t, err)
}
...
func TestToggleMarginTradeNormal(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex)
	_, err := ex.ToggleMarginTradeNormal(t.Context(), true)
	assert.NoError(t, err)
}

func TestGetProductInfo(t *testing.T) {
	t.Parallel()
	_, err := ex.GetProductInfo(t.Context(), "")
	if err != nil {
		t.Error(err)
	}
}
...
func TestGetInstitutionalLengingMarginCoinInfo(t *testing.T) {
	t.Parallel()
	_, err := ex.GetInstitutionalLengingMarginCoinInfo(t.Context(), "")
	if err != nil {
		t.Error(err)
	}
}
...
func TestGetInstitutionalLoanOrders(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex)
	_, err := ex.GetInstitutionalLoanOrders(t.Context(), "", time.Time{}, time.Time{}, 0)
	assert.NoError(t, err)
}
...
func TestGetInstitutionalRepayOrders(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex)
	_, err := ex.GetInstitutionalRepayOrders(t.Context(), time.Time{}, time.Time{}, 0)
	assert.NoError(t, err)
}
...
func TestBindOrUnbindUID(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex, canManipulateRealOrders)
	_, err := ex.BindOrUnbindUID(t.Context(), "12234", "0")
	if err != nil {
		t.Error(err)
	}
}
...
func TestGetC2CLendingCoinInfo(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex)
	_, err := ex.GetC2CLendingCoinInfo(t.Context(), currency.BTC)
	if err != nil {
		t.Error(err)
	}
}
...
func TestC2CDepositFunds(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex, canManipulateRealOrders)
	_, err := ex.C2CDepositFunds(t.Context(), nil)
	assert.ErrorIs(t, err, errNilArgument)

	_, err = ex.C2CDepositFunds(t.Context(), &C2CLendingFundsParams{})
	assert.ErrorIs(t, err, currency.ErrCurrencyCodeEmpty)

	_, err = ex.C2CDepositFunds(t.Context(), &C2CLendingFundsParams{Coin: currency.BTC})
	assert.ErrorIs(t, err, order.ErrAmountBelowMin)

	_, err = ex.C2CDepositFunds(t.Context(), &C2CLendingFundsParams{Coin: currency.BTC, Quantity: 1232})
	if err != nil {
		t.Error(err)
	}
}
...
func TestC2CRedeemFunds(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex, canManipulateRealOrders)
	_, err := ex.C2CRedeemFunds(t.Context(), nil)
	assert.ErrorIs(t, err, errNilArgument)

	_, err = ex.C2CRedeemFunds(t.Context(), &C2CLendingFundsParams{})
	assert.ErrorIs(t, err, currency.ErrCurrencyCodeEmpty)

	_, err = ex.C2CRedeemFunds(t.Context(), &C2CLendingFundsParams{Coin: currency.BTC})
	assert.ErrorIs(t, err, order.ErrAmountBelowMin)

	_, err = ex.C2CRedeemFunds(t.Context(), &C2CLendingFundsParams{Coin: currency.BTC, Quantity: 1232})
	if err != nil {
		t.Error(err)
	}
}
...
func TestGetC2CLendingOrderRecords(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex)
	_, err := ex.GetC2CLendingOrderRecords(t.Context(), currency.EMPTYCODE, "", "", time.Time{}, time.Time{}, 0)
	if err != nil {
		t.Error(err)
	}
}
...
func TestGetC2CLendingAccountInfo(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex)
	_, err := ex.GetC2CLendingAccountInfo(t.Context(), currency.LTC)
	if err != nil {
		t.Error(err)
	}
}
...
func TestGetBrokerEarning(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex)
	_, err := ex.GetBrokerEarning(t.Context(), "DERIVATIVES", "", time.Time{}, time.Time{}, 0)
	if err != nil {
		t.Error(err)
	}
}
...
func TestUpdateAccountInfo(t *testing.T) {
	...
	r, err := ex.UpdateAccountInfo(t.Context(), asset.Spot)
...
func TestGetWithdrawalsHistory(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex)
	_, err := ex.GetWithdrawalsHistory(t.Context(), currency.BTC, asset.Futures)
	assert.ErrorIs(t, err, asset.ErrNotSupported)

	_, err = ex.GetWithdrawalsHistory(t.Context(), currency.BTC, asset.Spot)
	if err != nil {
...
func TestGetRecentTrades(t *testing.T) {
	...
	for _, tt := range []struct {
		...
		_, err := ex.GetRecentTrades(t.Context(), tt.p, tt.a)
		assert.NoErrorf(t, err, "GetRecentTrades should not error for %s asset", tt.a)
	}

	_, err := ex.GetRecentTrades(t.Context(), spotTradablePair, asset.Futures)
	assert.ErrorIs(t, err, asset.ErrNotSupported)
}

func TestGetBybitServerTime(t *testing.T) {
	t.Parallel()
	_, err := ex.GetBybitServerTime(t.Context())
	if err != nil {
		t.Error(err)
	}
}
...
func TestGetServerTime(t *testing.T) {
	t.Parallel()
	_, err := ex.GetServerTime(t.Context(), asset.Empty)
	if err != nil {
		t.Error(err)
	}
}
...
func TestGetHistoricTrades(t *testing.T) {
	t.Parallel()
	_, err := ex.GetHistoricTrades(t.Context(), spotTradablePair, asset.Spot, time.Time{}, time.Time{})
	if err != nil {
		t.Error(err)
	}
	_, err = ex.GetHistoricTrades(t.Context(), usdtMarginedTradablePair, asset.USDTMarginedFutures, time.Time{}, time.Time{})
	if err != nil {
		t.Error(err)
	}
	_, err = ex.GetHistoricTrades(t.Context(), usdcMarginedTradablePair, asset.USDCMarginedFutures, time.Time{}, time.Time{})
	if err != nil {
		t.Error(err)
	}
	_, err = ex.GetHistoricTrades(t.Context(), inverseTradablePair, asset.CoinMarginedFutures, time.Time{}, time.Time{})
	if err != nil {
		t.Error(err)
	}
	_, err = ex.GetHistoricTrades(t.Context(), optionsTradablePair, asset.Options, time.Time{}, time.Time{})
	if err != nil {
		t.Error(err)
	}
}
...
func TestCancelBatchOrders(t *testing.T) {
	...
	_, err := ex.CancelBatchOrders(t.Context(), orderCancellationParams)
	assert.ErrorIs(t, err, asset.ErrNotSupported)
...
func TestPushData(t *testing.T) {
	...
	for x := range keys {
		err := ex.wsHandleData(t.Context(), asset.Spot, []byte(pushDataMap[keys[x]]))
...
func TestGetFeeByTypeOfflineTradeFee(t *testing.T) {
	...
	_, err := ex.GetFeeByType(t.Context(), feeBuilder)
	if err != nil {
		t.Fatal(err)
	}
...
func TestSetLeverage(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, ex, canManipulateRealOrders)
	ctx := t.Context()
	err := ex.SetLeverage(ctx, asset.USDTMarginedFutures, usdtMarginedTradablePair, margin.Multi, 5, order.Buy)
	if err != nil {
		t.Error(err)
	}
	err = ex.SetLeverage(ctx, asset.USDCMarginedFutures, usdcMarginedTradablePair, margin.Multi, 5, order.Buy)
	if err != nil {
		t.Error(err)
	}

	err = ex.SetLeverage(ctx, asset.CoinMarginedFutures, inverseTradablePair, margin.Isolated, 5, order.UnknownSide)
	assert.ErrorIs(t, err, order.ErrSideIsInvalid)

	err = ex.SetLeverage(ctx, asset.USDTMarginedFutures, usdtMarginedTradablePair, margin.Isolated, 5, order.Buy)
	if err != nil {
		t.Error(err)
	}

	err = ex.SetLeverage(ctx, asset.CoinMarginedFutures, inverseTradablePair, margin.Isolated, 5, order.Sell)
	if err != nil {
		t.Error(err)
	}

	err = ex.SetLeverage(ctx, asset.USDTMarginedFutures, usdtMarginedTradablePair, margin.Isolated, 5, order.CouldNotBuy)
	assert.ErrorIs(t, err, order.ErrSideIsInvalid)

	err = ex.SetLeverage(ctx, asset.Spot, inverseTradablePair, margin.Multi, 5, order.UnknownSide)
	assert.ErrorIs(t, err, asset.ErrNotSupported)
}
...
func TestGetFuturesContractDetails(t *testing.T) {
	...
	_, err = ex.GetFuturesContractDetails(t.Context(), asset.CoinMarginedFutures)
	assert.NoError(t, err)

	_, err = ex.GetFuturesContractDetails(t.Context(), asset.USDTMarginedFutures)
	assert.NoError(t, err)

	_, err = ex.GetFuturesContractDetails(t.Context(), asset.USDCMarginedFutures)
	assert.NoError(t, err)
}
...
func TestFetchTradablePairs(t *testing.T) {
	...
	_, err = ex.FetchTradablePairs(t.Context(), asset.CoinMarginedFutures)
	if err != nil {
		t.Fatal(err)
	}
	_, err = ex.FetchTradablePairs(t.Context(), asset.USDTMarginedFutures)
	if err != nil {
		t.Fatal(err)
	}
	_, err = ex.FetchTradablePairs(t.Context(), asset.USDCMarginedFutures)
	if err != nil {
		t.Fatal(err)
	}
...
func TestDeltaUpdateOrderbook(t *testing.T) {
	...
	err := ex.wsHandleData(t.Context(), asset.Spot, data)
	if err != nil {
		t.Fatal(err)
	}
	...
	err = ex.wsProcessOrderbook(asset.Spot, &wsResponse)
	if err != nil {
		t.Fatal(err)
	}
}
...
func TestGetLongShortRatio(t *testing.T) {
	t.Parallel()
	_, err := ex.GetLongShortRatio(t.Context(), "linear", "BTCUSDT", kline.FiveMin, 0)
	if err != nil {
		t.Fatal(err)
	}
	_, err = ex.GetLongShortRatio(t.Context(), "inverse", "BTCUSDT", kline.FiveMin, 0)
	if err != nil {
		t.Fatal(err)
	}
	_, err = ex.GetLongShortRatio(t.Context(), "spot", "BTCUSDT", kline.FiveMin, 0)
	require.ErrorIs(t, err, errInvalidCategory)
}
...
func TestFetchAccountType(t *testing.T) {
	...
	val, err := ex.FetchAccountType(t.Context())
	require.NoError(t, err)
...
func TestGetLatestFundingRates(t *testing.T) {
	t.Parallel()
	_, err := ex.GetLatestFundingRates(t.Context(), &fundingrate.LatestRateRequest{
		Asset: asset.Futures,
		Pair:  usdtMarginedTradablePair,
	})
	assert.ErrorIs(t, err, asset.ErrNotSupported)
...
func TestConstructOrderDetails(t *testing.T) {
	...
	orders, err := ex.ConstructOrderDetails(response, asset.Spot, currency.Pair{Base: currency.BTC, Quote: currency.USDT}, currency.Pairs{})
	if err != nil {
		t.Fatal(err)
	} else if len(orders) > 0 {
		t.Errorf("expected order with length 0, got %d", len(orders))
	}
	orders, err = ex.ConstructOrderDetails(response, asset.Spot, currency.EMPTYPAIR, currency.Pairs{})
	if err != nil {
		t.Fatal(err)
...
func TestIsPerpetualFutureCurrency(t *testing.T) {
	...
	is, err := ex.IsPerpetualFutureCurrency(asset.Spot, spotTradablePair)
	assert.NoError(t, err)
	assert.False(t, is)

	is, err = ex.IsPerpetualFutureCurrency(asset.CoinMarginedFutures, inverseTradablePair)
	assert.NoError(t, err)
	assert.Truef(t, is, "%s %s should be a perp", asset.CoinMarginedFutures, inverseTradablePair)

	is, err = ex.IsPerpetualFutureCurrency(asset.USDTMarginedFutures, usdtMarginedTradablePair)
	assert.NoError(t, err)
	assert.Truef(t, is, "%s %s should be a perp", asset.USDTMarginedFutures, usdtMarginedTradablePair)

	is, err = ex.IsPerpetualFutureCurrency(asset.USDCMarginedFutures, usdcMarginedTradablePair)
	assert.NoError(t, err)
