...
func (l *LakeBTC) GetAccountInformation() (AccountInfo, error) {
	resp := AccountInfo{}
	return resp, l.SendAuthenticatedHTTPRequest(exchange.DefaultSpot, lakeBTCGetAccountInfo, "", &resp)
}
...
func (l *LakeBTC) Trade(isBuyOrder bool, amount, price float64, currency string) (Trade, error) {
	...
	if isBuyOrder {
		if err := l.SendAuthenticatedHTTPRequest(exchange.DefaultSpot, lakeBTCBuyOrder, params, &resp); err != nil {
			return resp, err
		}
	} else {
		if err := l.SendAuthenticatedHTTPRequest(exchange.DefaultSpot, lakeBTCSellOrder, params, &resp); err != nil {
			return resp, err
		}
	}
...
func (l *LakeBTC) GetOpenOrders() ([]OpenOrders, error) {
	...
	return orders, l.SendAuthenticatedHTTPRequest(exchange.DefaultSpot, lakeBTCOpenOrders, "", &orders)
}
...
func (l *LakeBTC) GetOrders(orders []int64) ([]Orders, error) {
	...
	var resp []Orders
	return resp,
		l.SendAuthenticatedHTTPRequest(exchange.DefaultSpot, lakeBTCGetOrders, strings.Join(ordersStr, ","), &resp)
}
...
func (l *LakeBTC) CancelExistingOrder(orderID int64) error {
	...
	err := l.SendAuthenticatedHTTPRequest(exchange.DefaultSpot, lakeBTCCancelOrder, params, &resp)
	if err != nil {
		return err
	}
...
func (l *LakeBTC) GetTrades(timestamp int64) ([]AuthenticatedTradeHistory, error) {
	...
	return trades, l.SendAuthenticatedHTTPRequest(exchange.DefaultSpot, lakeBTCGetTrades, params, &trades)
}
...
func (l *LakeBTC) GetExternalAccounts() ([]ExternalAccounts, error) {
	...
	return resp, l.SendAuthenticatedHTTPRequest(exchange.DefaultSpot, lakeBTCGetExternalAccounts, "", &resp)
}
...
func (l *LakeBTC) CreateWithdraw(amount float64, accountID string) (Withdraw, error) {
	...
	err := l.SendAuthenticatedHTTPRequest(exchange.DefaultSpot, lakeBTCCreateWithdraw, params, &resp)
	if err != nil {
		return Withdraw{}, err
	}
	if len(resp.Error) > 0 {
...
func (l *LakeBTC) SendAuthenticatedHTTPRequest(ep, method, params string, result interface{}) (err error) {
