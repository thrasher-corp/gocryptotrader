...
func (b *Bitstamp) GetTicker(currency string, hourly bool) (*Ticker, error) {
	...
	return &response, b.SendHTTPRequest(runningSpotRest, path, &response)
}
...
func (b *Bitstamp) GetOrderbook(currency string) (Orderbook, error) {
	...
	err := b.SendHTTPRequest(runningSpotRest, path, &resp)
	if err != nil {
...
func (b *Bitstamp) GetTradingPairs() ([]TradingPair, error) {
	...
	return result, b.SendHTTPRequest(runningSpotRest, path, &result)
}
...
func (b *Bitstamp) GetTransactions(currencyPair, timePeriod string) ([]Transactions, error) {
	...
	return transactions, b.SendHTTPRequest(runningSpotRest, requestURL, &transactions)
}
...
func (b *Bitstamp) GetEURUSDConversionRate() (EURUSDConversionRate, error) {
	...
	return rate, b.SendHTTPRequest(runningSpotRest, path, &rate)
}

// GetBalance returns full balance of currency held on the exchange
func (b *Bitstamp) GetBalance() (Balances, error) {
	var balance map[string]string
	err := b.SendAuthenticatedHTTPRequest(runningSpotRest, bitstampAPIBalance, true, nil, &balance)
	if err != nil {
		return nil, err
	}
...
func (b *Bitstamp) GetUserTransactions(currencyPair string) ([]UserTransactions, error) {
	...
	if currencyPair == "" {
		if err := b.SendAuthenticatedHTTPRequest(runningSpotRest, bitstampAPIUserTransactions,
			true,
			url.Values{},
			&response); err != nil {
			return nil, err
		...
		if err := b.SendAuthenticatedHTTPRequest(runningSpotRest, bitstampAPIUserTransactions+"/"+currencyPair,
			true,
			url.Values{},
			&response); err != nil {
			return nil, err
...
func (b *Bitstamp) GetOpenOrders(currencyPair string) ([]Order, error) {
	...
	return resp, b.SendAuthenticatedHTTPRequest(runningSpotRest, path, true, nil, &resp)
}
...
func (b *Bitstamp) GetOrderStatus(orderID int64) (OrderStatus, error) {
	...
	return resp,
		b.SendAuthenticatedHTTPRequest(runningSpotRest, bitstampAPIOrderStatus, false, req, &resp)
}
...
func (b *Bitstamp) CancelExistingOrder(orderID int64) (CancelOrder, error) {
	...
	err := b.SendAuthenticatedHTTPRequest(runningSpotRest, bitstampAPICancelOrder, true, req, &result)
	if err != nil {
		return result, err
	}
...
func (b *Bitstamp) CancelAllExistingOrders() (bool, error) {
	...
	return result,
		b.SendAuthenticatedHTTPRequest(runningSpotRest, bitstampAPICancelAllOrders, false, nil, &result)
}
...
func (b *Bitstamp) PlaceOrder(currencyPair string, price, amount float64, buy, market bool) (Order, error) {
	...
	return response,
		b.SendAuthenticatedHTTPRequest(runningSpotRest, path, true, req, &response)
}
...
func (b *Bitstamp) GetWithdrawalRequests(timedelta int64) ([]WithdrawalRequests, error) {
	...
	return resp,
		b.SendAuthenticatedHTTPRequest(runningSpotRest, bitstampAPIWithdrawalRequests, false, value, &resp)
}
...
func (b *Bitstamp) CryptoWithdrawal(amount float64, address, symbol, destTag string, instant bool) (CryptoWithdrawalResponse, error) {
	...
	return resp, b.SendAuthenticatedHTTPRequest(runningSpotRest, endpoint, false, req, &resp)
}
...
func (b *Bitstamp) OpenBankWithdrawal(amount float64, currency,
	...
	return resp, b.SendAuthenticatedHTTPRequest(runningSpotRest, bitstampAPIOpenWithdrawal, true, req, &resp)
}
...
func (b *Bitstamp) GetCryptoDepositAddress(crypto currency.Code) (string, error) {
	...
	case currency.BTC:
		return resp,
			b.SendAuthenticatedHTTPRequest(runningSpotRest, bitstampAPIBitcoinDeposit, false, nil, &resp)

	case currency.LTC:
		return v2Resp.Address,
			b.SendAuthenticatedHTTPRequest(runningSpotRest, bitstampAPILitecoinDeposit, true, nil, &v2Resp)

	case currency.ETH:
		return v2Resp.Address,
			b.SendAuthenticatedHTTPRequest(runningSpotRest, bitstampAPIEthereumDeposit, true, nil, &v2Resp)

	case currency.XRP:
		return v2Resp.Address,
			b.SendAuthenticatedHTTPRequest(runningSpotRest, bitstampAPIXrpDeposit, true, nil, &v2Resp)

	case currency.BCH:
		return v2Resp.Address,
			b.SendAuthenticatedHTTPRequest(runningSpotRest, bitstampAPIBitcoinCashDeposit, true, nil, &v2Resp)
...
func (b *Bitstamp) GetUnconfirmedBitcoinDeposits() ([]UnconfirmedBTCTransactions, error) {
	...
	return response,
		b.SendAuthenticatedHTTPRequest(runningSpotRest, bitstampAPIUnconfirmedBitcoin, false, nil, &response)
}
...
func (b *Bitstamp) OHLC(currency string, start, end time.Time, step, limit string) (resp OHLCResponse, err error) {
	...
	return resp, b.SendHTTPRequest(runningSpotRest, common.EncodeURLValues("/v"+bitstampAPIVersion+"/"+bitstampOHLC+"/"+currency, v), &resp)
}
...
func (b *Bitstamp) TransferAccountBalance(amount float64, currency, subAccount string, toMain bool) error {
	...
	return b.SendAuthenticatedHTTPRequest(runningSpotRest, path, true, req, &resp)
}
