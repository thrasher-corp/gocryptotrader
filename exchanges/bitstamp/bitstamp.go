...
func (b *Bitstamp) GetTicker(currency string, hourly bool) (*Ticker, error) {
	...
	return &response, b.SendHTTPRequest(exchange.DefaultRest, path, &response)
}
...
func (b *Bitstamp) GetTradingPairs() ([]TradingPair, error) {
	...
	return result, b.SendHTTPRequest(exchange.DefaultRest, path, &result)
}
...
func (b *Bitstamp) GetTransactions(currencyPair, timePeriod string) ([]Transactions, error) {
	...
	return transactions, b.SendHTTPRequest(exchange.DefaultRest, requestURL, &transactions)
}
...
func (b *Bitstamp) GetEURUSDConversionRate() (EURUSDConversionRate, error) {
	...
	return rate, b.SendHTTPRequest(exchange.DefaultRest, path, &rate)
}

// GetBalance returns full balance of currency held on the exchange
func (b *Bitstamp) GetBalance() (Balances, error) {
	var balance map[string]string
	err := b.SendAuthenticatedHTTPRequest(exchange.DefaultRest, bitstampAPIBalance, true, nil, &balance)
	if err != nil {
		return nil, err
	}
...
func (b *Bitstamp) GetUserTransactions(currencyPair string) ([]UserTransactions, error) {
	...
	if currencyPair == "" {
		if err := b.SendAuthenticatedHTTPRequest(exchange.DefaultRest, bitstampAPIUserTransactions,
			true,
			url.Values{},
			&response); err != nil {
			return nil, err
		...
		if err := b.SendAuthenticatedHTTPRequest(exchange.DefaultRest, bitstampAPIUserTransactions+"/"+currencyPair,
			true,
			url.Values{},
			&response); err != nil {
			return nil, err
...
func (b *Bitstamp) GetOpenOrders(currencyPair string) ([]Order, error) {
	...
	return resp, b.SendAuthenticatedHTTPRequest(exchange.DefaultRest, path, true, nil, &resp)
}
...
func (b *Bitstamp) GetOrderStatus(orderID int64) (OrderStatus, error) {
	...
	return resp,
		b.SendAuthenticatedHTTPRequest(exchange.DefaultRest, bitstampAPIOrderStatus, false, req, &resp)
}
...
func (b *Bitstamp) CancelExistingOrder(orderID int64) (CancelOrder, error) {
	...
	err := b.SendAuthenticatedHTTPRequest(exchange.DefaultRest, bitstampAPICancelOrder, true, req, &result)
	if err != nil {
		return result, err
	}
...
func (b *Bitstamp) CancelAllExistingOrders() (bool, error) {
	...
	return result,
		b.SendAuthenticatedHTTPRequest(exchange.DefaultRest, bitstampAPICancelAllOrders, false, nil, &result)
}
...
func (b *Bitstamp) PlaceOrder(currencyPair string, price, amount float64, buy, market bool) (Order, error) {
	...
	return response,
		b.SendAuthenticatedHTTPRequest(exchange.DefaultRest, path, true, req, &response)
}
...
func (b *Bitstamp) GetWithdrawalRequests(timedelta int64) ([]WithdrawalRequests, error) {
	...
	return resp,
		b.SendAuthenticatedHTTPRequest(exchange.DefaultRest, bitstampAPIWithdrawalRequests, false, value, &resp)
}
...
func (b *Bitstamp) CryptoWithdrawal(amount float64, address, symbol, destTag string, instant bool) (CryptoWithdrawalResponse, error) {
	...
	return resp, b.SendAuthenticatedHTTPRequest(exchange.DefaultRest, endpoint, false, req, &resp)
}
...
func (b *Bitstamp) OpenBankWithdrawal(amount float64, currency,
	...
	return resp, b.SendAuthenticatedHTTPRequest(exchange.DefaultRest, bitstampAPIOpenWithdrawal, true, req, &resp)
}
...
func (b *Bitstamp) GetCryptoDepositAddress(crypto currency.Code) (string, error) {
	...
	case currency.BTC:
		return resp,
			b.SendAuthenticatedHTTPRequest(exchange.DefaultRest, bitstampAPIBitcoinDeposit, false, nil, &resp)

	case currency.LTC:
		return v2Resp.Address,
			b.SendAuthenticatedHTTPRequest(exchange.DefaultRest, bitstampAPILitecoinDeposit, true, nil, &v2Resp)

	case currency.ETH:
		return v2Resp.Address,
			b.SendAuthenticatedHTTPRequest(exchange.DefaultRest, bitstampAPIEthereumDeposit, true, nil, &v2Resp)

	case currency.XRP:
		return v2Resp.Address,
			b.SendAuthenticatedHTTPRequest(exchange.DefaultRest, bitstampAPIXrpDeposit, true, nil, &v2Resp)

	case currency.BCH:
		return v2Resp.Address,
			b.SendAuthenticatedHTTPRequest(exchange.DefaultRest, bitstampAPIBitcoinCashDeposit, true, nil, &v2Resp)
...
func (b *Bitstamp) GetUnconfirmedBitcoinDeposits() ([]UnconfirmedBTCTransactions, error) {
	...
	return response,
		b.SendAuthenticatedHTTPRequest(exchange.DefaultRest, bitstampAPIUnconfirmedBitcoin, false, nil, &response)
}
...
func (b *Bitstamp) OHLC(currency string, start, end time.Time, step, limit string) (resp OHLCResponse, err error) {
	...
	return resp, b.SendHTTPRequest(exchange.DefaultRest, common.EncodeURLValues("/v"+bitstampAPIVersion+"/"+bitstampOHLC+"/"+currency, v), &resp)
}
...
func (b *Bitstamp) TransferAccountBalance(amount float64, currency, subAccount string, toMain bool) error {
	...
	return b.SendAuthenticatedHTTPRequest(exchange.DefaultRest, path, true, req, &resp)
}

// SendHTTPRequest sends an unauthenticated HTTP request
func (b *Bitstamp) SendHTTPRequest(ep, path string, result interface{}) error {
...
func (b *Bitstamp) SendAuthenticatedHTTPRequest(ep, path string, v2 bool, values url.Values, result interface{}) error {
