...
func TestRetrieve(t *testing.T) {
	...
	assert.Equal(t, d.options.reachedGCTAt, ob.ReachedGCTAt, "Should have correct ReachedCodeAt")
	assert.Equal(t, d.options.checksumCompletedAt, ob.ChecksumCompletedAt, "Should have correct ChecksumDoneAt")
