...
func TestGetHistoricCandles(t *testing.T) {
	...
	builder, err := b.GetKlineBuilder(pair, asset.Spot, kline.OneHour, startTime, endTime)
	if err != nil {
		t.Fatal(err)
	}
	...
	builder, err = b.GetKlineBuilder(pair, asset.Spot, kline.OneMin*1337, startTime, endTime)
	if err != nil {
		t.Fatal(err)
	}
