...
func TestWsSubscribedResponse(t *testing.T) {
	...
	spotWebsocket.AddSuccessfulSubscriptions(stream.ChannelSubscription{Key: "waiter1"})
	err = b.wsHandleData([]byte(`{"event":"subscribed","channel":"ticker","chanId":224555,"subId":"waiter1","symbol":"tBTCUSD","pair":"BTCUSD"}`))
...
func TestWsOrderBook(t *testing.T) {
	...
	spotWebsocket.AddSuccessfulSubscriptions(stream.ChannelSubscription{Key: 23405, Asset: asset.Spot, Currency: btcusdPair, Channel: wsBook})
...
func TestWsTradeResponse(t *testing.T) {
	...
	spotWebsocket.AddSuccessfulSubscriptions(stream.ChannelSubscription{Asset: asset.Spot, Currency: btcusdPair, Channel: wsTrades, Key: 18788})
...
func TestWsTickerResponse(t *testing.T) {
	...
	spotWebsocket.AddSuccessfulSubscriptions(stream.ChannelSubscription{Asset: asset.Spot, Currency: btcusdPair, Channel: wsTicker, Key: 11534})
	...
	spotWebsocket.AddSuccessfulSubscriptions(stream.ChannelSubscription{Asset: asset.Spot, Currency: pair, Channel: wsTicker, Key: 123412})
	...
	spotWebsocket.AddSuccessfulSubscriptions(stream.ChannelSubscription{Asset: asset.Spot, Currency: pair, Channel: wsTicker, Key: 123413})
	...
	spotWebsocket.AddSuccessfulSubscriptions(stream.ChannelSubscription{Asset: asset.Spot, Currency: pair, Channel: wsTicker, Key: 123414})
...
func TestWsCandleResponse(t *testing.T) {
	...
	spotWebsocket.AddSuccessfulSubscriptions(stream.ChannelSubscription{Asset: asset.Spot, Currency: btcusdPair, Channel: wsCandles, Key: 343351})
