...
func TestWsSubscribedResponse(t *testing.T) {
	...
	spotWebsocket.AddSuccessfulSubscriptions(stream.ChannelSubscription{Asset: asset.Spot, Currency: pair, Channel: wsCandles, Params: map[string]interface{}{"chanId": 224557}})
	...
	spotWebsocket.AddSuccessfulSubscriptions(stream.ChannelSubscription{Asset: asset.MarginFunding, Currency: pair, Channel: wsCandles, Params: map[string]interface{}{"chanId": 224558}})
	...
	spotWebsocket.AddSuccessfulSubscriptions(stream.ChannelSubscription{Asset: asset.MarginFunding, Currency: pair, Channel: wsCandles, Params: map[string]interface{}{"chanId": 224559}})
...
func TestChanForSub(t *testing.T) {
	...
	spotWebsocket.AddSuccessfulSubscriptions(stream.ChannelSubscription{Asset: asset.Spot, Currency: btcusdPair, Channel: wsTicker})

	want := stream.ChannelSubscription{Asset: asset.Spot, Currency: p, Channel: wsBook}
	spotWebsocket.AddSuccessfulSubscriptions(want)
	s, err = b.chanForSub(wsBook, asset.Spot, p)
