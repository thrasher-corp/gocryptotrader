...
func TestWsSubscribedResponse(t *testing.T) {
	...
	err = b.Websocket.AddSuccessfulSubscriptions(nil, subscription.Subscription{Key: "waiter1"})
	require.NoError(t, err, "Adding a successful subscription should not error")
	err = b.wsHandleData([]byte(`{"event":"subscribed","channel":"ticker","chanId":224555,"subId":"waiter1","symbol":"tBTCUSD","pair":"BTCUSD"}`))
...
func TestWsOrderBook(t *testing.T) {
	err := b.Websocket.AddSuccessfulSubscriptions(nil, subscription.Subscription{Key: 23405, Asset: asset.Spot, Pair: btcusdPair, Channel: wsBook})
	require.NoError(t, err, "Adding a successful subscription should not error")
...
func TestWsTradeResponse(t *testing.T) {
	err := b.Websocket.AddSuccessfulSubscriptions(nil, subscription.Subscription{Asset: asset.Spot, Pair: btcusdPair, Channel: wsTrades, Key: 18788})
	require.NoError(t, err, "Adding a successful subscription should not error")
...
func TestWsTickerResponse(t *testing.T) {
	err := b.Websocket.AddSuccessfulSubscriptions(nil, subscription.Subscription{Asset: asset.Spot, Pair: btcusdPair, Channel: wsTicker, Key: 11534})
	require.NoError(t, err, "Adding a successful subscription should not error")
	...
	err = b.Websocket.AddSuccessfulSubscriptions(nil, subscription.Subscription{Asset: asset.Spot, Pair: pair, Channel: wsTicker, Key: 123412})
	require.NoError(t, err, "Adding a successful subscription should not error")
	...
	err = b.Websocket.AddSuccessfulSubscriptions(nil, subscription.Subscription{Asset: asset.Spot, Pair: pair, Channel: wsTicker, Key: 123413})
	require.NoError(t, err, "Adding a successful subscription should not error")
	...
	err = b.Websocket.AddSuccessfulSubscriptions(nil, subscription.Subscription{Asset: asset.Spot, Pair: pair, Channel: wsTicker, Key: 123414})
	require.NoError(t, err, "Adding a successful subscription should not error")
...
func TestWsCandleResponse(t *testing.T) {
	err := b.Websocket.AddSuccessfulSubscriptions(nil, subscription.Subscription{Asset: asset.Spot, Pair: btcusdPair, Channel: wsCandles, Key: 343351})
	require.NoError(t, err, "Adding a successful subscription should not error")
