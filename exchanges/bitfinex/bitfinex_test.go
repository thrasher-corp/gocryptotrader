...
func TestWsOrderBook(t *testing.T) {
	b.Websocket.AddSuccessfulSubscriptions(subscription.Subscription{Key: 23405, Asset: asset.Spot, Currency: btcusdPair, Channel: wsBook})
...
func TestWsTradeResponse(t *testing.T) {
	b.Websocket.AddSuccessfulSubscriptions(subscription.Subscription{Asset: asset.Spot, Currency: btcusdPair, Channel: wsTrades, Key: 18788})
...
func TestWsTickerResponse(t *testing.T) {
	b.Websocket.AddSuccessfulSubscriptions(subscription.Subscription{Asset: asset.Spot, Currency: btcusdPair, Channel: wsTicker, Key: 11534})
	...
	b.Websocket.AddSuccessfulSubscriptions(subscription.Subscription{Asset: asset.Spot, Currency: pair, Channel: wsTicker, Key: 123412})
	...
	b.Websocket.AddSuccessfulSubscriptions(subscription.Subscription{Asset: asset.Spot, Currency: pair, Channel: wsTicker, Key: 123413})
	...
	b.Websocket.AddSuccessfulSubscriptions(subscription.Subscription{Asset: asset.Spot, Currency: pair, Channel: wsTicker, Key: 123414})
...
func TestWsCandleResponse(t *testing.T) {
	b.Websocket.AddSuccessfulSubscriptions(subscription.Subscription{Asset: asset.Spot, Currency: btcusdPair, Channel: wsCandles, Key: 343351})
