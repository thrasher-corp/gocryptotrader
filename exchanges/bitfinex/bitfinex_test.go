...
func TestWsSubscribedResponse(t *testing.T) {
	...
	b.Websocket.AddSubscription(&subscription.Subscription{Key: "waiter1"})
	err = b.wsHandleData([]byte(`{"event":"subscribed","channel":"ticker","chanId":224555,"subId":"waiter1","symbol":"tBTCUSD","pair":"BTCUSD"}`))
...
func TestWsOrderBook(t *testing.T) {
	b.Websocket.AddSubscription(&subscription.Subscription{Key: 23405, Asset: asset.Spot, Pairs: currency.Pairs{btcusdPair}, Channel: wsBook})
...
func TestWsTradeResponse(t *testing.T) {
	b.Websocket.AddSubscription(&subscription.Subscription{Asset: asset.Spot, Pairs: currency.Pairs{btcusdPair}, Channel: wsTrades, Key: 18788})
...
func TestWsTickerResponse(t *testing.T) {
	b.Websocket.AddSubscription(&subscription.Subscription{Asset: asset.Spot, Pairs: currency.Pairs{btcusdPair}, Channel: wsTicker, Key: 11534})
	...
	b.Websocket.AddSubscription(&subscription.Subscription{Asset: asset.Spot, Pairs: currency.Pairs{pair}, Channel: wsTicker, Key: 123412})
	...
	b.Websocket.AddSubscription(&subscription.Subscription{Asset: asset.Spot, Pairs: currency.Pairs{pair}, Channel: wsTicker, Key: 123413})
	...
	b.Websocket.AddSubscription(&subscription.Subscription{Asset: asset.Spot, Pairs: currency.Pairs{pair}, Channel: wsTicker, Key: 123414})
...
func TestWsCandleResponse(t *testing.T) {
	b.Websocket.AddSubscription(&subscription.Subscription{Asset: asset.Spot, Pairs: currency.Pairs{btcusdPair}, Channel: wsCandles, Key: 343351})
