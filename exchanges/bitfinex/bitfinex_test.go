...
func TestWsSubscribedResponse(t *testing.T) {
	...
	m, err := spotWebsocket.Match.Set("subscribe:waiter1")
	...
	err = spotWebsocket.AddSubscriptions(&subscription.Subscription{Key: "waiter1"})
...
func TestWsOrderBook(t *testing.T) {
	...
	err = spotWebsocket.AddSubscriptions(&subscription.Subscription{Key: 23405, Asset: asset.Spot, Pairs: currency.Pairs{btcusdPair}, Channel: wsBook})
	require.NoError(t, err, "AddSubscriptions must not error")
...
func TestWsTradeResponse(t *testing.T) {
	...
	err = spotWebsocket.AddSubscriptions(&subscription.Subscription{Asset: asset.Spot, Pairs: currency.Pairs{btcusdPair}, Channel: wsTrades, Key: 18788})
	require.NoError(t, err, "AddSubscriptions must not error")
...
func TestWsTickerResponse(t *testing.T) {
	spotWebsocket, err := b.Websocket.GetAssetWebsocket(asset.Spot)
	require.NoError(t, err)
	err = spotWebsocket.AddSubscriptions(&subscription.Subscription{Asset: asset.Spot, Pairs: currency.Pairs{btcusdPair}, Channel: wsTicker, Key: 11534})
	require.NoError(t, err, "AddSubscriptions must not error")
	...
	err = spotWebsocket.AddSubscriptions(&subscription.Subscription{Asset: asset.Spot, Pairs: currency.Pairs{pair}, Channel: wsTicker, Key: 123412})
	require.NoError(t, err, "AddSubscriptions must not error")
	...
	err = spotWebsocket.AddSubscriptions(&subscription.Subscription{Asset: asset.Spot, Pairs: currency.Pairs{pair}, Channel: wsTicker, Key: 123413})
	require.NoError(t, err, "AddSubscriptions must not error")
	...
	err = spotWebsocket.AddSubscriptions(&subscription.Subscription{Asset: asset.Spot, Pairs: currency.Pairs{pair}, Channel: wsTicker, Key: 123414})
	require.NoError(t, err, "AddSubscriptions must not error")
...
func TestWsCandleResponse(t *testing.T) {
	spotWebsocket, err := b.Websocket.GetAssetWebsocket(asset.Spot)
	require.NoError(t, err)
	err = spotWebsocket.AddSubscriptions(&subscription.Subscription{Asset: asset.Spot, Pairs: currency.Pairs{btcusdPair}, Channel: wsCandles, Key: 343351})
	require.NoError(t, err, "AddSubscriptions must not error")
