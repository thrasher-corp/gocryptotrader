...
func (c *COINUT) GetInstruments() (Instruments, error) {
	...
	return result, c.SendHTTPRequest(defaultRest, coinutInstruments, params, false, &result)
}
...
func (c *COINUT) GetInstrumentTicker(instrumentID int64) (Ticker, error) {
	...
	return result, c.SendHTTPRequest(defaultRest, coinutTicker, params, false, &result)
}
...
func (c *COINUT) GetInstrumentOrderbook(instrumentID, limit int64) (Orderbook, error) {
	...
	return result, c.SendHTTPRequest(defaultRest, coinutOrderbook, params, false, &result)
}
...
func (c *COINUT) GetTrades(instrumentID int64) (Trades, error) {
	...
	return result, c.SendHTTPRequest(defaultRest, coinutTrades, params, false, &result)
}

// GetUserBalance returns the full user balance
func (c *COINUT) GetUserBalance() (*UserBalance, error) {
	var result *UserBalance
	return result, c.SendHTTPRequest(defaultRest, coinutBalance, nil, true, &result)
}
...
func (c *COINUT) NewOrder(instrumentID int64, quantity, price float64, buy bool, orderID uint32) (interface{}, error) {
	...
	return result, c.SendHTTPRequest(defaultRest, coinutOrder, params, true, &result)
}
...
func (c *COINUT) NewOrders(orders []Order) ([]OrdersBase, error) {
	...
	return result.Data, c.SendHTTPRequest(defaultRest, coinutOrders, params, true, &result.Data)
}
...
func (c *COINUT) GetOpenOrders(instrumentID int64) (GetOpenOrdersResponse, error) {
	...
	params := make(map[string]interface{})
	params["inst_id"] = instrumentID
	return result, c.SendHTTPRequest(defaultRest, coinutOrdersOpen, params, true, &result)
}
...
func (c *COINUT) CancelExistingOrder(instrumentID, orderID int64) (bool, error) {
	...
	err := c.SendHTTPRequest(defaultRest, coinutOrdersCancel, params, true, &result)
	if err != nil {
		return false, err
	}
	return true, nil
...
func (c *COINUT) CancelOrders(orders []CancelOrders) (CancelOrdersResponse, error) {
	...
	return result, c.SendHTTPRequest(defaultRest, coinutOrdersCancel, params, true, &result)
}
...
func (c *COINUT) GetTradeHistory(instrumentID, start, limit int64) (TradeHistory, error) {
	...
	return result, c.SendHTTPRequest(defaultRest, coinutTradeHistory, params, true, &result)
}
...
func (c *COINUT) GetIndexTicker(asset string) (IndexTicker, error) {
	...
	return result, c.SendHTTPRequest(defaultRest, coinutIndexTicker, params, false, &result)
}
...
func (c *COINUT) GetOptionChain(asset, secType string) (OptionChainResponse, error) {
	...
	return result, c.SendHTTPRequest(defaultRest, coinutOptionChain, params, false, &result)
}
...
func (c *COINUT) GetPositionHistory(secType string, start, limit int) (PositionHistory, error) {
	...
	return result, c.SendHTTPRequest(defaultRest, coinutPositionHistory, params, true, &result)
}
...
func (c *COINUT) GetOpenPositions(instrumentID int) ([]OpenPosition, error) {
	...
	return result.Positions,
		c.SendHTTPRequest(defaultRest, coinutPositionOpen, params, true, &result)
}
