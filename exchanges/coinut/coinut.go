...
func (c *COINUT) GetInstruments() (Instruments, error) {
	...
	return result, c.SendHTTPRequest(exchange.DefaultRest, coinutInstruments, params, false, &result)
}
...
func (c *COINUT) GetInstrumentTicker(instrumentID int64) (Ticker, error) {
	...
	return result, c.SendHTTPRequest(exchange.DefaultRest, coinutTicker, params, false, &result)
}
...
func (c *COINUT) GetInstrumentOrderbook(instrumentID, limit int64) (Orderbook, error) {
	...
	return result, c.SendHTTPRequest(exchange.DefaultRest, coinutOrderbook, params, false, &result)
}
...
func (c *COINUT) GetTrades(instrumentID int64) (Trades, error) {
	...
	return result, c.SendHTTPRequest(exchange.DefaultRest, coinutTrades, params, false, &result)
}

// GetUserBalance returns the full user balance
func (c *COINUT) GetUserBalance() (*UserBalance, error) {
	var result *UserBalance
	return result, c.SendHTTPRequest(exchange.DefaultRest, coinutBalance, nil, true, &result)
}
...
func (c *COINUT) NewOrder(instrumentID int64, quantity, price float64, buy bool, orderID uint32) (interface{}, error) {
	...
	return result, c.SendHTTPRequest(exchange.DefaultRest, coinutOrder, params, true, &result)
}
...
func (c *COINUT) NewOrders(orders []Order) ([]OrdersBase, error) {
	...
	return result.Data, c.SendHTTPRequest(exchange.DefaultRest, coinutOrders, params, true, &result.Data)
}
...
func (c *COINUT) GetOpenOrders(instrumentID int64) (GetOpenOrdersResponse, error) {
	...
	params := make(map[string]interface{})
	params["inst_id"] = instrumentID
	return result, c.SendHTTPRequest(exchange.DefaultRest, coinutOrdersOpen, params, true, &result)
}
...
func (c *COINUT) CancelExistingOrder(instrumentID, orderID int64) (bool, error) {
	...
	err := c.SendHTTPRequest(exchange.DefaultRest, coinutOrdersCancel, params, true, &result)
	if err != nil {
		return false, err
	}
	return true, nil
...
func (c *COINUT) CancelOrders(orders []CancelOrders) (CancelOrdersResponse, error) {
	...
	return result, c.SendHTTPRequest(exchange.DefaultRest, coinutOrdersCancel, params, true, &result)
}
...
func (c *COINUT) GetTradeHistory(instrumentID, start, limit int64) (TradeHistory, error) {
	...
	return result, c.SendHTTPRequest(exchange.DefaultRest, coinutTradeHistory, params, true, &result)
}
...
func (c *COINUT) GetIndexTicker(asset string) (IndexTicker, error) {
	...
	return result, c.SendHTTPRequest(exchange.DefaultRest, coinutIndexTicker, params, false, &result)
}
...
func (c *COINUT) GetOptionChain(asset, secType string) (OptionChainResponse, error) {
	...
	return result, c.SendHTTPRequest(exchange.DefaultRest, coinutOptionChain, params, false, &result)
}
...
func (c *COINUT) GetPositionHistory(secType string, start, limit int) (PositionHistory, error) {
	...
	return result, c.SendHTTPRequest(exchange.DefaultRest, coinutPositionHistory, params, true, &result)
}
...
func (c *COINUT) GetOpenPositions(instrumentID int) ([]OpenPosition, error) {
	...
	return result.Positions,
		c.SendHTTPRequest(exchange.DefaultRest, coinutPositionOpen, params, true, &result)
}

// to-do: user position update via websocket

// SendHTTPRequest sends either an authenticated or unauthenticated HTTP request
func (c *COINUT) SendHTTPRequest(ep, apiRequest string, params map[string]interface{}, authenticated bool, result interface{}) (err error) {
