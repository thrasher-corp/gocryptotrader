	...
	var balances = []account.Balance{
		{
			...
			Total:                  bal.BCH,
			Free:                   bal.BCH,
			AvailableWithoutBorrow: bal.BCH,
		},
		{
			CurrencyName:           currency.BTC,
			Total:                  bal.BTC,
			Free:                   bal.BTC,
			AvailableWithoutBorrow: bal.BTC,
		},
		{
			CurrencyName:           currency.BTG,
			Total:                  bal.BTG,
			Free:                   bal.BTG,
			AvailableWithoutBorrow: bal.BTG,
		},
		{
			CurrencyName:           currency.CAD,
			Total:                  bal.CAD,
			Free:                   bal.CAD,
			AvailableWithoutBorrow: bal.CAD,
		},
		{
			CurrencyName:           currency.ETC,
			Total:                  bal.ETC,
			Free:                   bal.ETC,
			AvailableWithoutBorrow: bal.ETC,
		},
		{
			CurrencyName:           currency.ETH,
			Total:                  bal.ETH,
			Free:                   bal.ETH,
			AvailableWithoutBorrow: bal.ETH,
		},
		{
			CurrencyName:           currency.LCH,
			Total:                  bal.LCH,
			Free:                   bal.LCH,
			AvailableWithoutBorrow: bal.LCH,
		},
		{
			CurrencyName:           currency.LTC,
			Total:                  bal.LTC,
			Free:                   bal.LTC,
			AvailableWithoutBorrow: bal.LTC,
		},
		{
			CurrencyName:           currency.MYR,
			Total:                  bal.MYR,
			Free:                   bal.MYR,
			AvailableWithoutBorrow: bal.MYR,
		},
		{
			CurrencyName:           currency.SGD,
			Total:                  bal.SGD,
			Free:                   bal.SGD,
			AvailableWithoutBorrow: bal.SGD,
		},
		{
			CurrencyName:           currency.USD,
			Total:                  bal.USD,
			Free:                   bal.USD,
			AvailableWithoutBorrow: bal.USD,
		},
		{
			CurrencyName:           currency.USDT,
			Total:                  bal.USDT,
			Free:                   bal.USDT,
			AvailableWithoutBorrow: bal.USDT,
		},
		{
			CurrencyName:           currency.XMR,
			Total:                  bal.XMR,
			Free:                   bal.XMR,
			AvailableWithoutBorrow: bal.XMR,
		},
		{
			CurrencyName:           currency.ZEC,
			Total:                  bal.ZEC,
			Free:                   bal.ZEC,
			AvailableWithoutBorrow: bal.ZEC,
		},
	}
