...
func TestGetFeeByTypeOfflineTradeFee(t *testing.T) {
	...
	if !sharedtestvalues.AreAPIkeysSet(i) {
...
func TestGetActiveOrders(t *testing.T) {
	...
	if sharedtestvalues.AreAPIkeysSet(i) && err != nil {
		t.Errorf("Could not get open orders: %s", err)
	} else if !sharedtestvalues.AreAPIkeysSet(i) && err == nil {
...
func TestSubmitOrder(t *testing.T) {
	...
	sharedtestvalues.SkipCredentialsSetCantManipulate(t, i, canManipulateRealOrders)
	...
	if sharedtestvalues.AreAPIkeysSet(i) && (err != nil || response.Status != order.New) {
...
func TestGetAccountInfo(t *testing.T) {
	t.Parallel()
	sharedtestvalues.SkipUnsetCredentials(t, i)
