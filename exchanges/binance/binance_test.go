...
func TestQueryOrder(t *testing.T) {
	...
	switch {
	case sharedtestvalues.AreAPIkeysSet(b) && err != nil:
		t.Error("QueryOrder() error", err)
	case !sharedtestvalues.AreAPIkeysSet(b) && err == nil && !mockTests:
...
func TestGetFeeByTypeOfflineTradeFee(t *testing.T) {
	...
	if !sharedtestvalues.AreAPIkeysSet(b) || mockTests {
...
func TestGetWsAuthStreamKey(t *testing.T) {
	...
	switch {
	case mockTests && err != nil,
		!mockTests && sharedtestvalues.AreAPIkeysSet(b) && err != nil:
		t.Fatal(err)
	case !mockTests && !sharedtestvalues.AreAPIkeysSet(b) && err == nil:
		t.Fatal("Expected error")
	}

	if key == "" && (sharedtestvalues.AreAPIkeysSet(b) || mockTests) {
