...
func TestGetFuturesSwapTickerChangeStats(t *testing.T) {
	...
	_, err = b.GetFuturesSwapTickerChangeStats("BTCUSD_201225", "")
	if err != nil {
		t.Error(err)
	}
...
func TestGetFuturesOrderbookTicker(t *testing.T) {
	...
	_, err = b.GetFuturesOrderbookTicker("BTCUSD_201225", "")
	if err != nil {
		t.Error(err)
	}
}
...
func TestGetExchangeInfo(t *testing.T) {
	...
	if mockTests {
		serverTime := time.Date(2020, 10, 16, 6, 32, 00, int(516*time.Millisecond), time.UTC)
