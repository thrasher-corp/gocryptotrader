...
func TestUpdateTicker(t *testing.T) {
	...
	require.NoError(t, err)
	require.False(t, r.Pair.Base != currency.DOGE && r.Pair.Quote != currency.USDT, "invalid pair values")
	...
	require.NoError(t, err)
	require.NotEmpty(t, usdtMarginedPairs, "no pairs are enabled")
...
func TestUpdateTickers(t *testing.T) {
	t.Parallel()
	//TODO: runtime: goroutine stack exceeds 1000000000-byte limit
...
func TestGetOrderHistory(t *testing.T) {
	...
	require.NotEmpty(t, err, "Expected: 'At least one currency is required to fetch order history'. received nil")
...
var messageMap = map[string]string{
	...
	"Contract Info":                 `{"stream": "!contractInfo", "data": {"e":"contractInfo", "E":1669356423908, "s":"IOTAUSDT", "ps":"IOTAUSDT", "ct":"PERPETUAL", "dt":4133404800000, "ot":1569398400000, "cs":"TRADING", "bks":[ { "bs":1, "bnf":0, "bnc":5000, "mmr":0.01, "cf":0, "mi":21, "ma":50 }, { "bs":2, "bnf":5000, "bnc":25000, "mmr":0.025, "cf":75, "mi":11, "ma":20 } ] }}`, //nolint:codespell // Variable name 'ot' represents Onboard date time
