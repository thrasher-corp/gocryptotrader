...
const (
	...
	testnetSpotURL = "https://testnet.binance.vision/api" //nolint:unused // Can be used for testing
	testnetFutures = "https://testnet.binancefuture.com"  //nolint:unused // Can be used for testing
