...
func (c *CoinbasePro) Subscribe(ctx context.Context, channelsToSubscribe []subscription.Subscription) error {
...
func (c *CoinbasePro) Unsubscribe(_ context.Context, channelsToUnsubscribe []subscription.Subscription) error {
