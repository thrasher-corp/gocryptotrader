...
func (c *CoinbasePro) PlaceLimitOrder(ctx context.Context, clientRef string, price, amount float64, side, timeInforce string, cancelAfter, productID, stp string, postOnly bool) (string, error) {
