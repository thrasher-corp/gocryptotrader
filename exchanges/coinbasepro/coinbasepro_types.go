...
// UnixTimestampMilli is a type used to unmarshal unix millisecond timestamps returned from
// the exchange, used in the type ServerTimeV3
type UnixTimestampMilli time.Time
