...
func (b *Bitmex) Subscribe(_ context.Context, channelsToSubscribe []stream.ChannelSubscription) error {
...
func (b *Bitmex) Unsubscribe(_ context.Context, channelsToUnsubscribe []stream.ChannelSubscription) error {
