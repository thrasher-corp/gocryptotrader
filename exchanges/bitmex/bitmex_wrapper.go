...
func (b *Bitmex) GetWebsocket() (*monitor.Websocket, error) {
...
func (b *Bitmex) SubscribeToWebsocketChannels(channels []monitor.WebsocketChannelSubscription) error {
...
func (b *Bitmex) UnsubscribeToWebsocketChannels(channels []monitor.WebsocketChannelSubscription) error {
	b.Websocket.RemoveSubscribedChannels(channels)
	return nil
}

// GetSubscriptions returns a copied list of subscriptions
func (b *Bitmex) GetSubscriptions() ([]monitor.WebsocketChannelSubscription, error) {
