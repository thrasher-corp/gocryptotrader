...
func TestUpdateAccountInfo(t *testing.T) {
	t.Parallel()
	sharedtestvalues.SkipUnsetCredentials(t, k)
...
func TestFuturesBatchOrder(t *testing.T) {
	...
	sharedtestvalues.SkipUnsetCredentials(t, k, canManipulateRealOrders)
...
func TestGetFeeByTypeOfflineTradeFee(t *testing.T) {
	...
	if !sharedtestvalues.AreAPIkeysSet(k) {
...
func TestGetOrderHistory(t *testing.T) {
	...
	if sharedtestvalues.AreAPIkeysSet(k) && err != nil {
		t.Errorf("Could not get order history: %s", err)
	} else if !sharedtestvalues.AreAPIkeysSet(k) && err == nil {
...
func TestGetOrderInfo(t *testing.T) {
	t.Parallel()
	sharedtestvalues.SkipCredentialsSetCantManipulate(t, k, canManipulateRealOrders)
...
func TestSubmitOrder(t *testing.T) {
	...
	if sharedtestvalues.AreAPIkeysSet(k) && (err != nil || response.Status != order.New) {
...
func setupWsTests(t *testing.T) {
	...
	if !k.Websocket.IsEnabled() && !k.API.AuthenticatedWebsocketSupport || !sharedtestvalues.AreAPIkeysSet(k) {
