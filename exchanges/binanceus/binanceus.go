...
func (bi *Binanceus) GetPriceDatas(ctx context.Context) (SymbolPrices, error) {
	...
	return res, bi.SendHTTPRequest(ctx, exchange.RestSpotSupplementary, tickerPrice, spotDefaultRate, &res)
}
...
// QuickDisableCryptoWithdrawal use this endpoint to enable crypto withdrawals.
...
// GetSubaccountStatusList this endpoint retrives a status list of sub-accounts.
...
func (bi *Binanceus) GetOrderRateLimits(ctx context.Context, recvWindow uint) ([]OrderRateLimit, error) {
	...
	return resp, bi.SendAuthHTTPRequest(ctx, exchange.RestSpotSupplementary, http.MethodGet, orderRateLimit, params, spotDefaultRate, &resp)
}
...
func (bi *Binanceus) GetTrades(ctx context.Context, arg *GetTradesParams) ([]*Trade, error) {
	...
	return resp, bi.SendAuthHTTPRequest(ctx, exchange.RestSpot, http.MethodGet, myTrades, params, spotDefaultRate, &resp)
}
...
func (bi *Binanceus) GetOCOOrder(ctx context.Context, arg *GetOCOOrderRequestParams) (*OCOOrderResponse, error) {
	...
	return &response, bi.SendAuthHTTPRequest(ctx, exchange.RestSpotSupplementary, http.MethodGet, ocoOrderList, params, spotDefaultRate, &response)
}
...
func (bi *Binanceus) FiatWithdrawalHistory(ctx context.Context, arg *FiatWithdrawalRequestParams) (FiatAssetsHistory, error) {
	...
	if arg.Offset > 0 {
		params.Set("offset", strconv.Itoa(arg.Offset))
	}
...
// GetSubAccountDepositAddress retrives sub-account’s deposit address.
...
// GetSubAccountDepositHistory retrives sub-account deposit history.
...
// GetReferralRewardHistory retrives the user’s referral reward history.
func (bi *Binanceus) GetReferralRewardHistory(ctx context.Context, userBusinessType, page, rows int) (*ReferalRewardHistoryResponse, error) {
	params := url.Values{}
	...
	params.Set("timestamp", strconv.FormatInt(time.Now().UnixMilli(), 10))
	var response ReferalRewardHistoryResponse
