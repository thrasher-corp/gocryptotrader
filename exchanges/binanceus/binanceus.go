...
// GetExchangeInfo Start implementing public and private exchange API funcs below
...
// GetMostRecentTrades o get older trades. Please note the maximum limit is 1,000 trades.
