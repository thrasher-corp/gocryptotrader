...
func (t Type) Title() string {
	return strings.Title(strings.ToLower(t.String())) //nolint:go-staticcheck // Ignore Title usage warning
}
...
func (s Side) Title() string {
	return strings.Title(strings.ToLower(s.String())) //nolint:go-staticcheck // Ignore Title usage warning
}
