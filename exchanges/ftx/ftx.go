...
func (f *FTX) GetMarkets() ([]MarketData, error) {
	...
	return resp.Data, f.SendHTTPRequest(exchange.DefaultSpot, getMarkets, &resp)
}
...
func (f *FTX) GetMarket(marketName string) (MarketData, error) {
	...
	return resp.Data, f.SendHTTPRequest(exchange.DefaultSpot, getMarket+marketName,
		&resp)
}
...
func (f *FTX) GetOrderbook(marketName string, depth int64) (OrderbookData, error) {
	...
	err := f.SendHTTPRequest(exchange.DefaultSpot, fmt.Sprintf(getOrderbook, marketName, strDepth), &result)
	if err != nil {
		return resp, err
	}
...
func (f *FTX) GetTrades(marketName string, startTime, endTime, limit int64) ([]TradeData, error) {
	...
	return resp.Data, f.SendHTTPRequest(exchange.DefaultSpot, fmt.Sprintf(getTrades, marketName)+params.Encode(),
		&resp)
}
...
func (f *FTX) GetHistoricalData(marketName, timeInterval, limit string, startTime, endTime time.Time) ([]OHLCVData, error) {
	...
	return resp.Data, f.SendHTTPRequest(exchange.DefaultSpot, fmt.Sprintf(getHistoricalData, marketName)+params.Encode(), &resp)
}
...
func (f *FTX) GetFutures() ([]FuturesData, error) {
	...
	return resp.Data, f.SendHTTPRequest(exchange.DefaultSpot, getFutures, &resp)
}
...
func (f *FTX) GetFuture(futureName string) (FuturesData, error) {
	...
	return resp.Data, f.SendHTTPRequest(exchange.DefaultSpot, getFuture+futureName, &resp)
}
...
func (f *FTX) GetFutureStats(futureName string) (FutureStatsData, error) {
	...
	return resp.Data, f.SendHTTPRequest(exchange.DefaultSpot, fmt.Sprintf(getFutureStats, futureName), &resp)
}
...
func (f *FTX) GetFundingRates(startTime, endTime time.Time, future string) ([]FundingRatesData, error) {
	...
	return resp.Data, f.SendHTTPRequest(exchange.DefaultSpot, getFundingRates+params.Encode(), &resp)
}

// GetIndexWeights gets index weights
func (f *FTX) GetIndexWeights(index string) (IndexWeights, error) {
	var resp IndexWeights
	return resp, f.SendHTTPRequest(exchange.DefaultSpot, fmt.Sprintf(getIndexWeights, index), &resp)
}
...
func (f *FTX) GetAccountInfo() (AccountInfoData, error) {
	...
	return resp.Data, f.SendAuthHTTPRequest(exchange.DefaultSpot, http.MethodGet, getAccountInfo, nil, &resp)
}
...
func (f *FTX) GetPositions() ([]PositionData, error) {
	...
	return resp.Data, f.SendAuthHTTPRequest(exchange.DefaultSpot, http.MethodGet, getPositions, nil, &resp)
}
...
func (f *FTX) ChangeAccountLeverage(leverage float64) error {
	...
	return f.SendAuthHTTPRequest(exchange.DefaultSpot, http.MethodPost, setLeverage, req, nil)
}
...
func (f *FTX) GetCoins() ([]WalletCoinsData, error) {
	...
	return resp.Data, f.SendAuthHTTPRequest(exchange.DefaultSpot, http.MethodGet, getCoins, nil, &resp)
}
...
func (f *FTX) GetBalances() ([]BalancesData, error) {
	...
	return resp.Data, f.SendAuthHTTPRequest(exchange.DefaultSpot, http.MethodGet, getBalances, nil, &resp)
}
...
func (f *FTX) GetAllWalletBalances() (AllWalletAccountData, error) {
	...
	return resp.Data, f.SendAuthHTTPRequest(exchange.DefaultSpot, http.MethodGet, getAllWalletBalances, nil, &resp)
}
...
func (f *FTX) FetchDepositAddress(coin string) (DepositData, error) {
	...
	return resp.Data, f.SendAuthHTTPRequest(exchange.DefaultSpot, http.MethodGet, getDepositAddress+coin, nil, &resp)
}
...
func (f *FTX) FetchDepositHistory() ([]TransactionData, error) {
	...
	return resp.Data, f.SendAuthHTTPRequest(exchange.DefaultSpot, http.MethodGet, getDepositHistory, nil, &resp)
}
...
func (f *FTX) FetchWithdrawalHistory() ([]TransactionData, error) {
	...
	return resp.Data, f.SendAuthHTTPRequest(exchange.DefaultSpot, http.MethodGet, getWithdrawalHistory, nil, &resp)
}
...
func (f *FTX) Withdraw(coin, address, tag, password, code string, size float64) (TransactionData, error) {
	...
	return resp.Data, f.SendAuthHTTPRequest(exchange.DefaultSpot, http.MethodPost, withdrawRequest, req, &resp)
}
...
func (f *FTX) GetOpenOrders(marketName string) ([]OrderData, error) {
	...
	return resp.Data, f.SendAuthHTTPRequest(exchange.DefaultSpot, http.MethodGet, getOpenOrders+params.Encode(), nil, &resp)
}
...
func (f *FTX) FetchOrderHistory(marketName string, startTime, endTime time.Time, limit string) ([]OrderData, error) {
	...
	return resp.Data, f.SendAuthHTTPRequest(exchange.DefaultSpot, http.MethodGet, getOrderHistory+params.Encode(), nil, &resp)
}
...
func (f *FTX) GetOpenTriggerOrders(marketName, orderType string) ([]TriggerOrderData, error) {
	...
	return resp.Data, f.SendAuthHTTPRequest(exchange.DefaultSpot, http.MethodGet, getOpenTriggerOrders+params.Encode(), nil, &resp)
}
...
func (f *FTX) GetTriggerOrderTriggers(orderID string) ([]TriggerData, error) {
	...
	return resp.Data, f.SendAuthHTTPRequest(exchange.DefaultSpot, http.MethodGet, fmt.Sprintf(getTriggerOrderTriggers, orderID), nil, &resp)
}
...
func (f *FTX) GetTriggerOrderHistory(marketName string, startTime, endTime time.Time, side, orderType, limit string) ([]TriggerOrderData, error) {
	...
	return resp.Data, f.SendAuthHTTPRequest(exchange.DefaultSpot, http.MethodGet, getTriggerOrderHistory+params.Encode(), nil, &resp)
}
...
func (f *FTX) Order(marketName, side, orderType, reduceOnly, ioc, postOnly, clientID string, price, size float64) (OrderData, error) {
	...
	return resp.Data, f.SendAuthHTTPRequest(exchange.DefaultSpot, http.MethodPost, placeOrder, req, &resp)
}
...
func (f *FTX) TriggerOrder(marketName, side, orderType, reduceOnly, retryUntilFilled string, size, triggerPrice, orderPrice, trailValue float64) (TriggerOrderData, error) {
	...
	return resp.Data, f.SendAuthHTTPRequest(exchange.DefaultSpot, http.MethodPost, placeTriggerOrder, req, &resp)
}
...
func (f *FTX) ModifyPlacedOrder(orderID, clientID string, price, size float64) (OrderData, error) {
	...
	return resp.Data, f.SendAuthHTTPRequest(exchange.DefaultSpot, http.MethodPost, fmt.Sprintf(modifyOrder, orderID), req, &resp)
}
...
func (f *FTX) ModifyOrderByClientID(clientOrderID, clientID string, price, size float64) (OrderData, error) {
	...
	return resp.Data, f.SendAuthHTTPRequest(exchange.DefaultSpot, http.MethodPost, fmt.Sprintf(modifyOrderByClientID, clientOrderID), req, &resp)
}
...
func (f *FTX) ModifyTriggerOrder(orderID, orderType string, size, triggerPrice, orderPrice, trailValue float64) (TriggerOrderData, error) {
	...
	return resp.Data, f.SendAuthHTTPRequest(exchange.DefaultSpot, http.MethodPost, fmt.Sprintf(modifyTriggerOrder, orderID), req, &resp)
}
...
func (f *FTX) GetOrderStatus(orderID string) (OrderData, error) {
	...
	return resp.Data, f.SendAuthHTTPRequest(exchange.DefaultSpot, http.MethodGet, getOrderStatus+orderID, nil, &resp)
}
...
func (f *FTX) GetOrderStatusByClientID(clientOrderID string) (OrderData, error) {
	...
	return resp.Data, f.SendAuthHTTPRequest(exchange.DefaultSpot, http.MethodGet, getOrderStatusByClientID+clientOrderID, nil, &resp)
}
...
func (f *FTX) DeleteOrder(orderID string) (string, error) {
	...
	if err := f.SendAuthHTTPRequest(exchange.DefaultSpot, http.MethodDelete, deleteOrder+orderID, nil, &resp); err != nil {
		return "", err
	}
	if !resp.Success {
...
func (f *FTX) DeleteOrderByClientID(clientID string) (string, error) {
	...
	if err := f.SendAuthHTTPRequest(exchange.DefaultSpot, http.MethodDelete, deleteOrderByClientID+clientID, nil, &resp); err != nil {
		return "", err
	}
	if !resp.Success {
...
func (f *FTX) DeleteTriggerOrder(orderID string) (string, error) {
	...
	if err := f.SendAuthHTTPRequest(exchange.DefaultSpot, http.MethodDelete, cancelTriggerOrder+orderID, nil, &resp); err != nil {
		return "", err
	}
	if !resp.Success {
...
func (f *FTX) GetFills(market, limit string, startTime, endTime time.Time) ([]FillsData, error) {
	...
	return resp.Data, f.SendAuthHTTPRequest(exchange.DefaultSpot, http.MethodGet, getFills+params.Encode(), nil, &resp)
}
...
func (f *FTX) GetFundingPayments(startTime, endTime time.Time, future string) ([]FundingPaymentsData, error) {
	...
	return resp.Data, f.SendAuthHTTPRequest(exchange.DefaultSpot, http.MethodGet, getFundingPayments+params.Encode(), nil, &resp)
}
...
func (f *FTX) ListLeveragedTokens() ([]LeveragedTokensData, error) {
	...
	return resp.Data, f.SendAuthHTTPRequest(exchange.DefaultSpot, http.MethodGet, getLeveragedTokens, nil, &resp)
}
...
func (f *FTX) GetTokenInfo(tokenName string) ([]LeveragedTokensData, error) {
	...
	return resp.Data, f.SendAuthHTTPRequest(exchange.DefaultSpot, http.MethodGet, getTokenInfo+tokenName, nil, &resp)
}
...
func (f *FTX) ListLTBalances() ([]LTBalanceData, error) {
	...
	return resp.Data, f.SendAuthHTTPRequest(exchange.DefaultSpot, http.MethodGet, getLTBalances, nil, &resp)
}
...
func (f *FTX) ListLTCreations() ([]LTCreationData, error) {
	...
	return resp.Data, f.SendAuthHTTPRequest(exchange.DefaultSpot, http.MethodGet, getLTCreations, nil, &resp)
}
...
func (f *FTX) RequestLTCreation(tokenName string, size float64) (RequestTokenCreationData, error) {
	...
	return resp.Data, f.SendAuthHTTPRequest(exchange.DefaultSpot, http.MethodPost, fmt.Sprintf(requestLTCreation, tokenName), req, &resp)
}
...
func (f *FTX) ListLTRedemptions() ([]LTRedemptionData, error) {
	...
	return resp.Data, f.SendAuthHTTPRequest(exchange.DefaultSpot, http.MethodGet, getLTRedemptions, nil, &resp)
}
...
func (f *FTX) RequestLTRedemption(tokenName string, size float64) (LTRedemptionRequestData, error) {
	...
	return resp.Data, f.SendAuthHTTPRequest(exchange.DefaultSpot, http.MethodPost, fmt.Sprintf(requestLTRedemption, tokenName), req, &resp)
}
...
func (f *FTX) GetQuoteRequests() ([]QuoteRequestData, error) {
	...
	return resp.Data, f.SendAuthHTTPRequest(exchange.DefaultSpot, http.MethodGet, getListQuotes, nil, &resp)
}
...
func (f *FTX) GetYourQuoteRequests() ([]PersonalQuotesData, error) {
	...
	return resp.Data, f.SendAuthHTTPRequest(exchange.DefaultSpot, http.MethodGet, getMyQuotesRequests, nil, &resp)
}
...
func (f *FTX) CreateQuoteRequest(underlying, optionType, side string, expiry int64, requestExpiry string, strike, size, limitPrice, counterParyID float64, hideLimitPrice bool) (CreateQuoteRequestData, error) {
	...
	return resp.Data, f.SendAuthHTTPRequest(exchange.DefaultSpot, http.MethodPost, createQuoteRequest, req, &resp)
}
...
func (f *FTX) DeleteQuote(requestID string) (CancelQuoteRequestData, error) {
	...
	return resp.Data, f.SendAuthHTTPRequest(exchange.DefaultSpot, http.MethodDelete, deleteQuote+requestID, nil, &resp)
}
...
func (f *FTX) GetQuotesForYourQuote(requestID string) (QuoteForQuoteData, error) {
	...
	return resp, f.SendAuthHTTPRequest(exchange.DefaultSpot, http.MethodGet, fmt.Sprintf(endpointQuote, requestID), nil, &resp)
}
...
func (f *FTX) MakeQuote(requestID, price string) ([]QuoteForQuoteData, error) {
	...
	return resp.Data, f.SendAuthHTTPRequest(exchange.DefaultSpot, http.MethodPost, fmt.Sprintf(endpointQuote, requestID), nil, &resp)
}
...
func (f *FTX) MyQuotes() ([]QuoteForQuoteData, error) {
	...
	return resp.Data, f.SendAuthHTTPRequest(exchange.DefaultSpot, http.MethodGet, getMyQuotes, nil, &resp)
}
...
func (f *FTX) DeleteMyQuote(quoteID string) ([]QuoteForQuoteData, error) {
	...
	return resp.Data, f.SendAuthHTTPRequest(exchange.DefaultSpot, http.MethodDelete, deleteMyQuote+quoteID, nil, &resp)
}
...
func (f *FTX) AcceptQuote(quoteID string) ([]QuoteForQuoteData, error) {
	...
	return resp.Data, f.SendAuthHTTPRequest(exchange.DefaultSpot, http.MethodPost, fmt.Sprintf(acceptQuote, quoteID), nil, &resp)
}
...
func (f *FTX) GetAccountOptionsInfo() (AccountOptionsInfoData, error) {
	...
	return resp.Data, f.SendAuthHTTPRequest(exchange.DefaultSpot, http.MethodGet, getOptionsInfo, nil, &resp)
}
...
func (f *FTX) GetOptionsPositions() ([]OptionsPositionsData, error) {
	...
	return resp.Data, f.SendAuthHTTPRequest(exchange.DefaultSpot, http.MethodGet, getOptionsPositions, nil, &resp)
}
...
func (f *FTX) GetPublicOptionsTrades(startTime, endTime time.Time, limit string) ([]OptionsTradesData, error) {
	...
	return resp.Data, f.SendAuthHTTPRequest(exchange.DefaultSpot, http.MethodGet, getPublicOptionsTrades, req, &resp)
}
...
func (f *FTX) GetOptionsFills(startTime, endTime time.Time, limit string) ([]OptionFillsData, error) {
	...
	return resp.Data, f.SendAuthHTTPRequest(exchange.DefaultSpot, http.MethodGet, getOptionsFills, req, &resp)
}
...
func (f *FTX) RequestForQuotes(base, quote string, amount float64) (RequestQuoteData, error) {
	...
	req["toCoin"] = quote
	req["size"] = amount
	return resp.Data, f.SendAuthHTTPRequest(exchange.DefaultSpot, http.MethodPost, requestOTCQuote, req, &resp)
}
...
func (f *FTX) GetOTCQuoteStatus(marketName, quoteID string) ([]QuoteStatusData, error) {
	...
	params := url.Values{}
	params.Set("market", marketName)
	return resp.Data, f.SendAuthHTTPRequest(exchange.DefaultSpot, http.MethodGet, getOTCQuoteStatus+quoteID, params, &resp)
}

// AcceptOTCQuote requests for otc quotes
func (f *FTX) AcceptOTCQuote(quoteID string) error {
	return f.SendAuthHTTPRequest(exchange.DefaultSpot, http.MethodPost, fmt.Sprintf(acceptOTCQuote, quoteID), nil, nil)
}
