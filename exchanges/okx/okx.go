...
var orderTypeFromStringMap = map[string]order.Type{OkxOrderMarket: order.Market, OkxOrderLimit: order.Limit, OkxOrderPostOnly: order.PostOnly, OkxOrderFOK: order.FillOrKill, OkxOrderIOC: order.ImmediateOrCancel, OkxOrderOptimalLimitIOC: order.OptimalLimitIOC}
...
func (ok *Okx) OrderTypeFromString(orderType string) (order.Type, error) {
	orderTypeValue, okay := orderTypeFromStringMap[strings.ToLower(orderType)]
	if !okay {
		return order.UnknownType, fmt.Errorf("%w %v", order.ErrTypeIsInvalid, orderType)
	}
	return orderTypeValue, nil
}

var orderTypesToStringMap = map[order.Type]string{order.Market: OkxOrderMarket, order.Limit: OkxOrderLimit, order.PostOnly: OkxOrderPostOnly, order.FillOrKill: OkxOrderFOK, order.IOS: OkxOrderIOC, order.OptimalLimitIOC: OkxOrderOptimalLimitIOC}
...
func (ok *Okx) OrderTypeString(orderType order.Type) (string, error) {
	orderTypeString, okay := orderTypesToStringMap[orderType]
	if !okay {
		return "", fmt.Errorf("%w %v", order.ErrTypeIsInvalid, orderType)
	}
	return orderTypeString, nil
}
...
func (ok *Okx) PlaceOrder(ctx context.Context, arg *PlaceOrderRequestParam) (*OrderData, error) {
	...
	var resp *OrderData
	return resp, ok.SendHTTPRequest(ctx, exchange.RestSpot, placeOrderEPL, http.MethodPost, "trade/order", &arg, &resp, request.AuthenticatedRequest)
}
...
func (ok *Okx) SetTransactionDetailIntervalFor2Years(ctx context.Context, arg *FillArchiveParam) (time.Time, error) {
	if *arg == (FillArchiveParam{}) {
		return time.Time{}, common.ErrNilPointer
	}
	resp := &struct {
		Timestamp types.Time `json:"ts"`
	}{}
	return resp.Timestamp.Time(), ok.SendHTTPRequest(ctx, exchange.RestSpot, setTransactionDetail2YearIntervalEPL, http.MethodPost, "trade/fills-archive", arg, &resp, request.AuthenticatedRequest)
}
...
func (ok *Okx) GetTransactionDetailsLast2Year(ctx context.Context, year int64, quarter string) ([]ArchiveReference, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, exchange.RestSpot, getTransactionDetailLast2YearsEPL, http.MethodGet, common.EncodeURLValues("trade/fills-archive", params), nil, &resp, request.AuthenticatedRequest)
}
...
func (ok *Okx) PlaceAlgoOrder(ctx context.Context, arg *AlgoOrderParams) (*AlgoOrder, error) {
	...
	var resp *AlgoOrder
	return resp, ok.SendHTTPRequest(ctx, exchange.RestSpot, placeAlgoOrderEPL, http.MethodGet, "trade/order-algo", arg, &resp, request.AuthenticatedRequest)
}
...
func (ok *Okx) cancelAlgoOrder(ctx context.Context, args []AlgoOrderCancelParams, route string, rateLimit request.EndpointLimit) ([]AlgoOrder, error) {
	...
	var resp []AlgoOrder
	return resp, ok.SendHTTPRequest(ctx, exchange.RestSpot, rateLimit, http.MethodPost, route, &args, &resp, request.AuthenticatedRequest)
}
...
func (ok *Okx) Withdrawal(ctx context.Context, input *WithdrawalInput) (*WithdrawalResponse, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, exchange.RestSpot, withdrawalEPL, http.MethodPost, "asset/withdrawal", &input, &resp, request.AuthenticatedRequest)
}
...
func (ok *Okx) GetSubaccountFundingBalance(ctx context.Context, subaccountName string, ccy currency.Code) ([]FundingBalance, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, exchange.RestSpot, getSubaccountFundingBalanceEPL, http.MethodGet, common.EncodeURLValues("asset/subaccount/balances", params), nil, &resp, request.AuthenticatedRequest)
}
...
func (ok *Okx) GetSubAccountMaximumWithdrawal(ctx context.Context, subAccountName string, ccy currency.Code) ([]SubAccountMaximumWithdrawal, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, exchange.RestSpot, getSubAccountMaxWithdrawalEPL, http.MethodGet, "account/subaccount/max-withdrawal", nil, &resp, request.AuthenticatedRequest)
}
...
func (ok *Okx) RedeemETHStaking(ctx context.Context, amount float64) error {
	...
	var resp []string
	return ok.SendHTTPRequest(ctx, exchange.RestSpot, redeemETHStakingEPL, http.MethodPost, "finance/staking-defi/eth/redeem", map[string]string{"amt": strconv.FormatFloat(amount, 'f', -1, 64)}, &resp, request.AuthenticatedRequest)
}
...
func (ok *Okx) GetBETHAssetsBalance(ctx context.Context) (*BETHAssetsBalance, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, exchange.RestSpot, getBETHBalanceEPL, http.MethodGet, "finance/staking-defi/eth/balance", nil, &resp, request.AuthenticatedRequest)
}
...
func (ok *Okx) GetPurchaseAndRedeemHistory(ctx context.Context, kind, status string, after, before time.Time, limit int64) ([]PurchaseRedeemHistory, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, exchange.RestSpot, getPurchaseRedeemHistoryEPL, http.MethodGet, common.EncodeURLValues("finance/staking-defi/eth/purchase-redeem-history", params), nil, &resp, request.AuthenticatedRequest)
}
...
func (ok *Okx) GetIndexTickers(ctx context.Context, quoteCurrency currency.Code, instID string) ([]IndexTicker, error) {
	...
	return response, ok.SendHTTPRequest(ctx, exchange.RestSpot, getIndexTickersEPL, http.MethodGet, common.EncodeURLValues("market/index-tickers", params), nil, &response, request.UnauthenticatedRequest)
}
...
func (ok *Okx) getHistoricCandlesticks(ctx context.Context, instrumentID, path string, after, before time.Time, bar kline.Interval, limit int64, epl request.EndpointLimit) ([]CandlestickHistoryItem, error) {
	...
	err := ok.SendHTTPRequest(ctx, exchange.RestSpot, epl, http.MethodGet, common.EncodeURLValues(path, params), nil, &resp, request.UnauthenticatedRequest)
	if err != nil {
		return nil, err
	}
...
func (ok *Okx) GetEconomicCalendarData(ctx context.Context, region, importance string, before, after time.Time, limit int64) ([]EconomicCalendar, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, exchange.RestSpot, getEconomicCalendarEPL, http.MethodGet, "public/economic-calendar", nil, &resp, request.AuthenticatedRequest)
}
...
func (ok *Okx) Get24HTotalVolume(ctx context.Context) (*TradingVolumeIn24HR, error) {
	...
	err := ok.SendHTTPRequest(ctx, exchange.RestSpot, get24HTotalVolumeEPL, http.MethodGet, "market/platform-24-volume", nil, &resp, request.UnauthenticatedRequest)
	if err != nil {
		return nil, err
	}
	if len(resp) == 1 {
...
func (ok *Okx) GetOracle(ctx context.Context) (*OracleSmartContractResponse, error) {
	...
	err := ok.SendHTTPRequest(ctx, exchange.RestSpot, getOracleEPL, http.MethodGet, "market/open-oracle", nil, &resp, request.UnauthenticatedRequest)
	if err != nil {
		return nil, err
	}
	if len(resp) == 1 {
...
func (ok *Okx) GetExchangeRate(ctx context.Context) (*UsdCnyExchangeRate, error) {
	...
	err := ok.SendHTTPRequest(ctx, exchange.RestSpot, getExchangeRateRequestEPL, http.MethodGet, "market/exchange-rate", nil, &resp, request.UnauthenticatedRequest)
	if err != nil {
		return nil, err
	}
	if len(resp) == 1 {
...
func (ok *Okx) GetInstruments(ctx context.Context, arg *InstrumentsFetchParams) ([]Instrument, error) {
	...
	var resp []Instrument
	return resp, ok.SendHTTPRequest(ctx, exchange.RestSpot, getInstrumentsEPL, http.MethodGet, common.EncodeURLValues("public/instruments", params), nil, &resp, request.UnauthenticatedRequest)
}
...
func (ok *Okx) GetDeliveryHistory(ctx context.Context, instrumentType, underlying string, after, before time.Time, limit int64) ([]DeliveryHistory, error) {
	if underlying == "" {
		return nil, fmt.Errorf("%w, underlying is missing", errInvalidUnderlying)
	}
	...
	return resp, ok.SendHTTPRequest(ctx, exchange.RestSpot, getDeliveryExerciseHistoryEPL, http.MethodGet, common.EncodeURLValues("public/delivery-exercise-history", params), nil, &resp, request.UnauthenticatedRequest)
}
...
func (ok *Okx) GetLimitPrice(ctx context.Context, instrumentID string) (*LimitPriceResponse, error) {
	...
	if err := ok.SendHTTPRequest(ctx, exchange.RestSpot, getLimitPriceEPL, http.MethodGet, common.EncodeURLValues("public/price-limit", params), nil, &resp, request.UnauthenticatedRequest); err != nil {
		return nil, err
	}
	if len(resp) == 1 {
		return &resp[0], nil
...
func (ok *Okx) GetSystemTime(ctx context.Context) (time.Time, error) {
	resp := &ServerTime{}
	return resp.Timestamp.Time(), ok.SendHTTPRequest(ctx, exchange.RestSpot, getSystemTimeEPL, http.MethodGet, "public/time", nil, &resp, request.UnauthenticatedRequest)
}
...
func (ok *Okx) GetLiquidationOrders(ctx context.Context, arg *LiquidationOrderRequestParams) (*LiquidationOrder, error) {
	...
	err := ok.SendHTTPRequest(ctx, exchange.RestSpot, getLiquidationOrdersEPL, http.MethodGet, common.EncodeURLValues("public/liquidation-orders", params), nil, &response, request.UnauthenticatedRequest)
	if err != nil {
		return nil, err
	}
	if len(response) == 1 {
...
func (ok *Okx) GetInterestRateAndLoanQuota(ctx context.Context) (map[string][]InterestRateLoanQuotaItem, error) {
	...
	err := ok.SendHTTPRequest(ctx, exchange.RestSpot, getInterestRateAndLoanQuotaEPL, http.MethodGet, "public/interest-rate-loan-quota", nil, &response, request.UnauthenticatedRequest)
	if err != nil {
		return nil, err
...
func (ok *Okx) GetInsuranceFundInformation(ctx context.Context, arg *InsuranceFundInformationRequestParams) (*InsuranceFundInformation, error) {
	...
	if err := ok.SendHTTPRequest(ctx, exchange.RestSpot, getInsuranceFundEPL, http.MethodGet, common.EncodeURLValues("public/insurance-fund", params), nil, &response, request.UnauthenticatedRequest); err != nil {
		return nil, err
	}
	if len(response) == 1 {
		return &response[0], nil
...
func (ok *Okx) CurrencyUnitConvert(ctx context.Context, instrumentID string, quantity, orderPrice float64, convertType uint, unitOfCcy currency.Code) (*UnitConvertResponse, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, exchange.RestSpot, unitConvertEPL, http.MethodGet, common.EncodeURLValues("public/convert-contract-coin", params), nil, &resp, request.UnauthenticatedRequest)
}
...
func (ok *Okx) GetOptionsTickBands(ctx context.Context, instrumentType, instrumentFamily string) ([]OptionTickBand, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, exchange.RestSpot, optionTickBandsEPL, http.MethodGet, common.EncodeURLValues("public/instrument-tick-bands", params), nil, &resp, request.UnauthenticatedRequest)
}
...
func (ok *Okx) GetOpenInterestAndVolumeExpiry(ctx context.Context, ccy currency.Code, period kline.Interval) ([]ExpiryOpenInterestAndVolume, error) {
	...
	var resp [][6]string
	err := ok.SendHTTPRequest(ctx, exchange.RestSpot, getOpenInterestAndVolumeEPL, http.MethodGet, common.EncodeURLValues("rubik/stat/option/open-interest-volume-expiry", params), nil, &resp, request.UnauthenticatedRequest)
	if err != nil {
		return nil, err
	}
...
func (ok *Okx) GetLendingOrders(ctx context.Context, orderID, term, state string, ccy currency.Code, startAt, endAt time.Time, limit int64) ([]LendingOrderDetail, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, exchange.RestSpot, lendingOrderListEPL, http.MethodGet, common.EncodeURLValues("finance/fixed-loan/lending-orders-list", params), nil, &resp, request.AuthenticatedRequest)
}
