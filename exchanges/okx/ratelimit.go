...
// rateLimits contains package-level endpoint definitions shared by every REST
// requester and websocket manager, consistent with other exchange integrations.
var rateLimits = request.RateLimitDefinitions{
	// Trade Endpoints
	// OKX's instrument/family and subaccount limits are request-scoped, so
	// these standard endpoint slots remain unrestricted to avoid applying a
	// second, incorrectly keyed limit.
	placeOrderEPL:                        request.NewRateLimitWithWeight(0, 0, 1),
	placeMultipleOrdersEPL:               request.NewRateLimitWithWeight(0, 0, 1),
	cancelOrderEPL:                       request.NewRateLimitWithWeight(0, 0, 1),
	cancelMultipleOrdersEPL:              request.NewRateLimitWithWeight(0, 0, 1),
	amendOrderEPL:                        request.NewRateLimitWithWeight(0, 0, 1),
	amendMultipleOrdersEPL:               request.NewRateLimitWithWeight(0, 0, 1),
