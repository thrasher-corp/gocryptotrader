...
const (
	...
	MockTesting = "Mock testing framework in use for %s @ %s on REST endpoints only"
	LiveTesting = "Mock testing bypassed; live testing of REST endpoints in use for %s @ %s"
)
