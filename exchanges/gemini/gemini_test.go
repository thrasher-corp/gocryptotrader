...
func TestTickerUnmarshal(t *testing.T) {
	t.Parallel()
	var tick Ticker
	err := json.Unmarshal([]byte(`{"bid":"69778.07000","ask":"69781.21000","last":"69796.39000","volume":{"BTC":"2733.78157298","USD":"190808084.8425255422","timestamp":1787213040001}}`), &tick)
	...
	assert.Equal(t, int64(1787213040001), tick.Volume.Timestamp.Time().UnixMilli(), "Timestamp should decode")
}
