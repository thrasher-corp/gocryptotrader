...
func (g *Gemini) NewOrder(symbol string, amount, price float64, side, orderType string) (int64, error) {
	...
	response := Order{}
	err := g.SendAuthenticatedHTTPRequest(defaultRest, http.MethodPost, geminiOrderNew, req, &response)
	if err != nil {
		return 0, err
	}
...
func (g *Gemini) CancelExistingOrder(orderID int64) (Order, error) {
	...
	response := Order{}
	err := g.SendAuthenticatedHTTPRequest(defaultRest, http.MethodPost, geminiOrderCancel, req, &response)
	if err != nil {
		return Order{}, err
	}
	if response.Message != "" {
...
func (g *Gemini) CancelExistingOrders(cancelBySession bool) (OrderResult, error) {
	...
	err := g.SendAuthenticatedHTTPRequest(defaultRest, http.MethodPost, path, nil, &response)
	if err != nil {
		return response, err
	}
	if response.Message != "" {
...
func (g *Gemini) GetOrderStatus(orderID int64) (Order, error) {
	...
	err := g.SendAuthenticatedHTTPRequest(defaultRest, http.MethodPost, geminiOrderStatus, req, &response)
	if err != nil {
		return response, err
	}
...
func (g *Gemini) GetOrders() ([]Order, error) {
	...
	err := g.SendAuthenticatedHTTPRequest(defaultRest, http.MethodPost, geminiOrders, nil, &response)
	if err != nil {
		return nil, err
	}
...
func (g *Gemini) GetTradeHistory(currencyPair string, timestamp int64) ([]TradeHistory, error) {
	...
	return response,
		g.SendAuthenticatedHTTPRequest(defaultRest, http.MethodPost, geminiMyTrades, req, &response)
}
...
func (g *Gemini) GetNotionalVolume() (NotionalVolume, error) {
	...
	return response,
		g.SendAuthenticatedHTTPRequest(defaultRest, http.MethodPost, geminiVolume, nil, &response)
}
...
func (g *Gemini) GetTradeVolume() ([][]TradeVolume, error) {
	...
	return response,
		g.SendAuthenticatedHTTPRequest(defaultRest, http.MethodPost, geminiTradeVolume, nil, &response)
}
...
func (g *Gemini) GetBalances() ([]Balance, error) {
	...
	return response,
		g.SendAuthenticatedHTTPRequest(defaultRest, http.MethodPost, geminiBalances, nil, &response)
}
...
func (g *Gemini) GetCryptoDepositAddress(depositAddlabel, currency string) (DepositAddress, error) {
	...
	err := g.SendAuthenticatedHTTPRequest(defaultRest, http.MethodPost, geminiDeposit+"/"+currency+"/"+geminiNewAddress, req, &response)
	if err != nil {
		return response, err
	}
	if response.Message != "" {
...
func (g *Gemini) WithdrawCrypto(address, currency string, amount float64) (WithdrawalAddress, error) {
	...
	err := g.SendAuthenticatedHTTPRequest(defaultRest, http.MethodPost, geminiWithdraw+strings.ToLower(currency), req, &response)
	if err != nil {
		return response, err
	}
	if response.Message != "" {
...
func (g *Gemini) PostHeartbeat() (string, error) {
	...
	err := g.SendAuthenticatedHTTPRequest(defaultRest, http.MethodPost, geminiHeartbeat, nil, &response)
	if err != nil {
