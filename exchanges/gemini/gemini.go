...
func (g *Gemini) GetSymbols() ([]string, error) {
	...
	return symbols, g.SendHTTPRequest(exchange.DefaultRest, path, &symbols)
}
...
func (g *Gemini) GetTicker(currencyPair string) (TickerV2, error) {
	...
	err := g.SendHTTPRequest(exchange.DefaultRest, path, &ticker)
	if err != nil {
		return ticker, err
	}
...
func (g *Gemini) GetOrderbook(currencyPair string, params url.Values) (Orderbook, error) {
	...
	return orderbook, g.SendHTTPRequest(exchange.DefaultRest, path, &orderbook)
}
...
func (g *Gemini) GetTrades(currencyPair string, since, limit int64, includeBreaks bool) ([]Trade, error) {
	...
	return trades, g.SendHTTPRequest(exchange.DefaultRest, path, &trades)
}
...
func (g *Gemini) GetAuction(currencyPair string) (Auction, error) {
	...
	return auction, g.SendHTTPRequest(exchange.DefaultRest, path, &auction)
}
...
func (g *Gemini) GetAuctionHistory(currencyPair string, params url.Values) ([]AuctionHistory, error) {
	...
	return auctionHist, g.SendHTTPRequest(exchange.DefaultRest, path, &auctionHist)
}
...
func (g *Gemini) NewOrder(symbol string, amount, price float64, side, orderType string) (int64, error) {
	...
	response := Order{}
	err := g.SendAuthenticatedHTTPRequest(exchange.DefaultRest, http.MethodPost, geminiOrderNew, req, &response)
	if err != nil {
		return 0, err
	}
...
func (g *Gemini) CancelExistingOrder(orderID int64) (Order, error) {
	...
	response := Order{}
	err := g.SendAuthenticatedHTTPRequest(exchange.DefaultRest, http.MethodPost, geminiOrderCancel, req, &response)
	if err != nil {
		return Order{}, err
	}
	if response.Message != "" {
...
func (g *Gemini) CancelExistingOrders(cancelBySession bool) (OrderResult, error) {
	...
	err := g.SendAuthenticatedHTTPRequest(exchange.DefaultRest, http.MethodPost, path, nil, &response)
	if err != nil {
		return response, err
	}
	if response.Message != "" {
...
func (g *Gemini) GetOrderStatus(orderID int64) (Order, error) {
	...
	err := g.SendAuthenticatedHTTPRequest(exchange.DefaultRest, http.MethodPost, geminiOrderStatus, req, &response)
	if err != nil {
		return response, err
	}
...
func (g *Gemini) GetOrders() ([]Order, error) {
	...
	err := g.SendAuthenticatedHTTPRequest(exchange.DefaultRest, http.MethodPost, geminiOrders, nil, &response)
	if err != nil {
		return nil, err
	}
...
func (g *Gemini) GetTradeHistory(currencyPair string, timestamp int64) ([]TradeHistory, error) {
	...
	return response,
		g.SendAuthenticatedHTTPRequest(exchange.DefaultRest, http.MethodPost, geminiMyTrades, req, &response)
}
...
func (g *Gemini) GetNotionalVolume() (NotionalVolume, error) {
	...
	return response,
		g.SendAuthenticatedHTTPRequest(exchange.DefaultRest, http.MethodPost, geminiVolume, nil, &response)
}
...
func (g *Gemini) GetTradeVolume() ([][]TradeVolume, error) {
	...
	return response,
		g.SendAuthenticatedHTTPRequest(exchange.DefaultRest, http.MethodPost, geminiTradeVolume, nil, &response)
}
...
func (g *Gemini) GetBalances() ([]Balance, error) {
	...
	return response,
		g.SendAuthenticatedHTTPRequest(exchange.DefaultRest, http.MethodPost, geminiBalances, nil, &response)
}
...
func (g *Gemini) GetCryptoDepositAddress(depositAddlabel, currency string) (DepositAddress, error) {
	...
	err := g.SendAuthenticatedHTTPRequest(exchange.DefaultRest, http.MethodPost, geminiDeposit+"/"+currency+"/"+geminiNewAddress, req, &response)
	if err != nil {
		return response, err
	}
	if response.Message != "" {
...
func (g *Gemini) WithdrawCrypto(address, currency string, amount float64) (WithdrawalAddress, error) {
	...
	err := g.SendAuthenticatedHTTPRequest(exchange.DefaultRest, http.MethodPost, geminiWithdraw+strings.ToLower(currency), req, &response)
	if err != nil {
		return response, err
	}
	if response.Message != "" {
...
func (g *Gemini) PostHeartbeat() (string, error) {
	...
	err := g.SendAuthenticatedHTTPRequest(exchange.DefaultRest, http.MethodPost, geminiHeartbeat, nil, &response)
	if err != nil {
