...
+ After 1 minute, the trade processor will parse and save all trades on the buffer to the trade table
...
+ If the processor has not received any trades in that 1 minute timeframe, it will shut down. Sending trade data to it later will automatically start it up again
