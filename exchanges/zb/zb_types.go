...
var defaultTransferFees = []fee.Transfer{
	...
	{Currency: currency.ETH, Deposit: fee.ConvertWithMinimumAmount(0, 0.008), Withdrawal: fee.ConvertWithMaxAndMin(0.01, 1000, 0)},
	{Currency: currency.ETC, Deposit: fee.ConvertWithMinimumAmount(0, 0.01), Withdrawal: fee.ConvertWithMaxAndMin(0.01, 200000, 0)},
	{Currency: currency.BTS, Deposit: fee.ConvertWithMinimumAmount(0, 1), Withdrawal: fee.ConvertWithMaxAndMin(3, 10e6, 0)},
	...
	{Currency: currency.HC, Deposit: fee.ConvertWithMinimumAmount(0, 0.011), Withdrawal: fee.ConvertWithMaxAndMin(0.01, 200000, 0)},
	...
	{Currency: currency.UBTC, Deposit: fee.ConvertWithMinimumAmount(0, 0.1), Withdrawal: fee.ConvertWithMaxAndMin(0.001, 200000, 0)},
	...
	{Currency: currency.DOGE, Deposit: fee.ConvertWithMinimumAmount(0, 10), Withdrawal: fee.ConvertWithMaxAndMin(20, 20000000, 0)},
	...
	{Currency: currency.GRIN, Deposit: fee.ConvertWithMinimumAmount(0, 0.0000001), Withdrawal: fee.ConvertWithMaxAndMin(0.1, 20000, 0)},
	...
	{Currency: currency.DOT, Deposit: fee.ConvertWithMinimumAmount(0, 0.1), Withdrawal: fee.ConvertWithMaxAndMin(0.1, 100000, 0)},
	...
	{Currency: currency.NEAR, Deposit: fee.ConvertWithMinimumAmount(0, 1), Withdrawal: fee.ConvertWithMaxAndMin(0.1, 150000, 0)},
	{Currency: currency.XYM, Deposit: fee.ConvertWithMinimumAmount(0, 1), Withdrawal: fee.ConvertWithMaxAndMin(5, 400000, 0)},
	...
	{Currency: currency.THETA, Deposit: fee.ConvertWithMinimumAmount(0, 0.01), Withdrawal: fee.ConvertWithMaxAndMin(0.1, 10000, 0)},
	{Currency: currency.BZZ, Deposit: fee.Convert(0), Withdrawal: fee.ConvertWithMaxAndMin(1, 10000, 0)},
	{Currency: currency.DOM, Deposit: fee.ConvertWithMinimumAmount(0, 0.01), Withdrawal: fee.ConvertWithMaxAndMin(0.1, 23000, 0)},
	...
	{Currency: currency.LIKE, Deposit: fee.ConvertWithMinimumAmount(0, 0.01), Withdrawal: fee.ConvertWithMaxAndMin(1, 5000000, 0)},
	...
	{Currency: currency.KAVA, Deposit: fee.ConvertWithMinimumAmount(0, 0.0001), Withdrawal: fee.ConvertWithMaxAndMin(0.1, 30000, 0)},
	...
	{Currency: currency.XEC, Deposit: fee.ConvertWithMinimumAmount(0, 5000), Withdrawal: fee.ConvertWithMaxAndMin(500, 2000000000, 0)},
