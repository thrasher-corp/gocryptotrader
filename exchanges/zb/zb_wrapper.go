...
func (z *ZB) GetWebsocket() (*monitor.Websocket, error) {
...
func (z *ZB) SubscribeToWebsocketChannels(channels []monitor.WebsocketChannelSubscription) error {
...
func (z *ZB) UnsubscribeToWebsocketChannels(channels []monitor.WebsocketChannelSubscription) error {
	return common.ErrFunctionNotSupported
}

// GetSubscriptions returns a copied list of subscriptions
func (z *ZB) GetSubscriptions() ([]monitor.WebsocketChannelSubscription, error) {
