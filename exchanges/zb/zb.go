...
func (z *ZB) GetMarkets() (map[string]MarketResponseItem, error) {
	...
	err := z.SendHTTPRequest(defaultRest, endpoint, &res, request.UnAuth)
	if err != nil {
		return nil, err
	}
...
func (z *ZB) GetTicker(symbol string) (TickerResponse, error) {
	...
	err := z.SendHTTPRequest(defaultRest, urlPath, &res, request.UnAuth)
	return res, err
}
...
func (z *ZB) GetTickers() (map[string]TickerChildResponse, error) {
	...
	err := z.SendHTTPRequest(defaultRest, urlPath, &resp, request.UnAuth)
	return resp, err
}
...
func (z *ZB) GetSpotKline(arg KlinesRequestParams) (KLineResponse, error) {
	...
	err := z.SendHTTPRequest(defaultRest, urlPath, &rawKlines, klineFunc)
	if err != nil {
		return res, err
	}
