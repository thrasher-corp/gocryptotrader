...
func (c *Coinbene) GetAllPairs() ([]PairData, error) {
	...
	return resp.Data, c.SendHTTPRequest(defaultRest, path, spotPairs, &resp)
}
...
func (c *Coinbene) GetPairInfo(symbol string) (PairData, error) {
	...
	return resp.Data, c.SendHTTPRequest(defaultRest, path, spotPairInfo, &resp)
}
...
func (c *Coinbene) GetOrderbook(symbol string, size int64) (Orderbook, error) {
	...
	err := c.SendHTTPRequest(defaultRest, path, spotOrderbook, &resp)
	if err != nil {
...
func (c *Coinbene) GetTicker(symbol string) (TickerData, error) {
	...
	return resp.TickerData, c.SendHTTPRequest(defaultRest, path, spotSpecificTicker, &resp)
}
...
func (c *Coinbene) GetTickers() ([]TickerData, error) {
	...
	return resp.TickerData, c.SendHTTPRequest(defaultRest, path, spotTickerList, &resp)
}
...
func (c *Coinbene) GetTrades(symbol string, limit int64) (Trades, error) {
	...
	err := c.SendHTTPRequest(defaultRest, path, spotMarketTrades, &resp)
	if err != nil {
		return nil, err
	}
...
func (c *Coinbene) GetAccountBalances() ([]UserBalanceData, error) {
	...
	err := c.SendAuthHTTPRequest(defaultRest, http.MethodGet,
		path,
...
func (c *Coinbene) PlaceSpotOrder(price, quantity float64, symbol, direction,
	...
	err := c.SendAuthHTTPRequest(defaultRest, http.MethodPost,
		path,
		coinbenePlaceOrder,
		false,
		params,
...
func (c *Coinbene) GetKlines(pair string, start, end time.Time, period string) (resp CandleResponse, err error) {
	...
	if err = c.SendHTTPRequest(defaultRest, path, contractKline, &resp); err != nil {
		return
	}
