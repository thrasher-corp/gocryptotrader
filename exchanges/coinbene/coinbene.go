...
func (c *Coinbene) GetAllPairs() ([]PairData, error) {
	...
	return resp.Data, c.SendHTTPRequest(exchange.DefaultSpot, path, spotPairs, &resp)
}
...
func (c *Coinbene) GetPairInfo(symbol string) (PairData, error) {
	...
	return resp.Data, c.SendHTTPRequest(exchange.DefaultSpot, path, spotPairInfo, &resp)
}
...
func (c *Coinbene) GetOrderbook(symbol string, size int64) (Orderbook, error) {
	...
	err := c.SendHTTPRequest(exchange.DefaultSpot, path, spotOrderbook, &resp)
	if err != nil {
...
func (c *Coinbene) GetTicker(symbol string) (TickerData, error) {
	...
	return resp.TickerData, c.SendHTTPRequest(exchange.DefaultSpot, path, spotSpecificTicker, &resp)
}
...
func (c *Coinbene) GetTickers() ([]TickerData, error) {
	...
	return resp.TickerData, c.SendHTTPRequest(exchange.DefaultSpot, path, spotTickerList, &resp)
}
...
func (c *Coinbene) GetTrades(symbol string, limit int64) (Trades, error) {
	...
	err := c.SendHTTPRequest(exchange.DefaultSpot, path, spotMarketTrades, &resp)
	if err != nil {
		return nil, err
	}
...
func (c *Coinbene) GetAccountBalances() ([]UserBalanceData, error) {
	...
	err := c.SendAuthHTTPRequest(exchange.DefaultSpot, http.MethodGet,
		path,
...
func (c *Coinbene) PlaceSpotOrder(price, quantity float64, symbol, direction,
	...
	err := c.SendAuthHTTPRequest(exchange.DefaultSpot, http.MethodPost,
		path,
		coinbenePlaceOrder,
		false,
		params,
...
func (c *Coinbene) GetSwapTickers() (SwapTickers, error) {
	...
	err := c.SendHTTPRequest(swapRest, path, contractTickers, &r)
	if err != nil {
		return nil, err
	}
	return r.Data, nil
...
func (c *Coinbene) GetSwapOrderbook(symbol string, size int64) (Orderbook, error) {
	...
	err := c.SendHTTPRequest(swapRest, path, contractOrderbook, &r)
	if err != nil {
		return s, err
	}
...
func (c *Coinbene) GetKlines(pair string, start, end time.Time, period string) (resp CandleResponse, err error) {
	...
	if err = c.SendHTTPRequest(exchange.DefaultSpot, path, contractKline, &resp); err != nil {
		return
	}
...
func (c *Coinbene) GetSwapKlines(symbol string, start, end time.Time, resolution string) (resp CandleResponse, err error) {
	...
	if err = c.SendHTTPRequest(swapRest, path, contractKline, &resp); err != nil {
		return
	}
...
func (c *Coinbene) GetSwapTrades(symbol string, limit int) (SwapTrades, error) {
	...
	if err := c.SendHTTPRequest(swapRest, path, contractTrades, &r); err != nil {
		return nil, err
	}
...
func (c *Coinbene) GetSwapAccountInfo() (SwapAccountInfo, error) {
	...
	err := c.SendAuthHTTPRequest(swapRest, http.MethodGet,
		path,
		coinbeneAccountInfo,
		true,
		nil,
...
func (c *Coinbene) PlaceSwapOrder(symbol, direction, orderType, marginMode,
	...
	var r resp
	path := coinbeneAPIVersion + coinbenePlaceOrder
	err := c.SendAuthHTTPRequest(swapRest, http.MethodPost,
		path,
		coinbenePlaceOrder,
		true,
		v,
...
func (c *Coinbene) SendHTTPRequest(ep, path string, f request.EndpointLimit, result interface{}) error {
...
func (c *Coinbene) SendAuthHTTPRequest(ep, method, path, epPath string, isSwap bool,
