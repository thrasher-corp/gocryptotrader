...
func (c *Coinbene) GetAllPairs() ([]PairData, error) {
	...
	return resp.Data, c.SendHTTPRequest(spotURL, path, spotPairs, &resp)
}
...
func (c *Coinbene) GetPairInfo(symbol string) (PairData, error) {
	...
	return resp.Data, c.SendHTTPRequest(spotURL, path, spotPairInfo, &resp)
}
...
func (c *Coinbene) GetOrderbook(symbol string, size int64) (Orderbook, error) {
	...
	err := c.SendHTTPRequest(spotURL, path, spotOrderbook, &resp)
	if err != nil {
...
func (c *Coinbene) GetTicker(symbol string) (TickerData, error) {
	...
	return resp.TickerData, c.SendHTTPRequest(spotURL, path, spotSpecificTicker, &resp)
}
...
func (c *Coinbene) GetTickers() ([]TickerData, error) {
	...
	return resp.TickerData, c.SendHTTPRequest(spotURL, path, spotTickerList, &resp)
}
...
func (c *Coinbene) GetTrades(symbol string, limit int64) (Trades, error) {
	...
	err := c.SendHTTPRequest(spotURL, path, spotMarketTrades, &resp)
	if err != nil {
		return nil, err
	}
...
func (c *Coinbene) GetAccountBalances() ([]UserBalanceData, error) {
	...
	err := c.SendAuthHTTPRequest(spotURL, http.MethodGet,
		path,
...
func (c *Coinbene) PlaceSpotOrder(price, quantity float64, symbol, direction,
	...
	err := c.SendAuthHTTPRequest(spotURL, http.MethodPost,
		path,
		coinbenePlaceOrder,
		false,
		params,
...
func (c *Coinbene) GetKlines(pair string, start, end time.Time, period string) (resp CandleResponse, err error) {
	...
	if err = c.SendHTTPRequest(spotURL, path, contractKline, &resp); err != nil {
		return
	}
