...
func (g *Gateio) GetBalances() (BalancesResponse, error) {
	...
	return result,
		g.SendAuthenticatedHTTPRequest(defaultRest, http.MethodPost, gateioBalances, "", &result)
}
...
func (g *Gateio) SpotNewOrder(arg SpotNewOrderRequestParams) (SpotNewOrderResponse, error) {
	...
	return result, g.SendAuthenticatedHTTPRequest(defaultRest, http.MethodPost, urlPath, params, &result)
}
...
func (g *Gateio) CancelExistingOrder(orderID int64, symbol string) (bool, error) {
	...
	err := g.SendAuthenticatedHTTPRequest(defaultRest, http.MethodPost, gateioCancelOrder, params, &result)
	if err != nil {
		return false, err
	}
	if !result.Result {
...
func (g *Gateio) CancelAllExistingOrders(orderType int64, symbol string) error {
	...
	err := g.SendAuthenticatedHTTPRequest(defaultRest, http.MethodPost, gateioCancelAllOrders, params, &result)
	if err != nil {
		return err
	}
...
func (g *Gateio) GetOpenOrders(symbol string) (OpenOrdersResponse, error) {
	...
	err := g.SendAuthenticatedHTTPRequest(defaultRest, http.MethodPost, gateioOpenOrders, params, &result)
	if err != nil {
		return result, err
	}
...
func (g *Gateio) GetTradeHistory(symbol string) (TradHistoryResponse, error) {
	...
	err := g.SendAuthenticatedHTTPRequest(defaultRest, http.MethodPost, gateioTradeHistory, params, &result)
	if err != nil {
		return result, err
	}
...
func (g *Gateio) WithdrawCrypto(currency, address string, amount float64) (*withdraw.ExchangeResponse, error) {
	...
	err := g.SendAuthenticatedHTTPRequest(defaultRest, http.MethodPost, gateioWithdraw, params, &result)
	if err != nil {
		return nil, err
	}
	if !result.Result {
...
func (g *Gateio) GetCryptoDepositAddress(currency string) (string, error) {
	...
	err := g.SendAuthenticatedHTTPRequest(defaultRest, http.MethodPost, gateioDepositAddress, params, &result)
	if err != nil {
		return "", err
	}
