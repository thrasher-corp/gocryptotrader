...
func (g *Gateio) DeliveryFuturesSubscribe(ctx context.Context, channelsToUnsubscribe []subscription.Subscription) error {
...
func (g *Gateio) DeliveryFuturesUnsubscribe(ctx context.Context, channelsToUnsubscribe []subscription.Subscription) error {
	return g.handleDeliveryFuturesSubscription(ctx, "unsubscribe", channelsToUnsubscribe)
}

// handleDeliveryFuturesSubscription sends a websocket message to receive data from the channel
func (g *Gateio) handleDeliveryFuturesSubscription(ctx context.Context, event string, channelsToSubscribe []subscription.Subscription) error {
...
func (g *Gateio) generateDeliveryFuturesPayload(ctx context.Context, event string, channelsToSubscribe []subscription.Subscription) ([2][]WsInput, error) {
