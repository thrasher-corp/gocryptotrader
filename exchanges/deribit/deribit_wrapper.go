...
// market conversion
func (d *Deribit) ModifyOrder(ctx context.Context, action *order.Modify) (string, error) {
...
func (d *Deribit) GetDepositAddress(ctx context.Context, cryptocurrency currency.Code, accountID string) (string, error) {
