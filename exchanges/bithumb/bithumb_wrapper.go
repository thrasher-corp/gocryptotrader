...
func (b *Bithumb) GetWebsocket() (*monitor.Websocket, error) {
...
func (b *Bithumb) SubscribeToWebsocketChannels(channels []monitor.WebsocketChannelSubscription) error {
	return common.ErrFunctionNotSupported
}

// UnsubscribeToWebsocketChannels removes from ChannelsToSubscribe
// which lets websocket.manageSubscriptions handle unsubscribing
func (b *Bithumb) UnsubscribeToWebsocketChannels(channels []monitor.WebsocketChannelSubscription) error {
	return common.ErrFunctionNotSupported
}

// GetSubscriptions returns a copied list of subscriptions
func (b *Bithumb) GetSubscriptions() ([]monitor.WebsocketChannelSubscription, error) {
	return nil, common.ErrFunctionNotSupported
}
