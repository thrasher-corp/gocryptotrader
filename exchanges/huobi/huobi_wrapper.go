...
func (h *HUOBI) CancelAllOrders(orderCancellation exchange.OrderCancellation) error {
	// Requires DB to properly support this on this exchange
	_, _ = h.GetOpenOrders("", "", "", 0)

	_, _ = h.CancelOrderBatch([]int64{0})
