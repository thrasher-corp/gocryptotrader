...
func (h *Exchange) FGetContractInfo(ctx context.Context, symbol, contractType string, code currency.Pair) (FContractInfoData, error) {
...
func (h *Exchange) FIndexPriceInfo(ctx context.Context, symbol currency.Code) (FContractIndexPriceInfo, error) {
...
func (h *Exchange) FContractPriceLimitations(ctx context.Context, symbol, contractType string, code currency.Pair) (FContractIndexPriceInfo, error) {
	var resp FContractIndexPriceInfo
	params := url.Values{}
	if symbol != "" {
		params.Set("symbol", symbol)
...
func (h *Exchange) ContractOpenInterestUSDT(ctx context.Context, contractCode, pair currency.Pair, contractType, businessType string) ([]UContractOpenInterest, error) {
	params := url.Values{}
...
func (h *Exchange) FContractOpenInterest(ctx context.Context, symbol, contractType string, code currency.Pair) (FContractOIData, error) {
...
func (h *Exchange) FGetEstimatedDeliveryPrice(ctx context.Context, symbol currency.Code) (FEstimatedDeliveryPriceInfo, error) {
...
func (h *Exchange) FGetMarketDepth(ctx context.Context, symbol currency.Pair, dataType string) (*OBData, error) {
...
func (h *Exchange) FGetKlineData(ctx context.Context, symbol currency.Pair, period string, size int64, startTime, endTime time.Time) (FKlineData, error) {
	var resp FKlineData
	params := url.Values{}
	symbolValue, err := h.formatFuturesPair(symbol, false)
	if err != nil {
...
func (h *Exchange) FGetMarketOverviewData(ctx context.Context, symbol currency.Pair) (FMarketOverviewData, error) {
...
func (h *Exchange) FLastTradeData(ctx context.Context, symbol currency.Pair) (FLastTradeData, error) {
...
func (h *Exchange) FRequestPublicBatchTrades(ctx context.Context, symbol currency.Pair, size int64) (FBatchTradesForContractData, error) {
	params := url.Values{}
	symbolValue, err := h.formatFuturesPair(symbol, false)
	if err != nil {
...
func (h *Exchange) FQueryTieredAdjustmentFactor(ctx context.Context, symbol currency.Code) (FTieredAdjustmentFactorInfo, error) {
...
func (h *Exchange) FQueryHisOpenInterest(ctx context.Context, symbol, contractType, period, amountType string, size int64) (FOIData, error) {
	var resp FOIData
	params := url.Values{}
	if symbol != "" {
		params.Set("symbol", symbol)
...
func (h *Exchange) FQuerySystemStatus(ctx context.Context, symbol currency.Code) (FContractOIData, error) {
	var resp FContractOIData
	params := url.Values{}
	if !symbol.IsEmpty() {
		codeValue, err := h.formatFuturesCode(symbol)
...
func (h *Exchange) FQueryTopAccountsRatio(ctx context.Context, symbol, period string) (FTopAccountsLongShortRatio, error) {
...
func (h *Exchange) FQueryTopPositionsRatio(ctx context.Context, symbol, period string) (FTopPositionsLongShortRatio, error) {
...
func (h *Exchange) FLiquidationOrders(ctx context.Context, symbol currency.Code, tradeType string, startTime, endTime int64, direction string, fromID int64) (LiquidationOrdersData, error) {
...
func (h *Exchange) FIndexKline(ctx context.Context, symbol currency.Pair, period string, size int64) (FIndexKlineData, error) {
...
func (h *Exchange) FGetBasisData(ctx context.Context, symbol currency.Pair, period, basisPriceType string, size int64) (FBasisData, error) {
	var resp FBasisData
	params := url.Values{}
	symbolValue, err := h.formatFuturesPair(symbol, false)
	if err != nil {
...
func (h *Exchange) FGetAccountInfo(ctx context.Context, symbol currency.Code) (FUserAccountData, error) {
...
func (h *Exchange) FGetPositionsInfo(ctx context.Context, symbol currency.Code) (FUsersPositionsInfo, error) {
...
func (h *Exchange) FGetAllSubAccountAssets(ctx context.Context, symbol currency.Code) (FSubAccountAssetsInfo, error) {
...
func (h *Exchange) FGetSingleSubAccountInfo(ctx context.Context, symbol, subUID string) (FSingleSubAccountAssetsInfo, error) {
...
func (h *Exchange) FGetSingleSubPositions(ctx context.Context, symbol, subUID string) (FSingleSubAccountPositionsInfo, error) {
...
func (h *Exchange) FGetFinancialRecords(ctx context.Context, symbol, recordType string, createDate, pageIndex, pageSize int64) (FFinancialRecords, error) {
...
func (h *Exchange) FGetSettlementRecords(ctx context.Context, symbol currency.Code, pageIndex, pageSize int64, startTime, endTime time.Time) (FSettlementRecords, error) {
...
func (h *Exchange) FGetOrderLimits(ctx context.Context, symbol, orderPriceType string) (FContractInfoOnOrderLimit, error) {
...
func (h *Exchange) FContractTradingFee(ctx context.Context, symbol currency.Code) (FContractTradingFeeData, error) {
...
func (h *Exchange) FGetTransferLimits(ctx context.Context, symbol currency.Code) (FTransferLimitData, error) {
...
func (h *Exchange) FGetPositionLimits(ctx context.Context, symbol currency.Code) (FPositionLimitData, error) {
...
func (h *Exchange) FGetAssetsAndPositions(ctx context.Context, symbol currency.Code) (FAssetsAndPositionsData, error) {
...
func (h *Exchange) FTransfer(ctx context.Context, subUID, symbol, transferType string, amount float64) (FAccountTransferData, error) {
...
func (h *Exchange) FGetTransferRecords(ctx context.Context, symbol, transferType string, createDate, pageIndex, pageSize int64) (FTransferRecords, error) {
...
func (h *Exchange) FGetAvailableLeverage(ctx context.Context, symbol currency.Code) (FAvailableLeverageData, error) {
...
func (h *Exchange) FOrder(ctx context.Context, contractCode currency.Pair, symbol, contractType, clientOrderID, direction, offset, orderPriceType string, price, volume, leverageRate float64) (FOrderData, error) {
	var resp FOrderData
	req := make(map[string]any)
	if symbol != "" {
		req["symbol"] = symbol
...
func (h *Exchange) FPlaceBatchOrder(ctx context.Context, data []fBatchOrderData) (FBatchOrderResponse, error) {
...
func (h *Exchange) FCancelOrder(ctx context.Context, baseCurrency currency.Code, orderID, clientOrderID string) (FCancelOrderData, error) {
...
func (h *Exchange) FCancelAllOrders(ctx context.Context, contractCode currency.Pair, symbol, contractType string) (FCancelOrderData, error) {
	var resp FCancelOrderData
	req := make(map[string]any)
	if symbol != "" {
		req["symbol"] = symbol
...
func (h *Exchange) FFlashCloseOrder(ctx context.Context, contractCode currency.Pair, symbol, contractType, direction, orderPriceType, clientOrderID string, volume float64) (FOrderData, error) {
	var resp FOrderData
	req := make(map[string]any)
	req["symbol"] = symbol
	if t := strings.ToLower(contractType); t != "" {
...
func (h *Exchange) FGetOrderInfo(ctx context.Context, symbol, clientOrderID, orderID string) (FOrderInfo, error) {
	var resp FOrderInfo
	req := make(map[string]any)
	req["symbol"] = symbol
	if orderID != "" {
...
func (h *Exchange) FOrderDetails(ctx context.Context, symbol, orderID, orderType string, createdAt time.Time, pageIndex, pageSize int64) (FOrderDetailsData, error) {
...
func (h *Exchange) FGetOpenOrders(ctx context.Context, symbol currency.Code, pageIndex, pageSize int64) (FOpenOrdersData, error) {
...
func (h *Exchange) FGetOrderHistory(ctx context.Context, contractCode currency.Pair, symbol, tradeType, reqType, orderType string, status []order.Status, createDate, pageIndex, pageSize int64) (FOrderHistoryData, error) {
...
func (h *Exchange) FTradeHistory(ctx context.Context, contractCode currency.Pair, symbol, tradeType string, createDate, pageIndex, pageSize int64) (FOrderHistoryData, error) {
	var resp FOrderHistoryData
	req := make(map[string]any)
	req["symbol"] = symbol
...
func (h *Exchange) FPlaceTriggerOrder(ctx context.Context, contractCode currency.Pair, symbol, contractType, triggerType, orderPriceType, direction, offset string, triggerPrice, orderPrice, volume, leverageRate float64) (FTriggerOrderData, error) {
...
func (h *Exchange) FCancelTriggerOrder(ctx context.Context, symbol, orderID string) (FCancelOrderData, error) {
	var resp FCancelOrderData
	req := make(map[string]any)
	req["symbol"] = symbol
	req["order_id"] = orderID
...
func (h *Exchange) FCancelAllTriggerOrders(ctx context.Context, contractCode currency.Pair, symbol, contractType string) (FCancelOrderData, error) {
	var resp FCancelOrderData
	req := make(map[string]any)
	req["symbol"] = symbol
	if !contractCode.IsEmpty() {
...
func (h *Exchange) FQueryTriggerOpenOrders(ctx context.Context, contractCode currency.Pair, symbol string, pageIndex, pageSize int64) (FTriggerOpenOrders, error) {
...
func (h *Exchange) FQueryTriggerOrderHistory(ctx context.Context, contractCode currency.Pair, symbol, tradeType, status string, createDate, pageIndex, pageSize int64) (FTriggerOrderHistoryData, error) {
...
func (h *Exchange) FuturesAuthenticatedHTTPRequest(ctx context.Context, ep exchange.URL, method, endpoint string, values url.Values, data, result any) error {
...
func (h *Exchange) formatFuturesCode(p currency.Code) (string, error) {
...
func (h *Exchange) formatFuturesPair(p currency.Pair, convertQuoteToExpiry bool) (string, error) {
...
func (h *Exchange) pairFromContractExpiryCode(p currency.Pair) (currency.Pair, error) {
