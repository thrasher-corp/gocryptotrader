...
func TestFOrder(t *testing.T) {
	...
	cp, err := currency.NewPairFromString("BTC_CQ")
	if err != nil {
		t.Error(err)
	}
	_, err = h.FOrder(cp, "", "BTC", "", "BUY", "open", "limit", 1, 1, 1)
	if err != nil {
		t.Error(err)
	}
}
...
func TestFFlashCloseOrder(t *testing.T) {
	...
	_, err = h.FFlashCloseOrder(cp, "quarter", "BTC", "BUY", "lightning", "", 1)
	if err != nil {
		t.Error(err)
	}
}
...
func TestFGetOrderHistory(t *testing.T) {
	...
	_, err = h.FGetOrderHistory(cp, "all", "all", "7", "", []order.Status{}, 5, 0, 0)
	if err != nil {
		t.Error(err)
	}
}
...
func TestFTradeHistory(t *testing.T) {
	...
	_, err = h.FTradeHistory(cp, "all", "", 10, 0, 0)
	if err != nil {
		t.Error(err)
	}
}
...
func TestFPlaceTriggerOrder(t *testing.T) {
	...
	_, err = h.FPlaceTriggerOrder(cp, "all", "", "greaterOrEqual",
...
func TestFCancelAllTriggerOrders(t *testing.T) {
	...
	_, err = h.FCancelAllTriggerOrders(cp, "", "this_week")
	if err != nil {
		t.Error(err)
	}
}
...
func TestFQueryTriggerOpenOrders(t *testing.T) {
	...
	_, err = h.FQueryTriggerOpenOrders(cp, "", 0, 0)
	if err != nil {
		t.Error(err)
	}
}
...
func TestFQueryTriggerOrderHistory(t *testing.T) {
	...
	_, err = h.FQueryTriggerOrderHistory(cp, "", "all", "all", 10, 0, 0)
	if err != nil {
		t.Error(err)
	}
}
