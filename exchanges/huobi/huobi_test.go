...
func TestFGetFinancialRecords(t *testing.T) {
	...
	h.Verbose = true
	t.Parallel()
	_, err := h.FGetFinancialRecords("BTC", "closeLong", 0, 0, 0)
	if err != nil {
		t.Error(err)
	}
}
...
func TestFOrder(t *testing.T) {
	...
	h.Verbose = true
	a, err := h.FOrder("BTC", "", "btc200925", "", "BUY", "OPEN", "limit", 1, 1, 1)
	fmt.Printf("%+v", a)
	if err != nil {
		t.Error(err)
	}
...
func TestFFlashCloseOrder(t *testing.T) {
	...
	h.Verbose = true
	t.Parallel()
	_, err := h.FFlashCloseOrder("BTC", "quarter", "btc200925", "BUY", "lightning", "", 1)
	if err != nil {
		t.Error(err)
	}
}
...
func TestFTradeHistory(t *testing.T) {
	...
	h.Verbose = true
	t.Parallel()
	_, err := h.FTradeHistory("ETH", "all", "", 10, 0, 0)
	if err != nil {
		t.Error(err)
	}
}
...
func TestFPlaceTriggerOrder(t *testing.T) {
	...
	h.Verbose = true
	t.Parallel()
	_, err := h.FPlaceTriggerOrder("ETH", "all", "", "greaterOrEqual",
...
func TestFCancelAllTriggerOrders(t *testing.T) {
	...
	h.Verbose = true
	t.Parallel()
	_, err := h.FCancelAllTriggerOrders("ETH", "", "this_week")
	if err != nil {
		t.Error(err)
	}
}
...
func TestFQueryTriggerOrderHistory(t *testing.T) {
	...
	h.Verbose = true
	t.Parallel()
	_, err := h.FQueryTriggerOrderHistory("ETH", "", "all", "all", 10, 0, 0)
	if err != nil {
		t.Error(err)
	}
}
...
func TestFetchTradablePairs(t *testing.T) {
	h.Verbose = true
	t.Parallel()
	a, err := h.FetchTradablePairs(asset.Futures)
	fmt.Printf("%+v", a)
	if err != nil {
		t.Error(err)
	}
...
func TestCancelSwapOrder(t *testing.T) {
	...
	_, err := h.CancelSwapOrder("test123", "", "BTC-USD")
	if err != nil {
		t.Error(err)
	}
}
...
func TestCancelAllSwapOrders(t *testing.T) {
	...
	_, err := h.CancelAllSwapOrders("BTC-USD")
	if err != nil {
		t.Error(err)
	}
}
...
func TestPlaceLightningCloseOrder(t *testing.T) {
	...
	_, err := h.PlaceLightningCloseOrder("BTC-USD", "buy", "lightning", 5, 1)
	if err != nil {
		t.Error(err)
	}
}
...
func TestGetSwapOrderInfo(t *testing.T) {
	...
	_, err := h.GetSwapOrderInfo("BTC-USD", "123", "")
	if err != nil {
		t.Error(err)
	}
}
