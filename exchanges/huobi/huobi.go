...
func (h *HUOBI) FGetContractInfo(symbol, contractType, code string) (FContractInfoData, error) {
	...
	return resp, h.SendHTTPRequest(exchange.Futures, path, &resp)
}
...
func (h *HUOBI) FGetMarketDepth(symbol, dataType string) (OBData, error) {
	...
	err := h.SendHTTPRequest(exchange.Futures, path, &tempData)
	if err != nil {
		return resp, err
	}
	resp.Symbol = symbol
...
func (h *HUOBI) GetSwapPriceLimits(code string) (SwapPriceLimitsData, error) {
	...
	params := url.Values{}
	params.Set("contract_code", code)
	return resp, h.SendHTTPRequest(exchange.Futures, huobiSwapPriceLimitation+params.Encode(),
		&resp)
}
...
func (h *HUOBI) SwapOpenInterestInformation(code string) (SwapOpenInterestData, error) {
	...
	params := url.Values{}
	params.Set("contract_code", code)
	return resp, h.SendHTTPRequest(exchange.Futures, huobiSwapOpenInterestInfo+params.Encode(), &resp)
}
...
func (h *HUOBI) GetSwapMarketDepth(code, dataType string) (SwapMarketDepthData, error) {
	...
	params.Set("contract_code", code)
	params.Set("type", dataType)
	return resp, h.SendHTTPRequest(exchange.Futures, huobiSwapMarketDepth+params.Encode(), &resp)
}
...
func (h *HUOBI) GetSwapKlineData(code, period string, size int64, startTime, endTime time.Time) (SwapKlineData, error) {
	...
	return resp, h.SendHTTPRequest(exchange.Futures, huobiKLineData+params.Encode(), &resp)
}
...
func (h *HUOBI) GetSwapMarketOverview(code string) (MarketOverviewData, error) {
	...
	params := url.Values{}
	params.Set("contract_code", code)
	return resp, h.SendHTTPRequest(exchange.Futures, huobiMarketDataOverview+params.Encode(), &resp)
}
...
func (h *HUOBI) GetLastTrade(code string) (LastTradeData, error) {
	...
	params := url.Values{}
	params.Set("contract_code", code)
	return resp, h.SendHTTPRequest(exchange.Futures, huobiLastTradeContract+params.Encode(), &resp)
}
...
func (h *HUOBI) GetBatchTrades(code string, size int64) (BatchTradesData, error) {
	...
	params.Set("size", strconv.FormatInt(size, 10))
	return resp, h.SendHTTPRequest(exchange.Futures, huobiRequestBatchOfTradingRecords+params.Encode(), &resp)
}
...
func (h *HUOBI) GetInsuranceData(code string) (InsuranceAndClawbackData, error) {
	...
	params := url.Values{}
	params.Set("contract_code", code)
	return resp, h.SendHTTPRequest(exchange.Futures, huobiInsuranceBalanceAndClawbackRate+params.Encode(), &resp)
}
...
func (h *HUOBI) GetHistoricalInsuranceData(code string, pageIndex, pageSize int64) (HistoricalInsuranceFundBalance, error) {
	...
	return resp, h.SendHTTPRequest(exchange.Futures, huobiInsuranceBalanceHistory+params.Encode(), &resp)
}
...
func (h *HUOBI) GetTieredAjustmentFactorInfo(code string) (TieredAdjustmentFactorData, error) {
	...
	params := url.Values{}
	params.Set("contract_code", code)
	return resp, h.SendHTTPRequest(exchange.Futures, huobiTieredAdjustmentFactor+params.Encode(), &resp)
}
...
func (h *HUOBI) GetOpenInterestInfo(code, period, amountType string, size int64) (OpenInterestData, error) {
	...
	return resp, h.SendHTTPRequest(exchange.Futures, huobiOpenInterestInfo+params.Encode(), &resp)
}
...
func (h *HUOBI) GetSystemStatusInfo(code, period, amountType string, size int64) (SystemStatusData, error) {
	...
	params.Set("amount_type", strconv.FormatInt(aType, 10))
	return resp, h.SendHTTPRequest(exchange.Futures, huobiSwapSystemStatus+params.Encode(), &resp)
}
...
func (h *HUOBI) GetTraderSentimentIndexAccount(code, period string) (TraderSentimentIndexAccountData, error) {
	...
	params.Set("period", period)
	return resp, h.SendHTTPRequest(exchange.Futures, huobiSwapSentimentAccountData+params.Encode(), &resp)
}
...
func (h *HUOBI) GetTraderSentimentIndexPosition(code, period string) (TraderSentimentIndexPositionData, error) {
	...
	params.Set("period", period)
	return resp, h.SendHTTPRequest(exchange.Futures, huobiSwapSentimentPosition+params.Encode(), &resp)
}
...
func (h *HUOBI) GetLiquidationOrders(code, tradeType string, pageIndex, pageSize, createDate int64) (LiquidationOrdersData, error) {
	...
	return resp, h.SendHTTPRequest(exchange.Futures, huobiSwapLiquidationOrders+params.Encode(), &resp)
}
...
func (h *HUOBI) GetHistoricalFundingRates(code string, pageSize, pageIndex int64) (HistoricalFundingRateData, error) {
	...
	return resp, h.SendHTTPRequest(exchange.Futures, huobiSwapHistoricalFundingRate+params.Encode(), &resp)
}
...
func (h *HUOBI) GetPremiumIndexKlineData(code, period string, size int64) (PremiumIndexKlineData, error) {
	...
	params.Set("size", strconv.FormatInt(size, 10))
	return resp, h.SendHTTPRequest(exchange.Futures, huobiPremiumIndexKlineData+params.Encode(), &resp)
}
...
func (h *HUOBI) GetEstimatedFundingRates(code, period string, size int64) (EstimatedFundingRateData, error) {
	...
	params.Set("size", strconv.FormatInt(size, 10))
	return resp, h.SendHTTPRequest(exchange.Futures, huobiPredictedFundingRateData+params.Encode(), &resp)
}
...
func (h *HUOBI) GetBasisData(code, period, basisPriceType string, size int64) (BasisData, error) {
	...
	return resp, h.SendHTTPRequest(exchange.Futures, huobiBasisData+params.Encode(), &resp)
}
...
func (h *HUOBI) GetSwapMarkets(contract string) ([]SwapMarketsData, error) {
	...
	var result response
	err := h.SendHTTPRequest(exchange.Futures, huobiSwapMarkets+vals.Encode(), &result)
...
func (h *HUOBI) GetSwapFundingRates(contract string) (FundingRatesData, error) {
	...
	var result response
	err := h.SendHTTPRequest(exchange.Futures, huobiSwapFunding+vals.Encode(), &result)
	if result.ErrorMessage != "" {
