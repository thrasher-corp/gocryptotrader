...
func (h *HUOBI) FGetContractInfo(symbol, contractType, code string) (FContractInfoData, error) {
	...
	return resp, h.SendHTTPRequest(futuresRest, path, &resp)
}
...
func (h *HUOBI) FGetMarketDepth(symbol, dataType string) (OBData, error) {
	...
	err := h.SendHTTPRequest(futuresRest, path, &tempData)
	if err != nil {
		return resp, err
	}
	resp.Symbol = symbol
...
func (h *HUOBI) FGetAccountInfo(symbol string) (FUserAccountData, error) {
	...
	return resp, h.SendAuthenticatedHTTPRequest2(futuresRest, http.MethodPost, fAccountData, nil, req, &resp, false)
}
...
func (h *HUOBI) FGetPositionsInfo(symbol string) (FUserAccountData, error) {
	...
	return resp, h.SendAuthenticatedHTTPRequest2(futuresRest, http.MethodPost, fPositionInformation, nil, req, &resp, false)
}
...
func (h *HUOBI) FGetAllSubAccountAssets(symbol string) (FSubAccountAssetsInfo, error) {
	...
	return resp, h.SendAuthenticatedHTTPRequest2(futuresRest, http.MethodPost, fAllSubAccountAssets, nil, req, &resp, false)
}
...
func (h *HUOBI) FGetSingleSubAccountInfo(symbol, subUID string) (FSingleSubAccountAssetsInfo, error) {
	...
	req["sub_uid"] = subUID
	return resp, h.SendAuthenticatedHTTPRequest2(futuresRest, http.MethodPost, fSingleSubAccountAssets, nil, req, &resp, false)
}
...
func (h *HUOBI) FGetSingleSubPositions(symbol, subUID string) (FSingleSubAccountPositionsInfo, error) {
	...
	req["sub_uid"] = subUID
	return resp, h.SendAuthenticatedHTTPRequest2(futuresRest, http.MethodPost, fSingleSubAccountPositions, nil, req, &resp, false)
}
...
func (h *HUOBI) FGetFinancialRecords(symbol, recordType string, createDate, pageIndex, pageSize int64) (FFinancialRecords, error) {
	...
	return resp, h.SendAuthenticatedHTTPRequest2(futuresRest, http.MethodPost, fFinancialRecords, nil, req, &resp, false)
}
...
func (h *HUOBI) FGetOrderLimits(symbol, orderPriceType string) (FContractInfoOnOrderLimit, error) {
	...
	return resp, h.SendAuthenticatedHTTPRequest2(futuresRest, http.MethodPost, fOrderLimitInfo, nil, req, &resp, false)
}
...
func (h *HUOBI) FContractTradingFee(symbol string) (FContractTradingFeeData, error) {
	...
	return resp, h.SendAuthenticatedHTTPRequest2(futuresRest, http.MethodPost, fContractTradingFee, nil, req, &resp, false)
}
...
func (h *HUOBI) FGetTransferLimits(symbol string) (FTransferLimitData, error) {
	...
	return resp, h.SendAuthenticatedHTTPRequest2(futuresRest, http.MethodPost, fTransferLimitInfo, nil, req, &resp, false)
}
...
func (h *HUOBI) FGetPositionLimits(symbol string) (FPositionLimitData, error) {
	...
	return resp, h.SendAuthenticatedHTTPRequest2(futuresRest, http.MethodPost, fPositionLimitInfo, nil, req, &resp, false)
}
...
func (h *HUOBI) FGetAssetsAndPositions(symbol string) (FAssetsAndPositionsData, error) {
	...
	req := make(map[string]interface{})
	req["symbol"] = symbol
	return resp, h.SendAuthenticatedHTTPRequest2(futuresRest, http.MethodPost, fQueryAssetsAndPositions, nil, req, &resp, false)
}
...
func (h *HUOBI) FTransfer(subUID, symbol, transferType string, amount float64) (FAccountTransferData, error) {
	...
	return resp, h.SendAuthenticatedHTTPRequest2(futuresRest, http.MethodPost, fTransfer, nil, req, &resp, false)
}
...
func (h *HUOBI) FGetTransferRecords(symbol, transferType string, createDate, pageIndex, pageSize int64) (FTransferRecords, error) {
	...
	return resp, h.SendAuthenticatedHTTPRequest2(futuresRest, http.MethodPost, fTransferRecords, nil, req, &resp, false)
}
...
func (h *HUOBI) FGetAvailableLeverage(symbol string) (FAvailableLeverageData, error) {
	...
	return resp, h.SendAuthenticatedHTTPRequest2(futuresRest, http.MethodPost, fAvailableLeverage, nil, req, &resp, false)
}
...
func (h *HUOBI) FOrder(symbol, contractType, contractCode, clientOrderID, direction, offset, orderPriceType string, price, volume, leverageRate float64) (FOrderData, error) {
	...
	req["price"] = price
	req["offset"] = offset
	return resp, h.SendAuthenticatedHTTPRequest2(futuresRest, http.MethodPost, fOrder, nil, req, &resp, false)
}
...
func (h *HUOBI) FPlaceBatchOrder(data []fBatchOrderData) (FBatchOrderResponse, error) {
	...
	return resp, h.SendAuthenticatedHTTPRequest2(futuresRest, http.MethodPost, fBatchOrder, nil, req, &resp, false)
}
...
func (h *HUOBI) FCancelOrder(symbol, orderID, clientOrderID string) (FCancelOrderData, error) {
	...
	return resp, h.SendAuthenticatedHTTPRequest2(futuresRest, http.MethodPost, fCancelOrder, nil, req, &resp, false)
}
...
func (h *HUOBI) FCancelAllOrders(symbol, contractCode, contractType string) (FCancelOrderData, error) {
	...
	return resp, h.SendAuthenticatedHTTPRequest2(futuresRest, http.MethodPost, fCancelAllOrders, nil, req, &resp, false)
}
...
func (h *HUOBI) FFlashCloseOrder(symbol, contractType, contractCode, direction, orderPriceType, clientOrderID string, volume float64) (FOrderData, error) {
	...
	return resp, h.SendAuthenticatedHTTPRequest2(futuresRest, http.MethodPost, fFlashCloseOrder, nil, req, &resp, false)
}
...
func (h *HUOBI) FGetOrderInfo(symbol, clientOrderID, orderID string) (FOrderInfo, error) {
	...
	return resp, h.SendAuthenticatedHTTPRequest2(futuresRest, http.MethodPost, fOrderInfo, nil, req, &resp, false)
}
...
func (h *HUOBI) FOrderDetails(symbol, orderID, orderType string, createdAt time.Time, pageIndex, pageSize int64) (FOrderDetailsData, error) {
	...
	return resp, h.SendAuthenticatedHTTPRequest2(futuresRest, http.MethodPost, fOrderDetails, nil, req, &resp, false)
}
...
func (h *HUOBI) FGetOpenOrders(symbol string, pageIndex, pageSize int64) (FOpenOrdersData, error) {
	...
	return resp, h.SendAuthenticatedHTTPRequest2(futuresRest, http.MethodPost, fQueryOpenOrders, nil, req, &resp, false)
}
...
func (h *HUOBI) FGetOrderHistory(symbol, tradeType, reqType, contractCode, orderType string, status []order.Status, createDate, pageIndex, pageSize int64) (FOrderHistoryData, error) {
	...
	return resp, h.SendAuthenticatedHTTPRequest2(futuresRest, http.MethodPost, fOrderHistory, nil, req, &resp, false)
}
...
func (h *HUOBI) FTradeHistory(symbol, tradeType, contractCode string, createDate, pageIndex, pageSize int64) (FOrderHistoryData, error) {
	...
	return resp, h.SendAuthenticatedHTTPRequest2(futuresRest, http.MethodPost, fMatchResult, nil, req, &resp, false)
}
...
func (h *HUOBI) FPlaceTriggerOrder(symbol, contractType, contractCode, triggerType, orderPriceType, direction, offset string, triggerPrice, orderPrice, volume, leverageRate float64) (FTriggerOrderData, error) {
	...
	req["order_price_type"] = orderPriceType
	return resp, h.SendAuthenticatedHTTPRequest2(futuresRest, http.MethodPost, fTriggerOrder, nil, req, &resp, false)
}
...
func (h *HUOBI) FCancelTriggerOrder(symbol, orderID string) (FCancelOrderData, error) {
	...
	req["symbol"] = symbol
	req["order_id"] = orderID
	return resp, h.SendAuthenticatedHTTPRequest2(futuresRest, http.MethodPost, fCancelTriggerOrder, nil, req, &resp, false)
}
...
func (h *HUOBI) FCancelAllTriggerOrders(symbol, contractCode, contractType string) (FCancelOrderData, error) {
	...
	return resp, h.SendAuthenticatedHTTPRequest2(futuresRest, http.MethodPost, fCancelAllTriggerOrders, nil, req, &resp, false)
}
...
func (h *HUOBI) FQueryTriggerOrderHistory(symbol, contractCode, tradeType, status string, createDate, pageIndex, pageSize int64) (FTriggerOrderHistoryData, error) {
	...
	return resp, h.SendAuthenticatedHTTPRequest2(futuresRest, http.MethodPost, fTriggerOrderHistory, nil, req, &resp, false)
}
...
func (h *HUOBI) GetSwapPriceLimits(code string) (SwapPriceLimitsData, error) {
	...
	params := url.Values{}
	params.Set("contract_code", code)
	return resp, h.SendHTTPRequest(futuresRest, huobiSwapPriceLimitation+params.Encode(),
		&resp)
}
...
func (h *HUOBI) SwapOpenInterestInformation(code string) (SwapOpenInterestData, error) {
	...
	params := url.Values{}
	params.Set("contract_code", code)
	return resp, h.SendHTTPRequest(futuresRest, huobiSwapOpenInterestInfo+params.Encode(), &resp)
}
...
func (h *HUOBI) GetSwapMarketDepth(code, dataType string) (SwapMarketDepthData, error) {
	...
	params.Set("contract_code", code)
	params.Set("type", dataType)
	return resp, h.SendHTTPRequest(futuresRest, huobiSwapMarketDepth+params.Encode(), &resp)
}
...
func (h *HUOBI) GetSwapKlineData(code, period string, size int64, startTime, endTime time.Time) (SwapKlineData, error) {
	...
	return resp, h.SendHTTPRequest(futuresRest, huobiKLineData+params.Encode(), &resp)
}
...
func (h *HUOBI) GetSwapMarketOverview(code string) (MarketOverviewData, error) {
	...
	params := url.Values{}
	params.Set("contract_code", code)
	return resp, h.SendHTTPRequest(futuresRest, huobiMarketDataOverview+params.Encode(), &resp)
}
...
func (h *HUOBI) GetLastTrade(code string) (LastTradeData, error) {
	...
	params := url.Values{}
	params.Set("contract_code", code)
	return resp, h.SendHTTPRequest(futuresRest, huobiLastTradeContract+params.Encode(), &resp)
}
...
func (h *HUOBI) GetBatchTrades(code string, size int64) (BatchTradesData, error) {
	...
	params.Set("size", strconv.FormatInt(size, 10))
	return resp, h.SendHTTPRequest(futuresRest, huobiRequestBatchOfTradingRecords+params.Encode(), &resp)
}
...
func (h *HUOBI) GetInsuranceData(code string) (InsuranceAndClawbackData, error) {
	...
	params := url.Values{}
	params.Set("contract_code", code)
	return resp, h.SendHTTPRequest(futuresRest, huobiInsuranceBalanceAndClawbackRate+params.Encode(), &resp)
}
...
func (h *HUOBI) GetHistoricalInsuranceData(code string, pageIndex, pageSize int64) (HistoricalInsuranceFundBalance, error) {
	...
	return resp, h.SendHTTPRequest(futuresRest, huobiInsuranceBalanceHistory+params.Encode(), &resp)
}
...
func (h *HUOBI) GetTieredAjustmentFactorInfo(code string) (TieredAdjustmentFactorData, error) {
	...
	params := url.Values{}
	params.Set("contract_code", code)
	return resp, h.SendHTTPRequest(futuresRest, huobiTieredAdjustmentFactor+params.Encode(), &resp)
}
...
func (h *HUOBI) GetOpenInterestInfo(code, period, amountType string, size int64) (OpenInterestData, error) {
	...
	return resp, h.SendHTTPRequest(futuresRest, huobiOpenInterestInfo+params.Encode(), &resp)
}
...
func (h *HUOBI) GetSystemStatusInfo(code, period, amountType string, size int64) (SystemStatusData, error) {
	...
	params.Set("amount_type", strconv.FormatInt(aType, 10))
	return resp, h.SendHTTPRequest(futuresRest, huobiSwapSystemStatus+params.Encode(), &resp)
}
...
func (h *HUOBI) GetTraderSentimentIndexAccount(code, period string) (TraderSentimentIndexAccountData, error) {
	...
	params.Set("period", period)
	return resp, h.SendHTTPRequest(futuresRest, huobiSwapSentimentAccountData+params.Encode(), &resp)
}
...
func (h *HUOBI) GetTraderSentimentIndexPosition(code, period string) (TraderSentimentIndexPositionData, error) {
	...
	params.Set("period", period)
	return resp, h.SendHTTPRequest(futuresRest, huobiSwapSentimentPosition+params.Encode(), &resp)
}
...
func (h *HUOBI) GetLiquidationOrders(code, tradeType string, pageIndex, pageSize, createDate int64) (LiquidationOrdersData, error) {
	...
	return resp, h.SendHTTPRequest(futuresRest, huobiSwapLiquidationOrders+params.Encode(), &resp)
}
...
func (h *HUOBI) GetHistoricalFundingRates(code string, pageSize, pageIndex int64) (HistoricalFundingRateData, error) {
	...
	return resp, h.SendHTTPRequest(futuresRest, huobiSwapHistoricalFundingRate+params.Encode(), &resp)
}
...
func (h *HUOBI) GetPremiumIndexKlineData(code, period string, size int64) (PremiumIndexKlineData, error) {
	...
	params.Set("size", strconv.FormatInt(size, 10))
	return resp, h.SendHTTPRequest(futuresRest, huobiPremiumIndexKlineData+params.Encode(), &resp)
}
...
func (h *HUOBI) GetEstimatedFundingRates(code, period string, size int64) (EstimatedFundingRateData, error) {
	...
	params.Set("size", strconv.FormatInt(size, 10))
	return resp, h.SendHTTPRequest(futuresRest, huobiPredictedFundingRateData+params.Encode(), &resp)
}
...
func (h *HUOBI) GetBasisData(code, period, basisPriceType string, size int64) (BasisData, error) {
	...
	return resp, h.SendHTTPRequest(futuresRest, huobiBasisData+params.Encode(), &resp)
}
...
func (h *HUOBI) GetSwapAccountInfo(code string) (SwapAccountInformation, error) {
	...
	return resp, h.SendAuthenticatedHTTPRequest2(futuresRest, http.MethodPost, huobiSwapAccInfo, nil, req, &resp, false)
}
...
func (h *HUOBI) GetSwapPositionsInfo(code string) (SwapPositionInfo, error) {
	...
	req := make(map[string]interface{})
	req["contract_code"] = code
	return resp, h.SendAuthenticatedHTTPRequest2(futuresRest, http.MethodPost, huobiSwapPosInfo, nil, req, &resp, false)
}
...
func (h *HUOBI) GetSwapAssetsAndPositions(code string) (SwapAssetsAndPositionsData, error) {
	...
	req := make(map[string]interface{})
	req["contract_code"] = code
	return resp, h.SendAuthenticatedHTTPRequest2(futuresRest, http.MethodPost, huobiSwapAssetsAndPos, nil, req, &resp, false)
}
...
func (h *HUOBI) GetSwapAllSubAccAssets(code string) (SubAccountsAssetData, error) {
	...
	return resp, h.SendAuthenticatedHTTPRequest2(futuresRest, http.MethodPost, huobiSwapSubAccList, nil, req, &resp, false)
}
...
func (h *HUOBI) SwapSingleSubAccAssets(code string, subUID int64) (SingleSubAccountAssetsInfo, error) {
	...
	req["contract_code"] = code
	req["sub_uid"] = subUID
	return resp, h.SendAuthenticatedHTTPRequest2(futuresRest, http.MethodPost, huobiSwapSubAccInfo, nil, req, &resp, false)
}
...
func (h *HUOBI) GetSubAccPositionInfo(code string, subUID int64) (SingleSubAccountPositionsInfo, error) {
	...
	req["contract_code"] = code
	req["sub_uid"] = subUID
	return resp, h.SendAuthenticatedHTTPRequest2(futuresRest, http.MethodPost, huobiSwapSubAccPosInfo, nil, req, &resp, false)
}
...
func (h *HUOBI) GetAccountFinancialRecords(code, orderType string, createDate, pageIndex, pageSize int64) (FinancialRecordData, error) {
	...
	return resp, h.SendAuthenticatedHTTPRequest2(futuresRest, http.MethodPost, huobiSwapFinancialRecords, nil, req, &resp, false)
}
...
func (h *HUOBI) GetSwapSettlementRecords(code string, startTime, endTime time.Time, pageIndex, pageSize int64) (FinancialRecordData, error) {
	...
	return resp, h.SendAuthenticatedHTTPRequest2(futuresRest, http.MethodPost, huobiSwapSettlementRecords, nil, req, &resp, false)
}
...
func (h *HUOBI) GetAvailableLeverage(code string) (AvailableLeverageData, error) {
	...
	return resp, h.SendAuthenticatedHTTPRequest2(futuresRest, http.MethodPost, huobiSwapAvailableLeverage, nil, req, &resp, false)
}
...
func (h *HUOBI) GetSwapOrderLimitInfo(code, orderType string) (SwapOrderLimitInfo, error) {
	...
	return resp, h.SendAuthenticatedHTTPRequest2(futuresRest, http.MethodPost, huobiSwapOrderLimitInfo, nil, req, &resp, false)
}
...
func (h *HUOBI) GetSwapTradingFeeInfo(code string) (SwapTradingFeeData, error) {
	...
	req := make(map[string]interface{})
	req["contract_code"] = code
	return resp, h.SendAuthenticatedHTTPRequest2(futuresRest, http.MethodPost, huobiSwapTradingFeeInfo, nil, req, &resp, false)
}
...
func (h *HUOBI) GetSwapTransferLimitInfo(code string) (TransferLimitData, error) {
	...
	req := make(map[string]interface{})
	req["contract_code"] = code
	return resp, h.SendAuthenticatedHTTPRequest2(futuresRest, http.MethodPost, huobiSwapTransferLimitInfo, nil, req, &resp, false)
}
...
func (h *HUOBI) GetSwapPositionLimitInfo(code string) (PositionLimitData, error) {
	...
	req := make(map[string]interface{})
	req["contract_code"] = code
	return resp, h.SendAuthenticatedHTTPRequest2(futuresRest, http.MethodPost, huobiSwapPositionLimitInfo, nil, req, &resp, false)
}
...
func (h *HUOBI) AccountTransferData(code, subUID, transferType string, amount float64) (InternalAccountTransferData, error) {
	...
	req["type"] = transferType
	return resp, h.SendAuthenticatedHTTPRequest2(futuresRest, http.MethodPost, huobiSwapInternalTransferData, nil, req, &resp, false)
}
...
func (h *HUOBI) AccountTransferRecords(code, transferType string, createDate, pageIndex, pageSize int64) (InternalAccountTransferData, error) {
	...
	return resp, h.SendAuthenticatedHTTPRequest2(futuresRest, http.MethodPost, huobiSwapInternalTransferRecords, nil, req, &resp, false)
}
...
func (h *HUOBI) PlaceSwapOrders(code, clientOrderID, direction, offset, orderPriceType string, price, volume, leverage float64) (SwapOrderData, error) {
	...
	return resp, h.SendAuthenticatedHTTPRequest2(futuresRest, http.MethodPost, huobiSwapPlaceOrder, nil, req, &resp, false)
}
...
func (h *HUOBI) PlaceSwapBatchOrders(data BatchOrderRequestType) (BatchOrderData, error) {
	...
	return resp, h.SendAuthenticatedHTTPRequest2(futuresRest, http.MethodPost, huobiSwapPlaceBatchOrder, nil, req, &resp, false)
}
...
func (h *HUOBI) CancelSwapOrder(orderID, clientOrderID, contractCode string) (CancelOrdersData, error) {
	...
	req["contract_code"] = contractCode
	return resp, h.SendAuthenticatedHTTPRequest2(futuresRest, http.MethodPost, huobiSwapCancelOrder, nil, req, &resp, false)
}
...
func (h *HUOBI) CancelAllSwapOrders(contractCode string) (CancelOrdersData, error) {
	...
	req := make(map[string]interface{})
	req["contract_code"] = contractCode
	return resp, h.SendAuthenticatedHTTPRequest2(futuresRest, http.MethodPost, huobiSwapCancelAllOrders, nil, req, &resp, false)
}
...
func (h *HUOBI) PlaceLightningCloseOrder(contractCode, direction, orderPriceType string, volume float64, clientOrderID int64) (LightningCloseOrderData, error) {
	...
	return resp, h.SendAuthenticatedHTTPRequest2(futuresRest, http.MethodPost, huobiSwapLightningCloseOrder, nil, req, &resp, false)
}
...
func (h *HUOBI) GetSwapOrderDetails(contractCode, orderID, createdAt, orderType string, pageIndex, pageSize int64) (SwapOrderData, error) {
	...
	return resp, h.SendAuthenticatedHTTPRequest2(futuresRest, http.MethodPost, huobiSwapOrderDetails, nil, req, &resp, false)
}
...
func (h *HUOBI) GetSwapOrderInfo(contractCode, orderID, clientOrderID string) (SwapOrderInfo, error) {
	...
	return resp, h.SendAuthenticatedHTTPRequest2(futuresRest, http.MethodPost, huobiSwapOrderInfo, nil, req, &resp, false)
}
...
func (h *HUOBI) GetSwapOpenOrders(contractCode string, pageIndex, pageSize int64) (SwapOpenOrdersData, error) {
	...
	return resp, h.SendAuthenticatedHTTPRequest2(futuresRest, http.MethodPost, huobiSwapOpenOrders, nil, req, &resp, false)
}
...
func (h *HUOBI) GetSwapOrderHistory(contractCode, tradeType, reqType string, status []order.Status, createDate, pageIndex, pageSize int64) (SwapOrderHistory, error) {
	...
	return resp, h.SendAuthenticatedHTTPRequest2(futuresRest, http.MethodPost, huobiSwapOrderHistory, nil, req, &resp, false)
}
...
func (h *HUOBI) GetSwapTradeHistory(contractCode, tradeType string, createDate, pageIndex, pageSize int64) (AccountTradeHistoryData, error) {
	...
	return resp, h.SendAuthenticatedHTTPRequest2(futuresRest, http.MethodPost, huobiSwapTradeHistory, nil, req, &resp, false)
}
...
func (h *HUOBI) PlaceSwapTriggerOrder(contractCode, triggerType, direction, offset, orderPriceType string, triggerPrice, orderPrice, volume, leverageRate float64) (AccountTradeHistoryData, error) {
	...
	req["order_price_type"] = orderPriceType
	return resp, h.SendAuthenticatedHTTPRequest2(futuresRest, http.MethodPost, huobiSwapTriggerOrder, nil, req, &resp, false)
}
...
func (h *HUOBI) CancelSwapTriggerOrder(contractCode, orderID string) (CancelTriggerOrdersData, error) {
	...
	req["contract_code"] = contractCode
	req["order_id"] = orderID
	return resp, h.SendAuthenticatedHTTPRequest2(futuresRest, http.MethodPost, huobiSwapCancelTriggerOrder, nil, req, &resp, false)
}
...
func (h *HUOBI) CancelAllSwapTriggerOrders(contractCode string) (CancelTriggerOrdersData, error) {
	...
	req := make(map[string]interface{})
	req["contract_code"] = contractCode
	return resp, h.SendAuthenticatedHTTPRequest2(futuresRest, http.MethodPost, huobiSwapCancelAllTriggerOrders, nil, req, &resp, false)
}
...
func (h *HUOBI) GetSwapTriggerOrderHistory(contractCode, status, tradeType string, createDate, pageIndex, pageSize int64) (TriggerOrderHistory, error) {
	...
	return resp, h.SendAuthenticatedHTTPRequest2(futuresRest, http.MethodPost, huobiSwapTriggerOrderHistory, nil, req, &resp, false)
}
...
func (h *HUOBI) GetSwapMarkets(contract string) ([]SwapMarketsData, error) {
	...
	var result response
	err := h.SendHTTPRequest(futuresRest, huobiSwapMarkets+vals.Encode(), &result)
...
func (h *HUOBI) GetMarginRates(symbol string) (MarginRatesData, error) {
	...
	return resp, h.SendAuthenticatedHTTPRequest(exchange.DefaultSpot, http.MethodGet, huobiMarginRates, vals, nil, &resp, false)
}
...
func (h *HUOBI) GetSpotKline(arg KlinesRequestParams) ([]KlineItem, error) {
	...
	err := h.SendHTTPRequest(exchange.DefaultSpot, common.EncodeURLValues(urlPath, vals), &result)
	if result.ErrorMessage != "" {
		return nil, errors.New(result.ErrorMessage)
	}
	return result.Data, err
...
func (h *HUOBI) GetTickers() (Tickers, error) {
	...
	return result, h.SendHTTPRequest(exchange.DefaultSpot, urlPath, &result)
}
...
func (h *HUOBI) GetSymbols() ([]Symbol, error) {
	...
	err := h.SendHTTPRequest(exchange.DefaultSpot, urlPath, &result)
	if result.ErrorMessage != "" {
		return nil, errors.New(result.ErrorMessage)
	}
...
func (h *HUOBI) GetAccounts() ([]Account, error) {
	...
	err := h.SendAuthenticatedHTTPRequest(exchange.DefaultSpot, http.MethodGet, huobiAccounts, url.Values{}, nil, &result, false)
...
func (h *HUOBI) GetAccountBalance(accountID string) ([]AccountBalanceDetail, error) {
	...
	err := h.SendAuthenticatedHTTPRequest(exchange.DefaultSpot, http.MethodGet, endpoint, v, nil, &result, false)
...
func (h *HUOBI) GetAggregatedBalance() ([]AggregatedBalance, error) {
	...
	err := h.SendAuthenticatedHTTPRequest(exchange.DefaultSpot,
		http.MethodGet,
...
func (h *HUOBI) CancelExistingOrder(orderID int64) (int64, error) {
	...
	err := h.SendAuthenticatedHTTPRequest(exchange.DefaultSpot, http.MethodPost, endpoint, url.Values{}, nil, &resp, false)
...
func (h *HUOBI) CancelOrderBatch(_ []int64) ([]CancelOrderBatch, error) {
	...
	var result response
	err := h.SendAuthenticatedHTTPRequest(exchange.DefaultSpot, http.MethodPost, huobiOrderCancelBatch, url.Values{}, nil, &result, false)
...
func (h *HUOBI) CancelOpenOrdersBatch(accountID, symbol string) (CancelOpenOrdersBatch, error) {
	...
	err := h.SendAuthenticatedHTTPRequest(exchange.DefaultSpot, http.MethodPost, huobiBatchCancelOpenOrders, url.Values{}, data, &result, false)
...
func (h *HUOBI) GetOrder(orderID int64) (OrderInfo, error) {
	...
	err := h.SendAuthenticatedHTTPRequest(exchange.DefaultSpot, http.MethodGet,
		huobiGetOrder,
		urlVal,
		nil,
		&resp,
...
func (h *HUOBI) GetOrderMatchResults(orderID int64) ([]OrderMatchInfo, error) {
	...
	err := h.SendAuthenticatedHTTPRequest(exchange.DefaultSpot, http.MethodGet, endpoint, url.Values{}, nil, &resp, false)
...
func (h *HUOBI) GetOrders(symbol, types, start, end, states, from, direct, size string) ([]OrderInfo, error) {
	...
	err := h.SendAuthenticatedHTTPRequest(exchange.DefaultSpot, http.MethodGet, huobiGetOrders, vals, nil, &resp, false)
	return resp.Orders, err
}
...
func (h *HUOBI) GetOpenOrders(accountID, symbol, side string, size int64) ([]OrderInfo, error) {
	...
	err := h.SendAuthenticatedHTTPRequest(exchange.DefaultSpot, http.MethodGet, huobiGetOpenOrders, vals, nil, &resp, false)
	return resp.Orders, err
}
...
func (h *HUOBI) GetOrdersMatch(symbol, types, start, end, from, direct, size string) ([]OrderMatchInfo, error) {
	...
	err := h.SendAuthenticatedHTTPRequest(exchange.DefaultSpot, http.MethodGet, huobiGetOrdersMatch, vals, nil, &resp, false)
	return resp.Orders, err
}
...
func (h *HUOBI) MarginTransfer(symbol, currency string, amount float64, in bool) (int64, error) {
	...
	err := h.SendAuthenticatedHTTPRequest(exchange.DefaultSpot, http.MethodPost, path, nil, data, &resp, false)
...
func (h *HUOBI) MarginOrder(symbol, currency string, amount float64) (int64, error) {
	...
	err := h.SendAuthenticatedHTTPRequest(exchange.DefaultSpot, http.MethodPost, huobiMarginOrders, nil, data, &resp, false)
...
func (h *HUOBI) MarginRepayment(orderID int64, amount float64) (int64, error) {
	...
	err := h.SendAuthenticatedHTTPRequest(exchange.DefaultSpot, http.MethodPost, endpoint, nil, data, &resp, false)
	return resp.MarginOrderID, err
}
...
func (h *HUOBI) GetMarginLoanOrders(symbol, currency, start, end, states, from, direct, size string) ([]MarginOrder, error) {
	...
	err := h.SendAuthenticatedHTTPRequest(exchange.DefaultSpot, http.MethodGet, huobiMarginLoanOrders, vals, nil, &resp, false)
...
func (h *HUOBI) GetMarginAccountBalance(symbol string) ([]MarginAccountBalance, error) {
	...
	err := h.SendAuthenticatedHTTPRequest(exchange.DefaultSpot, http.MethodGet, huobiMarginAccountBalance, vals, nil, &resp, false)
...
func (h *HUOBI) Withdraw(c currency.Code, address, addrTag string, amount, fee float64) (int64, error) {
	...
	err := h.SendAuthenticatedHTTPRequest(exchange.DefaultSpot, http.MethodPost, huobiWithdrawCreate, nil, data, &resp.WithdrawID, false)
...
func (h *HUOBI) CancelWithdraw(withdrawID int64) (int64, error) {
	...
	err := h.SendAuthenticatedHTTPRequest(exchange.DefaultSpot, http.MethodPost, endpoint, vals, nil, &resp, false)
	return resp.WithdrawID, err
}
...
func (h *HUOBI) QueryDepositAddress(cryptocurrency string) (DepositAddress, error) {
	...
	err := h.SendAuthenticatedHTTPRequest(exchange.DefaultSpot, http.MethodGet, huobiAccountDepositAddress, vals, nil, &resp, true)
	if err != nil {
...
func (h *HUOBI) QueryWithdrawQuotas(cryptocurrency string) (WithdrawQuota, error) {
	...
	err := h.SendAuthenticatedHTTPRequest(exchange.DefaultSpot, http.MethodGet, huobiAccountWithdrawQuota, vals, nil, &resp, true)
	if err != nil {
...
func (h *HUOBI) SendHTTPRequest(ep, path string, result interface{}) error {
...
func (h *HUOBI) SendAuthenticatedHTTPRequest2(ep, method, endpoint string, values url.Values, data, result interface{}, isVersion2API bool) error {
	if !h.AllowAuthenticatedRequest() {
		return fmt.Errorf(exchange.WarningAuthenticatedRequestWithoutCredentialsSet, h.Name)
	}
	epoint, err := h.API.Endpoints.Get(ep)
	if err != nil {
		return err
	}
	if values == nil {
...
func (h *HUOBI) SendAuthenticatedHTTPRequest(ep, method, endpoint string, values url.Values, data, result interface{}, isVersion2API bool) error {
	if !h.AllowAuthenticatedRequest() {
		return fmt.Errorf(exchange.WarningAuthenticatedRequestWithoutCredentialsSet, h.Name)
	}
	var err error
	...
	urlPath := endpoint + common.EncodeURLValues(endpoint, values)
