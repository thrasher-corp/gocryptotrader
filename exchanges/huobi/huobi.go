...
func (h *HUOBI) GetMarginRates(symbol string) (MarginRatesData, error) {
	...
	return resp, h.SendAuthenticatedHTTPRequest(defaultRest, http.MethodGet, huobiMarginRates, vals, nil, &resp, false)
}
...
func (h *HUOBI) GetSpotKline(arg KlinesRequestParams) ([]KlineItem, error) {
	...
	err := h.SendHTTPRequest(defaultRest, common.EncodeURLValues(urlPath, vals), &result)
	if result.ErrorMessage != "" {
		return nil, errors.New(result.ErrorMessage)
	}
	return result.Data, err
...
func (h *HUOBI) GetTickers() (Tickers, error) {
	...
	return result, h.SendHTTPRequest(defaultRest, urlPath, &result)
}
...
func (h *HUOBI) GetSymbols() ([]Symbol, error) {
	...
	err := h.SendHTTPRequest(defaultRest, urlPath, &result)
	if result.ErrorMessage != "" {
		return nil, errors.New(result.ErrorMessage)
	}
...
func (h *HUOBI) GetAccounts() ([]Account, error) {
	...
	err := h.SendAuthenticatedHTTPRequest(defaultRest, http.MethodGet, huobiAccounts, url.Values{}, nil, &result, false)
...
func (h *HUOBI) GetAccountBalance(accountID string) ([]AccountBalanceDetail, error) {
	...
	err := h.SendAuthenticatedHTTPRequest(defaultRest, http.MethodGet, endpoint, v, nil, &result, false)
...
func (h *HUOBI) GetAggregatedBalance() ([]AggregatedBalance, error) {
	...
	err := h.SendAuthenticatedHTTPRequest(defaultRest,
		http.MethodGet,
...
func (h *HUOBI) CancelExistingOrder(orderID int64) (int64, error) {
	...
	err := h.SendAuthenticatedHTTPRequest(defaultRest, http.MethodPost, endpoint, url.Values{}, nil, &resp, false)
...
func (h *HUOBI) CancelOrderBatch(_ []int64) ([]CancelOrderBatch, error) {
	...
	var result response
	err := h.SendAuthenticatedHTTPRequest(defaultRest, http.MethodPost, huobiOrderCancelBatch, url.Values{}, nil, &result, false)
...
func (h *HUOBI) CancelOpenOrdersBatch(accountID, symbol string) (CancelOpenOrdersBatch, error) {
	...
	err := h.SendAuthenticatedHTTPRequest(defaultRest, http.MethodPost, huobiBatchCancelOpenOrders, url.Values{}, data, &result, false)
...
func (h *HUOBI) GetOrder(orderID int64) (OrderInfo, error) {
	...
	err := h.SendAuthenticatedHTTPRequest(defaultRest, http.MethodGet,
		huobiGetOrder,
		urlVal,
		nil,
		&resp,
...
func (h *HUOBI) GetOrderMatchResults(orderID int64) ([]OrderMatchInfo, error) {
	...
	err := h.SendAuthenticatedHTTPRequest(defaultRest, http.MethodGet, endpoint, url.Values{}, nil, &resp, false)
...
func (h *HUOBI) GetOrders(symbol, types, start, end, states, from, direct, size string) ([]OrderInfo, error) {
	...
	err := h.SendAuthenticatedHTTPRequest(defaultRest, http.MethodGet, huobiGetOrders, vals, nil, &resp, false)
	return resp.Orders, err
}
...
func (h *HUOBI) GetOpenOrders(accountID, symbol, side string, size int64) ([]OrderInfo, error) {
	...
	err := h.SendAuthenticatedHTTPRequest(defaultRest, http.MethodGet, huobiGetOpenOrders, vals, nil, &resp, false)
	return resp.Orders, err
}
...
func (h *HUOBI) GetOrdersMatch(symbol, types, start, end, from, direct, size string) ([]OrderMatchInfo, error) {
	...
	err := h.SendAuthenticatedHTTPRequest(defaultRest, http.MethodGet, huobiGetOrdersMatch, vals, nil, &resp, false)
	return resp.Orders, err
}
...
func (h *HUOBI) MarginTransfer(symbol, currency string, amount float64, in bool) (int64, error) {
	...
	err := h.SendAuthenticatedHTTPRequest(defaultRest, http.MethodPost, path, nil, data, &resp, false)
...
func (h *HUOBI) MarginOrder(symbol, currency string, amount float64) (int64, error) {
	...
	err := h.SendAuthenticatedHTTPRequest(defaultRest, http.MethodPost, huobiMarginOrders, nil, data, &resp, false)
...
func (h *HUOBI) MarginRepayment(orderID int64, amount float64) (int64, error) {
	...
	err := h.SendAuthenticatedHTTPRequest(defaultRest, http.MethodPost, endpoint, nil, data, &resp, false)
	return resp.MarginOrderID, err
}
...
func (h *HUOBI) GetMarginLoanOrders(symbol, currency, start, end, states, from, direct, size string) ([]MarginOrder, error) {
	...
	err := h.SendAuthenticatedHTTPRequest(defaultRest, http.MethodGet, huobiMarginLoanOrders, vals, nil, &resp, false)
...
func (h *HUOBI) GetMarginAccountBalance(symbol string) ([]MarginAccountBalance, error) {
	...
	err := h.SendAuthenticatedHTTPRequest(defaultRest, http.MethodGet, huobiMarginAccountBalance, vals, nil, &resp, false)
...
func (h *HUOBI) Withdraw(c currency.Code, address, addrTag string, amount, fee float64) (int64, error) {
	...
	err := h.SendAuthenticatedHTTPRequest(defaultRest, http.MethodPost, huobiWithdrawCreate, nil, data, &resp.WithdrawID, false)
...
func (h *HUOBI) CancelWithdraw(withdrawID int64) (int64, error) {
	...
	err := h.SendAuthenticatedHTTPRequest(defaultRest, http.MethodPost, endpoint, vals, nil, &resp, false)
	return resp.WithdrawID, err
}
...
func (h *HUOBI) QueryDepositAddress(cryptocurrency string) (DepositAddress, error) {
	...
	err := h.SendAuthenticatedHTTPRequest(defaultRest, http.MethodGet, huobiAccountDepositAddress, vals, nil, &resp, true)
	if err != nil {
...
func (h *HUOBI) QueryWithdrawQuotas(cryptocurrency string) (WithdrawQuota, error) {
	...
	err := h.SendAuthenticatedHTTPRequest(defaultRest, http.MethodGet, huobiAccountWithdrawQuota, vals, nil, &resp, true)
	if err != nil {
