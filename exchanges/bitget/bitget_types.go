...
// WsFillResponse contains information on a fill response
...
// WsOrderResponse contains information on an order response
...
// WsTriggerOrderResponse contains information on a trigger order response
type WsTriggerOrderResponse struct {
	InstrumentID     string        `json:"instId"`
	OrderID          int64         `json:"orderId,string"`
	ClientOrderID    string        `json:"clientOid"`
	TriggerPrice     float64       `json:"triggerPrice,string"`
