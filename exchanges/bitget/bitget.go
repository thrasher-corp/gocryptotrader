...
func (bi *Bitget) GetMerchantAdvertisementList(ctx context.Context, startTime, endTime time.Time, limit, pagination, adNum, payMethodID int64, status, side, orderBy, sourceType string, cryptoCurrency, fiatCurrency currency.Code) (*P2PAdListResp, error) {
	...
	var resp struct {
		Data P2PAdListResp `json:"data"`
	}
	return &resp.Data, bi.SendAuthenticatedHTTPRequest(ctx, exchange.RestSpot, Rate10, http.MethodGet, bitgetP2P+bitgetAdvList, params.Values, nil, &resp)
}
...
func (bi *Bitget) GetMarginPositionRatios(ctx context.Context, pair currency.Pair, period, currency string) ([]PosRatMarginResp, error) {
	...
	return resp.PosRatMarginResp, bi.SendHTTPRequest(ctx, exchange.RestSpot, Rate1, path, vals, &resp)
}
...
func (bi *Bitget) GetMarginLoanGrowth(ctx context.Context, pair currency.Pair, period, currency string) ([]LoanGrowthResp, error) {
	...
	return resp.LoanGrowthResp, bi.SendHTTPRequest(ctx, exchange.RestSpot, Rate1, path, vals, &resp)
}
...
func (bi *Bitget) GetIsolatedBorrowingRatio(ctx context.Context, pair currency.Pair, period string) ([]BorrowRatioResp, error) {
	...
	return resp.BorrowRatioResp, bi.SendHTTPRequest(ctx, exchange.RestSpot, Rate1, path, vals, &resp)
}
...
func (bi *Bitget) PlaceSpotOrder(ctx context.Context, pair currency.Pair, side, orderType, strategy, clientOrderID, stpMode string, price, amount, triggerPrice, presetTPPrice, executeTPPrice, presetSLPrice, executeSLPrice float64, isCopyTradeLeader bool, acceptableDelay time.Duration) (*OrderIDStruct, error) {
	...
	return &resp.OrderIDStruct, bi.SendAuthenticatedHTTPRequest(ctx, exchange.RestSpot, rLim, http.MethodPost, path, nil, req, &resp)
}
...
func (bi *Bitget) CancelAndPlaceSpotOrder(ctx context.Context, pair currency.Pair, oldClientOrderID, newClientOrderID string, price, amount, presetTPPrice, executeTPPrice, presetSLPrice, executeSLPrice float64, orderID int64) (*CancelAndPlaceResp, error) {
	...
	var resp struct {
		CancelAndPlaceResp `json:"data"`
	}
	return &resp.CancelAndPlaceResp, bi.SendAuthenticatedHTTPRequest(ctx, exchange.RestSpot, Rate5, http.MethodPost, path, nil, req, &resp)
}
...
func (bi *Bitget) BatchCancelAndPlaceSpotOrders(ctx context.Context, orders []ReplaceSpotOrderStruct) ([]CancelAndPlaceResp, error) {
	...
	var resp struct {
		Data []CancelAndPlaceResp `json:"data"`
	}
	return resp.Data, bi.SendAuthenticatedHTTPRequest(ctx, exchange.RestSpot, Rate5, http.MethodPost, path, nil, req, &resp)
}
...
func (bi *Bitget) PlacePlanSpotOrder(ctx context.Context, pair currency.Pair, side, orderType, planType, triggerType, clientOrderID, strategy, stpMode string, triggerPrice, executePrice, amount float64) (*OrderIDStruct, error) {
	...
	return &resp.OrderIDStruct, bi.SendAuthenticatedHTTPRequest(ctx, exchange.RestSpot, Rate20, http.MethodPost, path, nil, req, &resp)
}
...
func (bi *Bitget) GetHistoricalFuturesOrders(ctx context.Context, orderID, pagination, limit int64, clientOrderID, productType, orderSource string, pair currency.Pair, startTime, endTime time.Time) (*HistFuturesOrdResp, error) {
	...
	var resp struct {
		HistFuturesOrdResp `json:"data"`
	}
	return &resp.HistFuturesOrdResp, bi.SendAuthenticatedHTTPRequest(ctx, exchange.RestSpot, Rate10, http.MethodGet, path, params.Values, nil, &resp)
}
...
func (bi *Bitget) PlaceTPAndSLFuturesOrder(ctx context.Context, marginCoin currency.Code, productType, takeProfitTriggerType, stopLossTriggerType, holdSide, stpMode string, pair currency.Pair, takeProfitTriggerPrice, takeProfitExecutePrice, stopLossTriggerPrice, stopLossExecutePrice float64) ([]int64, error) {
	...
	return resp.Data.OrderIDs, bi.SendAuthenticatedHTTPRequest(ctx, exchange.RestSpot, Rate10, http.MethodPost, path, nil, req, &resp)
}
...
func (bi *Bitget) GetCrossRepayHistory(ctx context.Context, repayID, limit, pagination int64, currency currency.Code, startTime, endTime time.Time) (*CrossRepayHistResp, error) {
	...
	var resp struct {
		CrossRepayHistResp `json:"data"`
	}
	return &resp.CrossRepayHistResp, bi.SendAuthenticatedHTTPRequest(ctx, exchange.RestSpot, Rate10, http.MethodGet, path, params.Values, nil, &resp)
}
...
func (bi *Bitget) GetIsolatedRepayHistory(ctx context.Context, pair currency.Pair, currency currency.Code, repayID, limit, pagination int64, startTime, endTime time.Time) (*IsoRepayHistResp, error) {
	if pair.IsEmpty() {
		return nil, errPairEmpty
	}
	var params Params
	...
	var resp struct {
		IsoRepayHistResp `json:"data"`
	}
	return &resp.IsoRepayHistResp, bi.SendAuthenticatedHTTPRequest(ctx, exchange.RestSpot, Rate10, http.MethodGet, path, params.Values, nil, &resp)
}

// GetIsolatedBorrowHistory returns the borrowing history for isolated margin
func (bi *Bitget) GetIsolatedBorrowHistory(ctx context.Context, pair currency.Pair, currency currency.Code, loanID, limit, pagination int64, startTime, endTime time.Time) (*BorrowHistIso, error) {
	if pair.IsEmpty() {
		return nil, errPairEmpty
	}
	var params Params
...
func (bi *Bitget) GetIsolatedInterestHistory(ctx context.Context, pair currency.Pair, currency currency.Code, startTime, endTime time.Time, limit, pagination int64) (*InterHistIso, error) {
	if pair.IsEmpty() {
		return nil, errPairEmpty
	}
	var params Params
...
func (bi *Bitget) GetIsolatedFinancialHistory(ctx context.Context, pair currency.Pair, marginType string, currency currency.Code, startTime, endTime time.Time, limit, pagination int64) (*FinHistIsoResp, error) {
	if pair.IsEmpty() {
		return nil, errPairEmpty
	}
	var params Params
...
func (bi *Bitget) IsolatedBorrow(ctx context.Context, pair currency.Pair, currency currency.Code, clientOrderID string, amount float64) (*BorrowIso, error) {
	if pair.IsEmpty() {
		return nil, errPairEmpty
	}
	if currency.IsEmpty() {
...
func (bi *Bitget) IsolatedRepay(ctx context.Context, amount float64, currency currency.Code, pair currency.Pair, clientOrderID string) (*RepayIso, error) {
	if amount == 0 {
		return nil, errAmountEmpty
	}
	if currency.IsEmpty() {
...
func (bi *Bitget) BorrowFunds(ctx context.Context, loanCoin, collateralCoin currency.Code, term string, collateralAmount, loanAmount float64) (int64, error) {
	...
	return resp.Data.OrderID, bi.SendAuthenticatedHTTPRequest(ctx, exchange.RestSpot, Rate10, http.MethodPost, path, nil, req, &resp)
}
