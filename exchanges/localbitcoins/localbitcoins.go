...
func (l *LocalBitcoins) GetAccountInformation(username string, self bool) (AccountInfo, error) {
	...
	if self {
		err := l.SendAuthenticatedHTTPRequest(spotURL, http.MethodGet, localbitcoinsAPIMyself, nil, &resp)
		if err != nil {
...
func (l *LocalBitcoins) Getads(args ...string) (AdData, error) {
	...
	var err error
	if len(args) == 0 {
		err = l.SendAuthenticatedHTTPRequest(spotURL, http.MethodGet,
			localbitcoinsAPIAds,
			nil,
			&resp)
	} else {
...
func (l *LocalBitcoins) EditAd(_ *AdEdit, adID string) error {
	...
	err := l.SendAuthenticatedHTTPRequest(spotURL, http.MethodPost,
...
func (l *LocalBitcoins) CreateAd(_ *AdCreate) error {
	return l.SendAuthenticatedHTTPRequest(spotURL, http.MethodPost, localbitcoinsAPIAdCreate, nil, nil)
}
...
func (l *LocalBitcoins) UpdatePriceEquation(adID string) error {
	return l.SendAuthenticatedHTTPRequest(spotURL, http.MethodPost, localbitcoinsAPIUpdateEquation+adID, nil, nil)
}
...
func (l *LocalBitcoins) ReleaseFunds(contactID string) error {
	return l.SendAuthenticatedHTTPRequest(spotURL, http.MethodPost, localbitcoinsAPIRelease+contactID, nil, nil)
}
...
func (l *LocalBitcoins) ReleaseFundsByPin(contactID string) error {
	return l.SendAuthenticatedHTTPRequest(spotURL, http.MethodPost, localbitcoinsAPIReleaseByPin+contactID, nil, nil)
}

// MarkAsPaid marks a trade as paid.
func (l *LocalBitcoins) MarkAsPaid(contactID string) error {
	return l.SendAuthenticatedHTTPRequest(spotURL, http.MethodPost, localbitcoinsAPIMarkAsPaid+contactID, nil, nil)
}
...
func (l *LocalBitcoins) GetMessages(contactID string) (Message, error) {
	...
	return resp.MessageList,
		l.SendAuthenticatedHTTPRequest(spotURL, http.MethodPost, localbitcoinsAPIMessages+contactID, nil, &resp)
}
...
func (l *LocalBitcoins) SendMessage(contactID string) error {
	return l.SendAuthenticatedHTTPRequest(spotURL, http.MethodPost, localbitcoinsAPISendMessage+contactID, nil, nil)
}
...
func (l *LocalBitcoins) Dispute(_, contactID string) error {
	return l.SendAuthenticatedHTTPRequest(spotURL, http.MethodPost, localbitcoinsAPIDispute+contactID, nil, nil)
}
...
func (l *LocalBitcoins) CancelTrade(contactID string) error {
	return l.SendAuthenticatedHTTPRequest(spotURL, http.MethodPost, localbitcoinsAPICancelTrade+contactID, nil, nil)
}
...
func (l *LocalBitcoins) FundTrade(contactID string) error {
	return l.SendAuthenticatedHTTPRequest(spotURL, http.MethodPost, localbitcoinsAPIFundTrade+contactID, nil, nil)
}

// ConfirmRealName creates or updates real name confirmation.
func (l *LocalBitcoins) ConfirmRealName(contactID string) error {
	return l.SendAuthenticatedHTTPRequest(spotURL, http.MethodPost, localbitcoinsAPIConfirmRealName+contactID, nil, nil)
}
...
func (l *LocalBitcoins) VerifyIdentity(contactID string) error {
	return l.SendAuthenticatedHTTPRequest(spotURL, http.MethodPost, localbitcoinsAPIVerifyIdentity+contactID, nil, nil)
}
...
func (l *LocalBitcoins) InitiateTrade(adID string) error {
	return l.SendAuthenticatedHTTPRequest(spotURL, http.MethodPost, localbitcoinsAPIInitiateTrade+adID, nil, nil)
}
...
func (l *LocalBitcoins) GetTradeInfo(contactID string) (dbi DashBoardInfo, err error) {
	err = l.SendAuthenticatedHTTPRequest(spotURL, http.MethodGet, localbitcoinsAPITradeInfo+contactID+"/", nil, &dbi)
	return
}

// GetCountryCodes returns a list of valid and recognized countrycodes
func (l *LocalBitcoins) GetCountryCodes() error {
	return l.SendHTTPRequest(spotURL, localbitcoinsAPICountryCodes, nil)
}
...
func (l *LocalBitcoins) GetCurrencies() error {
	return l.SendHTTPRequest(spotURL, localbitcoinsAPICurrencies, nil)
}
...
func (l *LocalBitcoins) GetDashboardInfo() ([]DashBoardInfo, error) {
	...
	return resp.Data.ContactList,
		l.SendAuthenticatedHTTPRequest(spotURL, http.MethodGet, localbitcoinsAPIDashboard, nil, &resp)
}
...
func (l *LocalBitcoins) GetDashboardReleasedTrades() ([]DashBoardInfo, error) {
	...
	return resp.Data.ContactList,
		l.SendAuthenticatedHTTPRequest(spotURL, http.MethodGet, localbitcoinsAPIDashboardReleased, nil, &resp)
}
...
func (l *LocalBitcoins) GetDashboardCancelledTrades() ([]DashBoardInfo, error) {
	...
	return resp.Data.ContactList,
		l.SendAuthenticatedHTTPRequest(spotURL, http.MethodGet, localbitcoinsAPIDashboardCancelled, nil, &resp)
}
...
func (l *LocalBitcoins) GetDashboardClosedTrades() ([]DashBoardInfo, error) {
	...
	return resp.Data.ContactList,
		l.SendAuthenticatedHTTPRequest(spotURL, http.MethodGet, localbitcoinsAPIDashboardClosed, nil, &resp)
}
...
func (l *LocalBitcoins) SetFeedback() error {
	return l.SendAuthenticatedHTTPRequest(spotURL, http.MethodPost, localbitcoinsAPIFeedback, nil, nil)
}
...
func (l *LocalBitcoins) Logout() error {
	return l.SendAuthenticatedHTTPRequest(spotURL, http.MethodPost, localbitcoinsAPILogout, nil, nil)
}

// CreateNewInvoice creates a new invoice.
// TODO
func (l *LocalBitcoins) CreateNewInvoice() error {
	return l.SendAuthenticatedHTTPRequest(spotURL, http.MethodPost, localbitcoinsAPICreateInvoice, nil, nil)
}
...
func (l *LocalBitcoins) GetInvoice() (Invoice, error) {
	resp := Invoice{}
	return resp, l.SendAuthenticatedHTTPRequest(spotURL, http.MethodPost, localbitcoinsAPICreateInvoice, nil, &resp)
}
...
func (l *LocalBitcoins) GetNotifications() ([]NotificationInfo, error) {
	...
	return resp, l.SendAuthenticatedHTTPRequest(spotURL, http.MethodPost, localbitcoinsAPIGetNotification, nil, &resp)
}

// MarkNotifications marks a specific notification as read.
// TODO
func (l *LocalBitcoins) MarkNotifications() error {
	return l.SendAuthenticatedHTTPRequest(spotURL, http.MethodPost, localbitcoinsAPIMarkNotification, nil, nil)
}
...
func (l *LocalBitcoins) GetPaymentMethods() error {
	return l.SendHTTPRequest(spotURL, localbitcoinsAPIPaymentMethods, nil)
}
...
func (l *LocalBitcoins) GetPaymentMethodsByCountry(countryCode string) error {
	return l.SendHTTPRequest(spotURL, localbitcoinsAPIPaymentMethods+countryCode, nil)
}
...
func (l *LocalBitcoins) CheckPincode(pin int) (bool, error) {
	...
	err := l.SendAuthenticatedHTTPRequest(spotURL, http.MethodPost, localbitcoinsAPIPinCode, values, &resp)
...
func (l *LocalBitcoins) GetPlaces() error {
	return l.SendHTTPRequest(spotURL, localbitcoinsAPIPlaces, nil)
}
...
func (l *LocalBitcoins) VerifyUsername() error {
	return l.SendAuthenticatedHTTPRequest(spotURL, http.MethodPost, localbitcoinsAPIVerifyUsername, nil, nil)
}
...
func (l *LocalBitcoins) GetWalletInfo() (WalletInfo, error) {
	...
	resp := response{}
	err := l.SendAuthenticatedHTTPRequest(spotURL, http.MethodGet, localbitcoinsAPIWallet, nil, &resp)
...
func (l *LocalBitcoins) GetWalletBalance() (WalletBalanceInfo, error) {
	...
	resp := response{}
	err := l.SendAuthenticatedHTTPRequest(spotURL, http.MethodGet, localbitcoinsAPIWalletBalance, nil, &resp)
...
func (l *LocalBitcoins) WalletSend(address string, amount float64, pin int64) error {
	...
	err := l.SendAuthenticatedHTTPRequest(spotURL, http.MethodPost, path, values, &resp)
	if err != nil {
		return err
	}
...
func (l *LocalBitcoins) GetWalletAddress() (string, error) {
	...
	resp := response{}
	err := l.SendAuthenticatedHTTPRequest(spotURL, http.MethodPost, localbitcoinsAPIWalletAddress, nil, &resp)
	if err != nil {
		return "", err
	}
...
func (l *LocalBitcoins) GetBitcoinsWithCashAd() error {
	return l.SendHTTPRequest(spotURL, localbitcoinsAPICashBuy, nil)
}

// GetBitcoinsOnlineAd this API returns buy or sell Bitcoin online ads.
// TODO
func (l *LocalBitcoins) GetBitcoinsOnlineAd() error {
	return l.SendHTTPRequest(spotURL, localbitcoinsAPIOnlineBuy, nil)
}
...
func (l *LocalBitcoins) GetTicker() (map[string]Ticker, error) {
	...
	return result, l.SendHTTPRequest(spotURL, localbitcoinsAPITicker, &result)
}
...
func (l *LocalBitcoins) GetTrades(currency string, values url.Values) ([]Trade, error) {
	...
	var result []Trade
	return result, l.SendHTTPRequest(spotURL, path, &result)
}
