...
func TestGetUserInfo(t *testing.T) {
	t.Parallel()
	sharedtestvalues.SkipUnsetCredentials(t, e)
...
func TestGetFeeByTypeOfflineTradeFee(t *testing.T) {
	...
	if !sharedtestvalues.AreAPIkeysSet(e) {
...
func TestGetActiveOrders(t *testing.T) {
	...
	if sharedtestvalues.AreAPIkeysSet(e) && err != nil {
		t.Errorf("Could not get open orders: %s", err)
	} else if !sharedtestvalues.AreAPIkeysSet(e) && err == nil {
...
func TestSubmitOrder(t *testing.T) {
	t.Parallel()
	sharedtestvalues.SkipCredentialsSetCantManipulate(t, e, canManipulateRealOrders)
	...
	if sharedtestvalues.AreAPIkeysSet(e) && (err != nil || response.Status != order.New) {
