...
// submitted
func (e *EXMO) WithdrawCryptocurrencyFunds(withdrawRequest *withdraw.Request) (string, error) {
...
func (e *EXMO) WithdrawFiatFunds(withdrawRequest *withdraw.Request) (string, error) {
	return "", common.ErrFunctionNotSupported
}
