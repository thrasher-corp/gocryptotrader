...
func (b *BTSE) GetExchangeHistory(*trade.HistoryRequest) ([]trade.History, error) {
...
func (b *BTSE) GetHistoricCandlesEx(pair currency.Pair, a asset.Item, start, end time.Time, interval kline.Interval) (kline.Item, error) {
