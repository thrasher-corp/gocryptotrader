...
func (b *BTSE) GetMarketSummary(symbol string, spot bool) (MarketSummary, error) {
	...
	return m, b.SendHTTPRequest(spotURL, http.MethodGet, path, &m, spot, queryFunc)
}

// GetSpotMarkets returns a list of spot markets available on BTSE
func (b *BTSE) GetSpotMarkets() ([]SpotMarket, error) {
	var m []SpotMarket
	return m, b.SendHTTPRequest(spotURL, http.MethodGet, btseMarkets, &m, true, queryFunc)
}
...
func (b *BTSE) FetchOrderBook(symbol string, group, limitBids, limitAsks int, spot bool) (*Orderbook, error) {
	...
	return &o, b.SendHTTPRequest(spotURL, http.MethodGet,
...
func (b *BTSE) FetchOrderBookL2(symbol string, depth int) (*Orderbook, error) {
	...
	return &o, b.SendHTTPRequest(spotURL, http.MethodGet, endpoint, &o, true, queryFunc)
}
...
func (b *BTSE) GetTrades(symbol string, start, end time.Time, beforeSerialID, afterSerialID, count int, includeOld, spot bool) ([]Trade, error) {
	...
	return t, b.SendHTTPRequest(spotURL, http.MethodGet,
...
func (b *BTSE) GetPrice(symbol string) (Price, error) {
	...
	return p, b.SendHTTPRequest(spotURL, http.MethodGet, path, &p, true, queryFunc)
}

// GetServerTime returns the exchanges server time
func (b *BTSE) GetServerTime() (*ServerTime, error) {
	var s ServerTime
	return &s, b.SendHTTPRequest(spotURL, http.MethodGet, btseTime, &s, true, queryFunc)
}
...
func (b *BTSE) GetWalletInformation() ([]CurrencyBalance, error) {
	...
	return a, b.SendAuthenticatedHTTPRequest(spotURL, http.MethodGet, btseWallet, true, nil, nil, &a, queryFunc)
}
...
func (b *BTSE) GetFeeInformation(symbol string) ([]AccountFees, error) {
	...
	return resp, b.SendAuthenticatedHTTPRequest(spotURL, http.MethodGet, btseUserFee, true, urlValues, nil, &resp, queryFunc)
}
...
func (b *BTSE) GetWalletHistory(symbol string, start, end time.Time, count int) (WalletHistory, error) {
	...
	return resp, b.SendAuthenticatedHTTPRequest(spotURL, http.MethodGet, btseWalletHistory, true, urlValues, nil, &resp, queryFunc)
}
...
func (b *BTSE) GetWalletAddress(currency string) (WalletAddress, error) {
	...
	return resp, b.SendAuthenticatedHTTPRequest(spotURL, http.MethodGet, btseWalletAddress, true, urlValues, nil, &resp, queryFunc)
}
...
func (b *BTSE) CreateWalletAddress(currency string) (WalletAddress, error) {
	...
	err := b.SendAuthenticatedHTTPRequest(spotURL, http.MethodPost, btseWalletAddress, true, nil, req, &resp, queryFunc)
	if err != nil {
...
func (b *BTSE) WalletWithdrawal(currency, address, tag, amount string) (WithdrawalResponse, error) {
	...
	req["tag"] = tag
	req["amount"] = amount
	return resp, b.SendAuthenticatedHTTPRequest(spotURL, http.MethodPost, btseWalletWithdrawal, true, nil, req, &resp, queryFunc)
}
...
func (b *BTSE) CreateOrder(clOrderID string, deviation float64, postOnly bool, price float64, side string, size, stealth, stopPrice float64, symbol, timeInForce string, trailValue, triggerPrice float64, txType, orderType string) ([]Order, error) {
	...
	var r []Order
	return r, b.SendAuthenticatedHTTPRequest(spotURL, http.MethodPost, btseOrder, true, url.Values{}, req, &r, orderFunc)
}
...
func (b *BTSE) GetOrders(symbol, orderID, clOrderID string) ([]OpenOrder, error) {
	...
	var o []OpenOrder
	return o, b.SendAuthenticatedHTTPRequest(spotURL, http.MethodGet, btsePendingOrders, true, req, nil, &o, orderFunc)
}
...
func (b *BTSE) CancelExistingOrder(orderID, symbol, clOrderID string) (CancelOrder, error) {
	...
	return c, b.SendAuthenticatedHTTPRequest(spotURL, http.MethodDelete, btseOrder, true, req, nil, &c, orderFunc)
}
...
func (b *BTSE) CancelAllAfter(timeout int) error {
	req := make(map[string]interface{})
	req["timeout"] = timeout
	return b.SendAuthenticatedHTTPRequest(spotURL, http.MethodPost, btseCancelAllAfter, true, url.Values{}, req, nil, orderFunc)
}
...
func (b *BTSE) IndexOrderPeg(clOrderID string, deviation float64, postOnly bool, price float64, side string, size, stealth, stopPrice float64, symbol, timeInForce string, trailValue, triggerPrice float64, txType, orderType string) ([]Order, error) {
	...
	return o, b.SendAuthenticatedHTTPRequest(spotURL, http.MethodPost, btsePegOrder, true, url.Values{}, req, nil, orderFunc)
}
...
func (b *BTSE) TradeHistory(symbol string, start, end time.Time, beforeSerialID, afterSerialID, count int, includeOld bool, clOrderID, orderID string) (TradeHistory, error) {
	...
	return resp, b.SendAuthenticatedHTTPRequest(spotURL, http.MethodGet, btseExchangeHistory, true, urlValues, nil, &resp, queryFunc)
}
