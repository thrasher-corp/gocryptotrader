...
func (b *BTSE) WsConnect(conn stream.Connection) error {
...
func (b *BTSE) GenerateDefaultSubscriptions(options stream.SubscriptionOptions) ([]stream.SubscriptionParamaters, error) {
