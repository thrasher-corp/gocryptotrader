...
func TestGetFuturesTickers(t *testing.T) {
	t.Parallel()
	tickers, err := e.GetFuturesTickers(t.Context())
	assert.NoError(t, err)
	for i := range tickers {
		...
		assert.Equal(t, e.Name, tickers[i].ExchangeName)
...
func TestGetMarketList(t *testing.T) {
	t.Parallel()
	_, err := e.GetMarketList(t.Context())
	assert.NoError(t, err)
}
...
func TestGetCurrenciesV3(t *testing.T) {
	t.Parallel()
	_, err := e.GetCurrenciesV3(t.Context())
	assert.NoError(t, err)
}

func TestGetCurrencyV3(t *testing.T) {
	t.Parallel()
	_, err := e.GetCurrencyDetailV3(t.Context(), currency.EMPTYCODE, "")
	require.ErrorIs(t, err, currency.ErrCurrencyCodeEmpty)
	result, err := e.GetCurrencyDetailV3(t.Context(), currency.BTC, "")
	assert.NoError(t, err)
	assert.NotNil(t, result)

	result, err = e.GetCurrencyDetailV3(t.Context(), currency.BTC, "ETH")
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetFiatPrice(t *testing.T) {
	t.Parallel()
	result, err := e.GetFiatPrice(t.Context(), "", "")
	assert.NoError(t, err)
	assert.NotNil(t, result)

	result, err = e.GetFiatPrice(t.Context(), "EUR", "ETH,BTC")
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetLeveragedTokenInfo(t *testing.T) {
	t.Parallel()
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetLeveragedTokenInfo(t.Context(), currency.BTC)
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetAllMarginTradingPairsMarkPrices(t *testing.T) {
	t.Parallel()
	result, err := e.GetAllMarginTradingPairsMarkPrices(t.Context())
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetMarginConfiguration(t *testing.T) {
	t.Parallel()
	result, err := e.GetMarginConfiguration(t.Context())
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetMarginAccount(t *testing.T) {
	t.Parallel()
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetMarginAccount(t.Context())
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetCrossMarginRiskLimitCurrencyConfig(t *testing.T) {
	t.Parallel()
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetCrossMarginRiskLimitCurrencyConfig(t.Context(), "", currency.BTC)
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetIsolatedMarginRiskLimitCurrencyConfig(t *testing.T) {
	t.Parallel()
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetIsolatedMarginRiskLimitCurrencyConfig(t.Context(), "", currency.BTC)
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestPostBorrowOrder(t *testing.T) {
	t.Parallel()
	_, err := e.PostMarginBorrowOrder(t.Context(), &MarginBorrowParam{})
	require.ErrorIs(t, err, common.ErrNilPointer)

	_, err = e.PostMarginBorrowOrder(t.Context(), &MarginBorrowParam{IsIsolated: true})
	require.ErrorIs(t, err, currency.ErrCurrencyCodeEmpty)

	_, err = e.PostMarginBorrowOrder(t.Context(), &MarginBorrowParam{IsIsolated: true, Currency: currency.BTC})
	require.ErrorIs(t, err, errTimeInForceRequired)

	_, err = e.PostMarginBorrowOrder(t.Context(),
		&MarginBorrowParam{
...
func TestPostRepayment(t *testing.T) {
	t.Parallel()
	_, err := e.PostRepayment(t.Context(), &RepayParam{})
	require.ErrorIs(t, err, common.ErrNilPointer)
...
func TestGetCrossIsolatedMarginInterestRecords(t *testing.T) {
	t.Parallel()
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetCrossIsolatedMarginInterestRecords(t.Context(), false, "", currency.BTC, time.Now().Add(-time.Hour*50), time.Now(), 0, 0)
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetIsolatedMarginPairConfig(t *testing.T) {
	t.Parallel()
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetIsolatedMarginPairConfig(t.Context())
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetIsolatedMarginAccountInfo(t *testing.T) {
	t.Parallel()
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetIsolatedMarginAccountInfo(t.Context(), "")
	assert.NoError(t, err)
	assert.NotNil(t, result)
	result, err = e.GetIsolatedMarginAccountInfo(t.Context(), "USDT")
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetSingleIsolatedMarginAccountInfo(t *testing.T) {
	t.Parallel()
	_, err := e.GetSingleIsolatedMarginAccountInfo(t.Context(), "")
	require.ErrorIs(t, err, currency.ErrSymbolStringEmpty)
...
func TestGetServiceStatus(t *testing.T) {
	t.Parallel()
	result, err := e.GetServiceStatus(t.Context())
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestCancelSingleOrder(t *testing.T) {
	t.Parallel()
	_, err := e.CancelSingleOrder(t.Context(), "")
	require.ErrorIs(t, err, order.ErrOrderIDNotSet)

	sharedtestvalues.SkipTestIfCredentialsUnset(t, e, canManipulateRealOrders)
	result, err := e.CancelSingleOrder(t.Context(), "5bd6e9286d99522a52e458de")
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestCancelOrderByClientOID(t *testing.T) {
	t.Parallel()
	_, err := e.CancelOrderByClientOID(t.Context(), "")
	require.ErrorIs(t, err, order.ErrOrderIDNotSet)

	sharedtestvalues.SkipTestIfCredentialsUnset(t, e, canManipulateRealOrders)
	result, err := e.CancelOrderByClientOID(t.Context(), "5bd6e9286d99522a52e458de")
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetOrders(t *testing.T) {
	...
	result, err := e.ListOrders(t.Context(), "", "", "", "", "", time.Time{}, time.Time{})
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetRecentOrders(t *testing.T) {
	t.Parallel()
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetRecentOrders(t.Context())
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetOrderByID(t *testing.T) {
	t.Parallel()
	_, err := e.GetOrderByID(t.Context(), "")
	require.ErrorIs(t, err, order.ErrOrderIDNotSet)

	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetOrderByID(t.Context(), "5c35c02703aa673ceec2a168")
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetOrderByClientOID(t *testing.T) {
	t.Parallel()
	_, err := e.GetOrderByClientSuppliedOrderID(t.Context(), "")
	require.ErrorIs(t, err, order.ErrClientOrderIDMustBeSet)

	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetOrderByClientSuppliedOrderID(t.Context(), "6d539dc614db312")
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetFills(t *testing.T) {
	t.Parallel()
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetFills(t.Context(), "", "", "", "", "", time.Time{}, time.Time{})
	assert.NoError(t, err)
	assert.NotNil(t, result)
...
func TestGetRecentFills(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetRecentFills(t.Context())
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestCancelStopOrder(t *testing.T) {
	t.Parallel()
	_, err := e.CancelStopOrder(t.Context(), "")
	require.ErrorIs(t, err, order.ErrOrderIDNotSet)

	sharedtestvalues.SkipTestIfCredentialsUnset(t, e, canManipulateRealOrders)
	result, err := e.CancelStopOrder(t.Context(), "5bd6e9286d99522a52e458de")
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestCancelAllStopOrder(t *testing.T) {
	t.Parallel()
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e, canManipulateRealOrders)
	result, err := e.CancelStopOrders(t.Context(), "", "", []string{})
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetStopOrder(t *testing.T) {
	...
	assert.NoError(t, err)
	_, err = e.GetStopOrder(t.Context(), "")
	require.ErrorIs(t, err, order.ErrOrderIDNotSet)

	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetStopOrder(t.Context(), "5bd6e9286d99522a52e458de")
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetAllStopOrder(t *testing.T) {
	t.Parallel()
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.ListStopOrders(t.Context(), "", "", "", "", []string{}, time.Time{}, time.Time{}, 0, 0)
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetStopOrderByClientID(t *testing.T) {
	t.Parallel()
	_, err := e.GetStopOrderByClientID(t.Context(), "", "")
	require.ErrorIs(t, err, order.ErrClientOrderIDMustBeSet)

	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetStopOrderByClientID(t.Context(), "", "5bd6e9286d99522a52e458de")
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestCancelStopOrderByClientID(t *testing.T) {
	t.Parallel()
	_, err := e.CancelStopOrderByClientID(t.Context(), "", "")
	require.ErrorIs(t, err, order.ErrClientOrderIDMustBeSet)

	sharedtestvalues.SkipTestIfCredentialsUnset(t, e, canManipulateRealOrders)
	result, err := e.CancelStopOrderByClientID(t.Context(), "", "5bd6e9286d99522a52e458de")
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetAccount(t *testing.T) {
	t.Parallel()
	_, err := e.GetAccountDetail(t.Context(), "")
	require.ErrorIs(t, err, errAccountIDMissing)

	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetAccountDetail(t.Context(), "62fcd1969474ea0001fd20e4")
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetCrossMarginAccountsDetail(t *testing.T) {
	t.Parallel()
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetCrossMarginAccountsDetail(t.Context(), "KCS", "MARGIN_V2")
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetFuturesAccountDetail(t *testing.T) {
	t.Parallel()
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetFuturesAccountDetail(t.Context(), currency.USDT)
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetSubAccounts(t *testing.T) {
	t.Parallel()
	_, err := e.GetSubAccounts(t.Context(), "", false)
	require.ErrorIs(t, err, order.ErrOrderIDNotSet)

	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetSubAccounts(t.Context(), "5caefba7d9575a0688f83c45", false)
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetAllFuturesSubAccountBalances(t *testing.T) {
	t.Parallel()
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetAllFuturesSubAccountBalances(t.Context(), currency.BTC)
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetAccountLedgers(t *testing.T) {
	...
	_, err = e.GetAccountLedgers(t.Context(), currency.EMPTYCODE, "", "", time.Now(), time.Now().Add(-time.Hour*24*10))
	require.ErrorIs(t, err, common.ErrStartAfterEnd)

	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetAccountLedgers(t.Context(), currency.EMPTYCODE, "", "", time.Time{}, time.Time{})
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetAccountLedgersHFTrade(t *testing.T) {
	t.Parallel()
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	_, err := e.GetAccountLedgersHFTrade(t.Context(), currency.BTC, "", "", 0, 10, time.Time{}, time.Now())
	assert.NoError(t, err)
}
...
func TestGetAccountLedgerHFMargin(t *testing.T) {
	t.Parallel()
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetAccountLedgerHFMargin(t.Context(), currency.BTC, "", "", 0, 0, time.Time{}, time.Time{})
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetFuturesAccountLedgers(t *testing.T) {
	t.Parallel()
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetFuturesAccountLedgers(t.Context(), currency.BTC, true, time.Time{}, time.Now(), 0, 100)
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetAllSubAccountsInfoV1(t *testing.T) {
	t.Parallel()
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetAllSubAccountsInfoV1(t.Context())
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetAllSubAccountsInfoV2(t *testing.T) {
	t.Parallel()
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetAllSubAccountsInfoV2(t.Context(), 0, 30)
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetAccountSummaryInformation(t *testing.T) {
	t.Parallel()
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetAccountSummaryInformation(t.Context())
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetAggregatedSubAccountBalance(t *testing.T) {
	t.Parallel()
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetAggregatedSubAccountBalance(t.Context())
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetAllSubAccountsBalanceV2(t *testing.T) {
	t.Parallel()
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetAllSubAccountsBalanceV2(t.Context())
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetPaginatedSubAccountInformation(t *testing.T) {
	t.Parallel()
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetPaginatedSubAccountInformation(t.Context(), 0, 10)
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetTransferableBalance(t *testing.T) {
	t.Parallel()
	_, err := e.GetTransferableBalance(t.Context(), currency.EMPTYCODE, "MAIN", "")
	require.ErrorIs(t, err, currency.ErrCurrencyCodeEmpty)
	_, err = e.GetTransferableBalance(t.Context(), currency.BTC, "", "")
	require.ErrorIs(t, err, errAccountTypeMissing)

	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetTransferableBalance(t.Context(), currency.BTC, "MAIN", "")
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetUniversalTransfer(t *testing.T) {
	t.Parallel()
	_, err := e.GetUniversalTransfer(t.Context(), &UniversalTransferParam{})
	require.ErrorIs(t, err, common.ErrNilPointer)
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e, canManipulateRealOrders)
	result, err := e.GetUniversalTransfer(t.Context(), &UniversalTransferParam{
...
func TestTransferMainToSubAccount(t *testing.T) {
	t.Parallel()
	_, err := e.TransferMainToSubAccount(t.Context(), currency.EMPTYCODE, 1, "62fcd1969474ea0001fd20e4", "OUT", "", "", "5caefba7d9575a0688f83c45")
	require.ErrorIs(t, err, currency.ErrCurrencyCodeEmpty)
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e, canManipulateRealOrders)
	result, err := e.TransferMainToSubAccount(t.Context(), currency.BTC, 1, "62fcd1969474ea0001fd20e4", "OUT", "", "", "5caefba7d9575a0688f83c45")
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestMakeInnerTransfer(t *testing.T) {
	t.Parallel()
	_, err := e.MakeInnerTransfer(t.Context(), 0, currency.EMPTYCODE, "62fcd1969474ea0001fd20e4", "trade", "main", "1", "")
	require.ErrorIs(t, err, currency.ErrCurrencyCodeEmpty)
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e, canManipulateRealOrders)
	result, err := e.MakeInnerTransfer(t.Context(), 10, currency.USDT, "62fcd1969474ea0001fd20e4", "main", "trade_hf", "", "")
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestTransferToFuturesAccount(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e, canManipulateRealOrders)
	result, err := e.TransferToFuturesAccount(t.Context(), &FundTransferToFuturesParam{
		Amount:             60,
		Currency:           currency.USDT,
...
func TestGetFuturesTransferOutRequestRecords(t *testing.T) {
	t.Parallel()
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetFuturesTransferOutRequestRecords(t.Context(), time.Time{}, time.Now(), "", "", currency.BTC, 0, 10)
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestCreateDepositAddress(t *testing.T) {
	t.Parallel()
	_, err := e.CreateDepositAddress(t.Context(), &DepositAddressParams{})
	require.ErrorIs(t, err, currency.ErrCurrencyCodeEmpty)

	sharedtestvalues.SkipTestIfCredentialsUnset(t, e, canManipulateRealOrders)
	result, err := e.CreateDepositAddress(t.Context(), &DepositAddressParams{
		Currency: currency.BTC,
	})
	assert.NoError(t, err)
	assert.NotNil(t, result)

	result, err = e.CreateDepositAddress(t.Context(),
...
func TestGetDepositAddressV2(t *testing.T) {
	t.Parallel()
	_, err := e.GetDepositAddressesV2(t.Context(), currency.EMPTYCODE)
	require.ErrorIs(t, err, currency.ErrCurrencyCodeEmpty)

	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetDepositAddressesV2(t.Context(), currency.BTC)
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetDepositAddressesV1(t *testing.T) {
	t.Parallel()
	_, err := e.GetDepositAddressV1(t.Context(), currency.EMPTYCODE, "")
	require.ErrorIs(t, err, currency.ErrCurrencyCodeEmpty)

	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetDepositAddressV1(t.Context(), currency.BTC, "")
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetDepositList(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetDepositList(t.Context(), currency.EMPTYCODE, "", time.Time{}, time.Time{})
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetHistoricalDepositList(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetHistoricalDepositList(t.Context(), currency.EMPTYCODE, "", time.Time{}, time.Time{})
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetWithdrawalList(t *testing.T) {
	t.Parallel()
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetWithdrawalList(t.Context(), currency.EMPTYCODE, "", time.Time{}, time.Time{})
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetHistoricalWithdrawalList(t *testing.T) {
	t.Parallel()
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetHistoricalWithdrawalList(t.Context(), currency.EMPTYCODE, "", time.Time{}, time.Time{})
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetWithdrawalQuotas(t *testing.T) {
	t.Parallel()
	_, err := e.GetWithdrawalQuotas(t.Context(), currency.EMPTYCODE, "")
	require.ErrorIs(t, err, currency.ErrCurrencyCodeEmpty)

	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetWithdrawalQuotas(t.Context(), currency.BTC, "")
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestApplyWithdrawal(t *testing.T) {
	t.Parallel()
	_, err := e.ApplyWithdrawal(t.Context(), currency.EMPTYCODE, "0x597873884BC3a6C10cB6Eb7C69172028Fa85B25A", "", "", "", "", false, 1)
	require.ErrorIs(t, err, currency.ErrCurrencyCodeEmpty)
...
func TestCancelWithdrawal(t *testing.T) {
	t.Parallel()
	err := e.CancelWithdrawal(t.Context(), "")
	require.ErrorIs(t, err, order.ErrOrderIDNotSet)

	sharedtestvalues.SkipTestIfCredentialsUnset(t, e, canManipulateRealOrders)
	err = e.CancelWithdrawal(t.Context(), "5bffb63303aa675e8bbe18f9")
	assert.NoError(t, err)
}
...
func TestGetBasicFee(t *testing.T) {
	t.Parallel()
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetBasicFee(t.Context(), "1")
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetTradingFee(t *testing.T) {
	t.Parallel()
	_, err := e.GetTradingFee(t.Context(), nil)
	...
	result, err := e.GetTradingFee(t.Context(), pairs)
	assert.NoError(t, err)
	assert.NotNil(t, result)

	got, err := e.GetTradingFee(t.Context(), pairs[:10])
	assert.NoError(t, err)
	assert.Len(t, got, 10)
}
...
func TestGetFuturesContract(t *testing.T) {
	t.Parallel()
	_, err := e.GetFuturesContract(t.Context(), "")
	require.ErrorIs(t, err, currency.ErrSymbolStringEmpty)

	result, err := e.GetFuturesContract(t.Context(), "XBTUSDTM")
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetFuturesTicker(t *testing.T) {
	t.Parallel()
	_, err := e.GetFuturesTicker(t.Context(), "")
	require.ErrorIs(t, err, currency.ErrSymbolStringEmpty)

	tick, err := e.GetFuturesTicker(t.Context(), "XBTUSDTM")
...
func TestGetFuturesPartOrderbook20(t *testing.T) {
	t.Parallel()
	_, err := e.GetFuturesPartOrderbook20(t.Context(), "")
	require.ErrorIs(t, err, currency.ErrSymbolStringEmpty)

	result, err := e.GetFuturesPartOrderbook20(t.Context(), "XBTUSDTM")
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetFuturesPartOrderbook100(t *testing.T) {
	t.Parallel()
	_, err := e.GetFuturesPartOrderbook100(t.Context(), "")
	require.ErrorIs(t, err, currency.ErrSymbolStringEmpty)

	result, err := e.GetFuturesPartOrderbook100(t.Context(), "XBTUSDTM")
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetFuturesTradeHistory(t *testing.T) {
	t.Parallel()
	_, err := e.GetFuturesTradeHistory(t.Context(), "")
	require.ErrorIs(t, err, currency.ErrSymbolStringEmpty)

	result, err := e.GetFuturesTradeHistory(t.Context(), "XBTUSDTM")
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGet24HourFuturesTransactionVolume(t *testing.T) {
	t.Parallel()
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	resp, err := e.Get24HourFuturesTransactionVolume(t.Context())
	assert.NoError(t, err)
...
func TestGetFuturesServerTime(t *testing.T) {
	t.Parallel()
	result, err := e.GetFuturesServerTime(t.Context())
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetFuturesServiceStatus(t *testing.T) {
	t.Parallel()
	result, err := e.GetFuturesServiceStatus(t.Context())
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestPostFuturesOrder(t *testing.T) {
	t.Parallel()
	_, err := e.PostFuturesOrder(t.Context(), &FuturesOrderParam{ClientOrderID: "5bd6e9286d99522a52e458de", Side: "buy"})
	require.ErrorIs(t, err, errInvalidLeverage)
	_, err = e.PostFuturesOrder(t.Context(), &FuturesOrderParam{Side: "buy", Leverage: 1})
	require.ErrorIs(t, err, order.ErrClientOrderIDMustBeSet)
	_, err = e.PostFuturesOrder(t.Context(), &FuturesOrderParam{ClientOrderID: "5bd6e9286d99522a52e458de", Leverage: 1})
	require.ErrorIs(t, err, order.ErrSideIsInvalid)
	_, err = e.PostFuturesOrder(t.Context(), &FuturesOrderParam{ClientOrderID: "5bd6e9286d99522a52e458de", Side: "buy", Leverage: 1})
	require.ErrorIs(t, err, currency.ErrCurrencyPairEmpty)
...
func TestFillFuturesPostOrderArgumentFilter(t *testing.T) {
	...
	require.ErrorIs(t, err, order.ErrClientOrderIDMustBeSet)
	err = e.FillFuturesPostOrderArgumentFilter(&FuturesOrderParam{ClientOrderID: "5bd6e9286d99522a52e458de", Leverage: 1})
	require.ErrorIs(t, err, order.ErrSideIsInvalid)
	err = e.FillFuturesPostOrderArgumentFilter(&FuturesOrderParam{ClientOrderID: "5bd6e9286d99522a52e458de", Side: "buy", Leverage: 1})
	require.ErrorIs(t, err, currency.ErrCurrencyPairEmpty)
...
func TestPlaceMultipleFuturesOrders(t *testing.T) {
	t.Parallel()
	_, err := e.PlaceMultipleFuturesOrders(t.Context(), []FuturesOrderParam{})
	require.ErrorIs(t, err, common.ErrEmptyParams)

	sharedtestvalues.SkipTestIfCredentialsUnset(t, e, canManipulateRealOrders)
	result, err := e.PlaceMultipleFuturesOrders(t.Context(), []FuturesOrderParam{
		{
...
func TestCancelFuturesOrder(t *testing.T) {
	t.Parallel()
	_, err := e.CancelFuturesOrderByOrderID(t.Context(), "")
	require.ErrorIs(t, err, order.ErrOrderIDNotSet)

	sharedtestvalues.SkipTestIfCredentialsUnset(t, e, canManipulateRealOrders)
	result, err := e.CancelFuturesOrderByOrderID(t.Context(), "5bd6e9286d99522a52e458de")
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetFuturesOrders(t *testing.T) {
	t.Parallel()
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetFuturesOrders(t.Context(), "", "", "", "", time.Time{}, time.Time{})
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetUntriggeredFuturesStopOrders(t *testing.T) {
	t.Parallel()
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetUntriggeredFuturesStopOrders(t.Context(), "", "", "", time.Time{}, time.Time{})
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetFuturesOrderDetails(t *testing.T) {
	t.Parallel()
	_, err := e.GetFuturesOrderDetails(t.Context(), "", "")
	require.ErrorIs(t, err, order.ErrOrderIDNotSet)

	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetFuturesOrderDetails(t.Context(), "5cdfc138b21023a909e5ad55", "2212332")
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetFuturesOrderDetailsByClientID(t *testing.T) {
	t.Parallel()
	_, err := e.GetFuturesOrderDetailsByClientOrderID(t.Context(), "")
	require.ErrorIs(t, err, order.ErrClientOrderIDMustBeSet)

	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetFuturesOrderDetailsByClientOrderID(t.Context(), "eresc138b21023a909e5ad59")
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetFuturesFills(t *testing.T) {
	t.Parallel()
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetFuturesFills(t.Context(), "", "", "", "", time.Time{}, time.Time{})
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetFuturesRecentFills(t *testing.T) {
	t.Parallel()
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetFuturesRecentFills(t.Context())
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetFuturesOpenOrderStats(t *testing.T) {
	t.Parallel()
	_, err := e.GetFuturesOpenOrderStats(t.Context(), "")
	require.ErrorIs(t, err, currency.ErrSymbolStringEmpty)
...
func TestGetFuturesPosition(t *testing.T) {
	t.Parallel()
	_, err := e.GetFuturesPosition(t.Context(), "")
	require.ErrorIs(t, err, currency.ErrSymbolStringEmpty)
...
func TestGetFuturesPositionList(t *testing.T) {
	t.Parallel()
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetFuturesPositionList(t.Context())
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestSetAutoDepositMargin(t *testing.T) {
	t.Parallel()
	_, err := e.SetAutoDepositMargin(t.Context(), "", true)
	require.ErrorIs(t, err, currency.ErrSymbolStringEmpty)
...
func TestGetMaxWithdrawMargin(t *testing.T) {
	t.Parallel()
	_, err := e.GetMaxWithdrawMargin(t.Context(), "")
	require.ErrorIs(t, err, currency.ErrSymbolStringEmpty)
...
func TestAddMargin(t *testing.T) {
	t.Parallel()
	_, err := e.AddMargin(t.Context(), "", "6200c9b83aecfb000152dasfdee", 1)
	require.ErrorIs(t, err, currency.ErrSymbolStringEmpty)
...
func TestGetFuturesRiskLimitLevel(t *testing.T) {
	t.Parallel()
	_, err := e.GetFuturesRiskLimitLevel(t.Context(), "")
	require.ErrorIs(t, err, currency.ErrSymbolStringEmpty)
...
func TestUpdateRiskLmitLevel(t *testing.T) {
	t.Parallel()
	_, err := e.FuturesUpdateRiskLmitLevel(t.Context(), "", 2)
	require.ErrorIs(t, err, currency.ErrSymbolStringEmpty)
...
func TestGetFuturesFundingHistory(t *testing.T) {
	t.Parallel()
	_, err := e.GetFuturesFundingHistory(t.Context(), "", 0, 0, true, true, time.Time{}, time.Time{})
	require.ErrorIs(t, err, currency.ErrSymbolStringEmpty)
...
func TestGetFuturesAccountOverview(t *testing.T) {
	t.Parallel()
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetFuturesAccountOverview(t.Context(), "BTC")
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetFuturesTransactionHistory(t *testing.T) {
	t.Parallel()
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetFuturesTransactionHistory(t.Context(), currency.EMPTYCODE, "", 0, 0, true, time.Time{}, time.Time{})
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestCreateFuturesSubAccountAPIKey(t *testing.T) {
	t.Parallel()
	_, err := e.CreateFuturesSubAccountAPIKey(t.Context(), "", "passphrase", "", "", "subAccName")
	require.ErrorIs(t, err, errRemarkIsRequired)
	_, err = e.CreateFuturesSubAccountAPIKey(t.Context(), "", "passphrase", "", "remark", "")
	require.ErrorIs(t, err, errInvalidSubAccountName)
	_, err = e.CreateFuturesSubAccountAPIKey(t.Context(), "", "", "", "remark", "subAccName")
	require.ErrorIs(t, err, errInvalidPassPhraseInstance)

	sharedtestvalues.SkipTestIfCredentialsUnset(t, e, canManipulateRealOrders)
	result, err := e.CreateFuturesSubAccountAPIKey(t.Context(), "", "passphrase", "", "remark", "subAccName")
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestTransferFuturesFundsToMainAccount(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e, canManipulateRealOrders)
	result, err := e.TransferFuturesFundsToMainAccount(t.Context(), 1, currency.USDT, "MAIN")
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestTransferFundsToFuturesAccount(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e, canManipulateRealOrders)
	err = e.TransferFundsToFuturesAccount(t.Context(), 1, currency.USDT, "MAIN")
	assert.NoError(t, err)
}

func TestGetFuturesTransferOutList(t *testing.T) {
	t.Parallel()
	_, err := e.GetFuturesTransferOutList(t.Context(), currency.EMPTYCODE, "", time.Time{}, time.Time{})
	require.ErrorIs(t, err, currency.ErrCurrencyCodeEmpty)

	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetFuturesTransferOutList(t.Context(), currency.USDT, "", time.Time{}, time.Time{})
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGenerateSubscriptions(t *testing.T) {
	...
	ku.Websocket.Subscriptions = defaultSubscriptions.Clone()
	subs, err := ku.Websocket.GenerateSubscriptions()
...
func TestGenerateTickerAllSub(t *testing.T) {
	...
	ku.Websocket.Subscriptions = subscription.List{{Channel: subscription.TickerChannel, Asset: asset.Spot}}
	exp := subscription.List{
...
func TestGenerateOtherSubscriptions(t *testing.T) {
	...
	for _, s := range subs {
		ku.Websocket.Subscriptions = subscription.List{s}
		got, err := ku.Websocket.GenerateSubscriptions()
...
func TestGenerateMarginSubscriptions(t *testing.T) {
	...
	ku.Websocket.Subscriptions = subscription.List{{Channel: subscription.TickerChannel, Asset: asset.Margin}}
	subs, err := ku.Websocket.GenerateSubscriptions()
	...
	ku.Websocket.Subscriptions = subscription.List{{Channel: subscription.TickerChannel, Asset: asset.All}}
	subs, err = ku.Websocket.GenerateSubscriptions()
...
func TestCheckSubscriptions(t *testing.T) {
	...
	testsubs.EqualLists(t, defaultSubscriptions, ku.Websocket.Subscriptions)
...
func TestGetWithdrawalsHistory(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetWithdrawalsHistory(t.Context(), currency.BTC, asset.Futures)
	assert.NoError(t, err)
	assert.NotNil(t, result)
...
func TestSubmitOrder(t *testing.T) {
	...
	_, err = e.SubmitOrder(t.Context(), spotOrderSubmission)
	require.ErrorIs(t, err, order.ErrUnsupportedOrderType)
...
func TestCreateSubUser(t *testing.T) {
	...
	assert.NoError(t, err)
	_, err = e.CreateSubUser(t.Context(), "", "Subaccount-1", "", "")
	require.ErrorIs(t, err, errInvalidSubAccountName)
	_, err = e.CreateSubUser(t.Context(), "Subaccount-2", "", "", "")
	require.ErrorIs(t, err, errInvalidPassPhraseInstance)

	sharedtestvalues.SkipTestIfCredentialsUnset(t, e, canManipulateRealOrders)
	result, err := e.CreateSubUser(t.Context(), "Subaccount-2", "Subaccount-1", "", "")
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetSubAccountSpotAPIList(t *testing.T) {
	t.Parallel()
	_, err := e.GetSubAccountSpotAPIList(t.Context(), "", "")
	require.ErrorIs(t, err, errInvalidSubAccountName)

	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetSubAccountSpotAPIList(t.Context(), "Sam", "")
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestCreateSpotAPIsForSubAccount(t *testing.T) {
	t.Parallel()
	_, err := e.CreateSpotAPIsForSubAccount(t.Context(), &SpotAPISubAccountParams{
		SubAccountName: "",
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e, canManipulateRealOrders)
	result, err := e.CreateSpotAPIsForSubAccount(t.Context(), &SpotAPISubAccountParams{
		SubAccountName: "gocryptoTrader1",
		Passphrase:     "mysecretPassphrase123",
		Remark:         "the-remark",
	})
...
func TestModifySubAccountSpotAPIs(t *testing.T) {
	...
	assert.NoError(t, err)
	_, err = e.ModifySubAccountSpotAPIs(t.Context(), &SpotAPISubAccountParams{
...
func TestDeleteSubAccountSpotAPI(t *testing.T) {
	t.Parallel()
	_, err := e.DeleteSubAccountSpotAPI(t.Context(), "65e7f22077172b0001f9ee41", "", "the-passphrase")
	require.ErrorIs(t, err, errInvalidSubAccountName)
	_, err = e.DeleteSubAccountSpotAPI(t.Context(), "", "gocryptoTrader1", "the-passphrase")
	require.ErrorIs(t, err, errAPIKeyRequired)
	_, err = e.DeleteSubAccountSpotAPI(t.Context(), "65e7f22077172b0001f9ee41", "gocryptoTrader1", "")
	require.ErrorIs(t, err, errInvalidPassPhraseInstance)
...
func TestGetUserInfoOfAllSubAccounts(t *testing.T) {
	t.Parallel()
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetUserInfoOfAllSubAccounts(t.Context())
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetPaginatedListOfSubAccounts(t *testing.T) {
	t.Parallel()
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetPaginatedListOfSubAccounts(t.Context(), 1, 100)
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestSubscribeBatches(t *testing.T) {
	...
	ku.Websocket.Subscriptions = subscription.List{
	...
	subs, err := ku.Websocket.GenerateSubscriptions()
	require.NoError(t, err, "generateSubscriptions must not error")
	require.Len(t, subs, len(ku.Websocket.Subscriptions), "Must generate batched subscriptions")
...
func TestSubscribeBatchLimit(t *testing.T) {
	...
	ku.Websocket.Subscriptions = subscription.List{{Asset: asset.Spot, Channel: subscription.AllTradesChannel}}
	subs, err := ku.Websocket.GenerateSubscriptions()
	require.NoError(t, err, "generateSubscriptions must not error")
...
func TestSubscribeTickerAll(t *testing.T) {
	...
	ku.Websocket.Subscriptions = subscription.List{{Asset: asset.Spot, Channel: subscription.TickerChannel}}
...
func TestIsPerpetualFutureCurrency(t *testing.T) {
	...
	assert.NoError(t, err)
	assert.False(t, is)
	is, err = e.IsPerpetualFutureCurrency(asset.Futures, currency.NewPair(currency.XBT, currency.EOS))
	assert.NoError(t, err)
	assert.False(t, is)
	is, err = e.IsPerpetualFutureCurrency(asset.Futures, currency.NewPair(currency.XBT, currency.USDTM))
	assert.NoError(t, err)
	assert.True(t, is)
	is, err = e.IsPerpetualFutureCurrency(asset.Futures, currency.NewPair(currency.XBT, currency.USDM))
	assert.NoError(t, err)
	assert.True(t, is)
}
...
func TestChangePositionMargin(t *testing.T) {
	...
	_, err = e.ChangePositionMargin(t.Context(), req)
	require.ErrorIs(t, err, futures.ErrNotFuturesAsset)
	...
	result, err := e.ChangePositionMargin(t.Context(), req)
	assert.NoError(t, err)
	assert.NotNil(t, result)
...
func TestGetFuturesPositionSummary(t *testing.T) {
	...
	_, err = e.GetFuturesPositionSummary(t.Context(), req)
	require.ErrorIs(t, err, futures.ErrNotPerpetualFuture)
...
func TestGetFuturesPositionOrders(t *testing.T) {
	...
	_, err = e.GetFuturesPositionOrders(t.Context(), req)
	require.ErrorIs(t, err, futures.ErrNotPerpetualFuture)
...
func TestSpotHFPlaceOrder(t *testing.T) {
	t.Parallel()
	_, err := e.HFSpotPlaceOrder(t.Context(), &PlaceHFParam{})
	require.ErrorIs(t, err, common.ErrNilPointer)
...
func TestSpotPlaceHFOrderTest(t *testing.T) {
	t.Parallel()
	_, err := e.SpotPlaceHFOrderTest(t.Context(), &PlaceHFParam{})
	require.ErrorIs(t, err, common.ErrNilPointer)
...
func TestSyncPlaceHFOrder(t *testing.T) {
	t.Parallel()
	_, err := e.SyncPlaceHFOrder(t.Context(), &PlaceHFParam{})
	require.ErrorIs(t, err, common.ErrNilPointer)
...
func TestModifyHFOrder(t *testing.T) {
	t.Parallel()
	_, err := e.ModifyHFOrder(t.Context(), &ModifyHFOrderParam{})
	require.ErrorIs(t, err, common.ErrNilPointer)

	_, err = e.ModifyHFOrder(t.Context(), &ModifyHFOrderParam{OrderID: "1234"})
	require.ErrorIs(t, err, currency.ErrCurrencyPairEmpty)
...
func TestCancelAllHFOrdersBySymbol(t *testing.T) {
	t.Parallel()
	_, err := e.CancelAllHFOrdersBySymbol(t.Context(), "")
	require.ErrorIs(t, err, currency.ErrSymbolStringEmpty)
...
func TestCancelAllHFOrders(t *testing.T) {
	t.Parallel()
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e, canManipulateRealOrders)
	result, err := e.CancelAllHFOrders(t.Context())
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetActiveHFOrders(t *testing.T) {
	t.Parallel()
	_, err := e.GetActiveHFOrders(t.Context(), "")
	require.ErrorIs(t, err, currency.ErrSymbolStringEmpty)
...
func TestGetSymbolsWithActiveHFOrderList(t *testing.T) {
	t.Parallel()
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	_, err := e.GetSymbolsWithActiveHFOrderList(t.Context())
	assert.NoError(t, err)
}
...
func TestAutoCancelHFOrderSetting(t *testing.T) {
	t.Parallel()
	_, err := e.AutoCancelHFOrderSetting(t.Context(), 0, []string{})
	require.ErrorIs(t, err, errTimeoutRequired)

	sharedtestvalues.SkipTestIfCredentialsUnset(t, e, canManipulateRealOrders)
	result, err := e.AutoCancelHFOrderSetting(t.Context(), 450, []string{})
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestAutoCancelHFOrderSettingQuery(t *testing.T) {
	t.Parallel()
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.AutoCancelHFOrderSettingQuery(t.Context())
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestPlaceOCOOrder(t *testing.T) {
	t.Parallel()
	_, err := e.PlaceOCOOrder(t.Context(), &OCOOrderParams{})
	require.ErrorIs(t, err, common.ErrNilPointer)
...
func TestCancelOrderByOrderID(t *testing.T) {
	t.Parallel()
	_, err := e.CancelOCOOrderByOrderID(t.Context(), "")
	require.ErrorIs(t, err, order.ErrOrderIDNotSet)

	sharedtestvalues.SkipTestIfCredentialsUnset(t, e, canManipulateRealOrders)
	result, err := e.CancelOCOOrderByOrderID(t.Context(), "6572fdd65723280007deb5e0")
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestCancelOrderByClientOrderID(t *testing.T) {
	t.Parallel()
	_, err := e.CancelOCOOrderByClientOrderID(t.Context(), "")
	require.ErrorIs(t, err, order.ErrClientOrderIDMustBeSet)

	sharedtestvalues.SkipTestIfCredentialsUnset(t, e, canManipulateRealOrders)
	result, err := e.CancelOCOOrderByClientOrderID(t.Context(), "6572fdd65723280007deb5e0")
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetOrderInfoByOrderID(t *testing.T) {
	t.Parallel()
	_, err := e.GetOCOOrderInfoByOrderID(t.Context(), "")
	require.ErrorIs(t, err, order.ErrOrderIDNotSet)

	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetOCOOrderInfoByOrderID(t.Context(), "order-id-here")
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetOrderInfoByClientOrderID(t *testing.T) {
	t.Parallel()
	_, err := e.GetOCOOrderInfoByClientOrderID(t.Context(), "")
	require.ErrorIs(t, err, order.ErrOrderIDNotSet)

	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	_, err = e.GetOCOOrderInfoByClientOrderID(t.Context(), "client-order-id-here")
	assert.NoError(t, err)
}

func TestGetOrderDetailsByOrderID(t *testing.T) {
	t.Parallel()
	_, err := e.GetOCOOrderDetailsByOrderID(t.Context(), "")
	require.ErrorIs(t, err, order.ErrOrderIDNotSet)

	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetOCOOrderDetailsByOrderID(t.Context(), "order-id-here")
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestPlaceMarginHFOrderTest(t *testing.T) {
	t.Parallel()
	_, err := e.PlaceMarginHFOrderTest(t.Context(), &PlaceMarginHFOrderParam{})
	require.ErrorIs(t, err, common.ErrNilPointer)
...
func TestGetLendingCurrencyInformation(t *testing.T) {
	t.Parallel()
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetLendingCurrencyInformation(t.Context(), currency.ETH)
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetInterestRate(t *testing.T) {
	t.Parallel()
	_, err := e.GetInterestRate(t.Context(), currency.EMPTYCODE)
	require.ErrorIs(t, err, currency.ErrCurrencyCodeEmpty)

	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetInterestRate(t.Context(), currency.ETH)
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestMarginLendingSubscription(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.MarginLendingSubscription(t.Context(), currency.ETH, 1, 0.22)
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestRedemption(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e, canManipulateRealOrders)
	result, err := e.Redemption(t.Context(), currency.ETH, 1, "1245")
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestModifySubscriptionOrder(t *testing.T) {
	t.Parallel()
	_, err := e.ModifySubscriptionOrder(t.Context(), currency.EMPTYCODE, "12345", 1.23)
	require.ErrorIs(t, err, currency.ErrCurrencyCodeEmpty)
	_, err = e.ModifySubscriptionOrder(t.Context(), currency.ETH, "12345", 0)
	require.ErrorIs(t, err, errMissingInterestRate)
	_, err = e.ModifySubscriptionOrder(t.Context(), currency.ETH, "", 1.23)
	require.ErrorIs(t, err, errMissingPurchaseOrderNumber)

	sharedtestvalues.SkipTestIfCredentialsUnset(t, e, canManipulateRealOrders)
	result, err := e.ModifySubscriptionOrder(t.Context(), currency.ETH, "12345", 1.23)
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetRedemptionOrders(t *testing.T) {
	t.Parallel()
	_, err := e.GetRedemptionOrders(t.Context(), currency.EMPTYCODE, "DONE", "2234", 0, 20)
	require.ErrorIs(t, err, currency.ErrCurrencyCodeEmpty)
	_, err = e.GetRedemptionOrders(t.Context(), currency.ETH, "", "", 0, 20)
	require.ErrorIs(t, err, errStatusMissing)

	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetRedemptionOrders(t.Context(), currency.BTC, "2234", "PENDING", 0, 20)
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetSubscriptionOrders(t *testing.T) {
	t.Parallel()
	_, err := e.GetSubscriptionOrders(t.Context(), currency.EMPTYCODE, "2234", "DONE", 0, 20)
	require.ErrorIs(t, err, currency.ErrCurrencyCodeEmpty)
	_, err = e.GetSubscriptionOrders(t.Context(), currency.ETH, "", "", 0, 20)
	require.ErrorIs(t, err, errStatusMissing)

	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetSubscriptionOrders(t.Context(), currency.BTC, "2234", "DONE", 0, 20)
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetFuturesTradingPairsActualFees(t *testing.T) {
	t.Parallel()
	_, err := e.GetFuturesTradingPairsActualFees(t.Context(), "")
	require.ErrorIs(t, err, currency.ErrSymbolStringEmpty)
...
func TestGetLatestTickersForAllContracts(t *testing.T) {
	t.Parallel()
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetLatestTickersForAllContracts(t.Context())
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestSubscribeToEarnFixedIncomeProduct(t *testing.T) {
	...
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e, canManipulateRealOrders)
	result, err := e.SubscribeToEarnFixedIncomeProduct(t.Context(), "1232412", "MAIN", 12.2)
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetEarnRedeemPreviewByHoldingID(t *testing.T) {
	t.Parallel()
	_, err := e.GetEarnRedeemPreviewByHoldingID(t.Context(), "", "MAIN")
	require.ErrorIs(t, err, order.ErrOrderIDNotSet)

	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetEarnRedeemPreviewByHoldingID(t.Context(), "12345", "MAIN")
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetEarnSavingsProducts(t *testing.T) {
	t.Parallel()
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetEarnSavingsProducts(t.Context(), currency.EMPTYCODE)
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetEarnFixedIncomeCurrentHoldings(t *testing.T) {
	t.Parallel()
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetEarnFixedIncomeCurrentHoldings(t.Context(), "12312", "", currency.EMPTYCODE, 0, 10)
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetLimitedTimePromotionProducts(t *testing.T) {
	t.Parallel()
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetLimitedTimePromotionProducts(t.Context(), currency.BTC)
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetEarnKCSStakingProducts(t *testing.T) {
	t.Parallel()
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetEarnKCSStakingProducts(t.Context(), currency.EMPTYCODE)
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetEarnStakingProducts(t *testing.T) {
	t.Parallel()
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetEarnStakingProducts(t.Context(), currency.EMPTYCODE)
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetEarnETHStakingProducts(t *testing.T) {
	t.Parallel()
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetEarnETHStakingProducts(t.Context())
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetInformationOnOffExchangeFundingAndLoans(t *testing.T) {
	t.Parallel()
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetInformationOnOffExchangeFundingAndLoans(t.Context())
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetInformationOnAccountInvolvedInOffExchangeLoans(t *testing.T) {
	t.Parallel()
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetInformationOnAccountInvolvedInOffExchangeLoans(t.Context())
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestGetMarginPairsConfigurations(t *testing.T) {
	t.Parallel()
	_, err := e.GetMarginPairsConfigurations(t.Context(), "")
	require.ErrorIs(t, err, currency.ErrSymbolStringEmpty)
...
func TestGetActiveHFOrderSymbols(t *testing.T) {
	t.Parallel()
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	result, err := e.GetActiveHFOrderSymbols(t.Context(), "MARGIN_TRADE")
	assert.NoError(t, err)
	assert.NotNil(t, result)
}
...
func TestOrderSideString(t *testing.T) {
	...
	for a := range sideErrInput {
		sideString, err = e.OrderSideString(sideErrInput[a].Side)
...
func TestStringToOrderStatus(t *testing.T) {
	...
	for a := range orderStatusResults {
		result, err := e.StringToOrderStatus(orderStatusResults[a].Input)
...
func TestGetHistoricTrades(t *testing.T) {
	_, err := e.GetHistoricTrades(t.Context(), currency.EMPTYPAIR, asset.Spot, time.Time{}, time.Time{})
	assert.ErrorIs(t, common.ErrFunctionNotSupported, err)
}
