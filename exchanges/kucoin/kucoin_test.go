...
var websocketPushDatas = map[string]string{
	...
	"Public Futures TickerPushDataJSON":                          `{"subject": "tickerV2","topic": "/contractMarket/tickerV2:XBTUSDTM","data": {"symbol": "XBTUSDTM","bestBidSize": 795,"bestBidPrice": 3200.00,"bestAskPrice": 3600.00,"bestAskSize": 284,"ts": 1553846081210004941}}`,
	"Public Futures TickerV1PushDataJSON":                        `{"subject": "ticker","topic": "/contractMarket/ticker:XBTUSDTM","data": {"symbol": "XBTUSDTM","sequence": 45,"side": "sell","price": 3600.00,"size": 16,"tradeId": "5c9dcf4170744d6f5a3d32fb","bestBidSize": 795,"bestBidPrice": 3200.00,"bestAskPrice": 3600.00,"bestAskSize": 284,"ts": 1553846081210004941}}`,
	"Public Futures Level2OrderbookPushDataJSON":                 `{"subject": "level2",  "topic": "/contractMarket/level2:XBTUSDM",  "type": "message",  "data": {    "sequence": 18,    "change": "5000.0,sell,83","timestamp": 1551770400000}}`,
	"Public Futures ExecutionDataJSON":                           `{"type": "message","topic": "/contractMarket/execution:XBTUSDTM","subject": "match","data": {"makerUserId": "6287c3015c27f000017d0c2f","symbol": "XBTUSDTM","sequence": 31443494,"side": "buy","size": 35,"price": 23083.00000000,"takerOrderId": "63f94040839d00000193264b","makerOrderId": "63f94036839d0000019310c3","takerUserId": "6133f817230d8d000607b941","tradeId": "63f940400000650065f4996f","ts": 1677279296134648869}}`,
	...
	"Private PositionSettlementPushDataJSON":                     `{"userId": "xbc453tg732eba53a88ggyt8c","topic": "/contract/position:XBTUSDM","subject": "position.settlement","data": {"fundingTime": 1551770400000,"qty": 100,"markPrice": 3610.85,"fundingRate": -0.002966,"fundingFee": -296,"ts": 1547697294838004923,"settleCurrency": "XBT"}}`,
	...
	"Futures StopOrderPushDataJSON":                              `{"userId": "5cd3f1a7b7ebc19ae9558591","topic": "/contractMarket/advancedOrders", "subject": "stopOrder","data": {"orderId": "5cdfc138b21023a909e5ad55","symbol": "XBTUSDM","type": "open","orderType":"stop","side":"buy","size":"1000","orderPrice":"9000","stop":"up","stopPrice":"9100","stopPriceType":"TP","triggerSuccess": true,"error": "error.createOrder.accountBalanceInsufficient","createdAt": 1558074652423,"ts":1558074652423004000}}`,
	...
	"Futures EndFundingFeeSettlementPushDataJSON":                `{ "type":"message","topic": "/contract/announcement","subject": "funding.end","data": {"symbol": "XBTUSDM",         "fundingTime": 1551770400000,"fundingRate": -0.002966,    "timestamp": 1551770410000          }}`,
	"Futures StartFundingFeeSettlementPushDataJSON":              `{ "topic": "/contract/announcement","subject": "funding.begin","data": {"symbol": "XBTUSDM","fundingTime": 1551770400000,"fundingRate": -0.002966,"timestamp": 1551770400000}}`,
	"Futures FundingRatePushDataJSON":                            `{ "topic": "/contract/instrument:XBTUSDM","subject": "funding.rate","data": {"granularity": 60000,"fundingRate": -0.002966,"timestamp": 1551770400000}}`,
	"Futures MarkIndexPricePushDataJSON":                         `{ "topic": "/contract/instrument:XBTUSDM","subject": "mark.index.price","data": {"granularity": 1000,"indexPrice": 4000.23,"markPrice": 4010.52,"timestamp": 1551770400000}}`,
...
func TestProcessOrderbook(t *testing.T) {
	...
	err = ku.processOrderbookWithDepth([]byte(orderbookLevel5PushData), "BTC-USDT")
	if err != nil {
		t.Error(err)
	}
