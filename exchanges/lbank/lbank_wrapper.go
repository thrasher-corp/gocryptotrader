...
// submitted
func (l *Lbank) WithdrawCryptocurrencyFunds(withdrawRequest *withdraw.Request) (string, error) {
...
// submitted
func (l *Lbank) WithdrawFiatFunds(withdrawRequest *withdraw.Request) (string, error) {
	return "", common.ErrFunctionNotSupported
}
