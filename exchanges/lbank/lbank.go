...
func (l *Lbank) GetTicker(symbol string) (TickerResponse, error) {
	...
	return t, l.SendHTTPRequest(exchange.DefaultSpot, path, &t)
}
...
func (l *Lbank) GetMarketDepths(symbol, size, merge string) (MarketDepthResponse, error) {
	...
	return m, l.SendHTTPRequest(exchange.DefaultSpot, path, &m)
}
...
func (l *Lbank) GetTrades(symbol string, limit, time int64) ([]TradeResponse, error) {
	...
	return g, l.SendHTTPRequest(exchange.DefaultSpot, path, &g)
}
...
func (l *Lbank) GetKlines(symbol, size, klineType, time string) ([]KlineResponse, error) {
	...
	err := l.SendHTTPRequest(exchange.DefaultSpot, path, &klineTemp)
	if err != nil {
		return k, err
	}
...
func (l *Lbank) GetPairInfo() ([]PairInfoResponse, error) {
	...
	return resp, l.SendHTTPRequest(exchange.DefaultSpot, path, &resp)
}
...
func (l *Lbank) SendHTTPRequest(ep, path string, result interface{}) error {
