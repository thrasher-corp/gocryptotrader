...
type AccountWithdrawRequest struct {
	...
	Currency    string  `json:"currency"`    // [required] token
	Destination int64   `json:"destination"` // [required] withdrawal address(2:OKCoin International 3:Okx 4:others)
	Fee         float64 `json:"fee"`         // [required] Network transaction fee≥0. Withdrawals to OKCoin or Okx are fee-free, please set as 0. Withdrawal to external digital asset address requires network transaction fee.
