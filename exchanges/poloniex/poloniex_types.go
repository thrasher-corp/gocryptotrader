...
var WithdrawalFees = map[asset.Item]map[currency.Code]fee.Transfer{
	asset.Spot: {
		currency.ZRX:   {Withdrawal: 5},
		currency.ARDR:  {Withdrawal: 2},
		currency.REP:   {Withdrawal: 0.1},
		currency.BTC:   {Withdrawal: 0.0005},
		currency.BCH:   {Withdrawal: 0.0001},
		currency.XBC:   {Withdrawal: 0.0001},
		currency.BTCD:  {Withdrawal: 0.01},
		currency.BTM:   {Withdrawal: 0.01},
		currency.BTS:   {Withdrawal: 5},
		currency.BURST: {Withdrawal: 1},
		currency.BCN:   {Withdrawal: 1},
		currency.CVC:   {Withdrawal: 1},
		currency.CLAM:  {Withdrawal: 0.001},
		currency.XCP:   {Withdrawal: 1},
		currency.DASH:  {Withdrawal: 0.01},
		currency.DCR:   {Withdrawal: 0.1},
		currency.DGB:   {Withdrawal: 0.1},
		currency.DOGE:  {Withdrawal: 5},
		currency.EMC2:  {Withdrawal: 0.01},
		currency.EOS:   {Withdrawal: 0},
		currency.ETH:   {Withdrawal: 0.01},
		currency.ETC:   {Withdrawal: 0.01},
		currency.EXP:   {Withdrawal: 0.01},
		currency.FCT:   {Withdrawal: 0.01},
		currency.GAME:  {Withdrawal: 0.01},
		currency.GAS:   {Withdrawal: 0},
		currency.GNO:   {Withdrawal: 0.015},
		currency.GNT:   {Withdrawal: 1},
		currency.GRC:   {Withdrawal: 0.01},
		currency.HUC:   {Withdrawal: 0.01},
		currency.LBC:   {Withdrawal: 0.05},
		currency.LSK:   {Withdrawal: 0.1},
		currency.LTC:   {Withdrawal: 0.001},
		currency.MAID:  {Withdrawal: 10},
		currency.XMR:   {Withdrawal: 0.015},
		currency.NMC:   {Withdrawal: 0.01},
		currency.NAV:   {Withdrawal: 0.01},
		currency.XEM:   {Withdrawal: 15},
		currency.NEOS:  {Withdrawal: 0.0001},
		currency.NXT:   {Withdrawal: 1},
		currency.OMG:   {Withdrawal: 0.3},
		currency.OMNI:  {Withdrawal: 0.1},
		currency.PASC:  {Withdrawal: 0.01},
		currency.PPC:   {Withdrawal: 0.01},
		currency.POT:   {Withdrawal: 0.01},
		currency.XPM:   {Withdrawal: 0.01},
		currency.XRP:   {Withdrawal: 0.15},
		currency.SC:    {Withdrawal: 10},
		currency.STEEM: {Withdrawal: 0.01},
		currency.SBD:   {Withdrawal: 0.01},
		currency.XLM:   {Withdrawal: 0.00001},
		currency.STORJ: {Withdrawal: 1},
		currency.STRAT: {Withdrawal: 0.01},
		currency.AMP:   {Withdrawal: 5},
		currency.SYS:   {Withdrawal: 0.01},
		currency.USDT:  {Withdrawal: 10},
		currency.VRC:   {Withdrawal: 0.01},
		currency.VTC:   {Withdrawal: 0.001},
