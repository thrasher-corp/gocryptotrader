...
var WithdrawalFees = map[asset.Item]map[currency.Code]fee.Transfer{
	asset.Spot: {
		currency.ZRX:   {Withdrawal: fee.Convert(5)},
		currency.ARDR:  {Withdrawal: fee.Convert(2)},
		...
		currency.XBC:   {Withdrawal: fee.Convert(0.0001)},
		currency.BTCD:  {Withdrawal: fee.Convert(0.01)},
		currency.BTM:   {Withdrawal: fee.Convert(0.01)},
		currency.BTS:   {Withdrawal: fee.Convert(5)},
		currency.BURST: {Withdrawal: fee.Convert(1)},
		currency.BCN:   {Withdrawal: fee.Convert(1)},
		currency.CVC:   {Withdrawal: fee.Convert(1)},
		currency.CLAM:  {Withdrawal: fee.Convert(0.001)},
		currency.XCP:   {Withdrawal: fee.Convert(1)},
		currency.DASH:  {Withdrawal: fee.Convert(0.01)},
		currency.DCR:   {Withdrawal: fee.Convert(0.1)},
		currency.DGB:   {Withdrawal: fee.Convert(0.1)},
		currency.DOGE:  {Withdrawal: fee.Convert(5)},
		currency.EMC2:  {Withdrawal: fee.Convert(0.01)},
		currency.EOS:   {Withdrawal: fee.Convert(0)},
		currency.ETH:   {Withdrawal: fee.Convert(0.01)},
		currency.ETC:   {Withdrawal: fee.Convert(0.01)},
		currency.EXP:   {Withdrawal: fee.Convert(0.01)},
		currency.FCT:   {Withdrawal: fee.Convert(0.01)},
		currency.GAME:  {Withdrawal: fee.Convert(0.01)},
		currency.GAS:   {Withdrawal: fee.Convert(0)},
		currency.GNO:   {Withdrawal: fee.Convert(0.015)},
		currency.GNT:   {Withdrawal: fee.Convert(1)},
		currency.GRC:   {Withdrawal: fee.Convert(0.01)},
		currency.HUC:   {Withdrawal: fee.Convert(0.01)},
		currency.LBC:   {Withdrawal: fee.Convert(0.05)},
		currency.LSK:   {Withdrawal: fee.Convert(0.1)},
		currency.LTC:   {Withdrawal: fee.Convert(0.001)},
		currency.MAID:  {Withdrawal: fee.Convert(10)},
		currency.XMR:   {Withdrawal: fee.Convert(0.015)},
		currency.NMC:   {Withdrawal: fee.Convert(0.01)},
		currency.NAV:   {Withdrawal: fee.Convert(0.01)},
		currency.XEM:   {Withdrawal: fee.Convert(15)},
		currency.NEOS:  {Withdrawal: fee.Convert(0.0001)},
		currency.NXT:   {Withdrawal: fee.Convert(1)},
		currency.OMG:   {Withdrawal: fee.Convert(0.3)},
		currency.OMNI:  {Withdrawal: fee.Convert(0.1)},
		currency.PASC:  {Withdrawal: fee.Convert(0.01)},
		currency.PPC:   {Withdrawal: fee.Convert(0.01)},
		currency.POT:   {Withdrawal: fee.Convert(0.01)},
		currency.XPM:   {Withdrawal: fee.Convert(0.01)},
		currency.XRP:   {Withdrawal: fee.Convert(0.15)},
		currency.SC:    {Withdrawal: fee.Convert(10)},
		currency.STEEM: {Withdrawal: fee.Convert(0.01)},
		currency.SBD:   {Withdrawal: fee.Convert(0.01)},
		currency.XLM:   {Withdrawal: fee.Convert(0.00001)},
		currency.STORJ: {Withdrawal: fee.Convert(1)},
		currency.STRAT: {Withdrawal: fee.Convert(0.01)},
		currency.AMP:   {Withdrawal: fee.Convert(5)},
		currency.SYS:   {Withdrawal: fee.Convert(0.01)},
		currency.USDT:  {Withdrawal: fee.Convert(10)},
		currency.VRC:   {Withdrawal: fee.Convert(0.01)},
		currency.VTC:   {Withdrawal: fee.Convert(0.001)},
		currency.VIA:   {Withdrawal: fee.Convert(0.01)},
