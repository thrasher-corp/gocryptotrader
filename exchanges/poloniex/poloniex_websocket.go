...
func (p *Exchange) manageSubs(ctx context.Context, subs subscription.List, op wsOp) error {
...
func (p *Exchange) wsSendAuthorisedCommand(ctx context.Context, secret, key string, op wsOp) error {
