...
func (p *Poloniex) GetTicker() (map[string]Ticker, error) {
	...
	return resp.Data, p.SendHTTPRequest(defaultRest, path, &resp.Data)
}
...
func (p *Poloniex) GetVolume() (interface{}, error) {
	...
	return resp, p.SendHTTPRequest(defaultRest, path, &resp)
}
...
func (p *Poloniex) GetOrderbook(currencyPair string, depth int) (OrderbookAll, error) {
	...
	if currencyPair != "" {
		...
		err := p.SendHTTPRequest(defaultRest, path, &resp)
		if err != nil {
			return oba, err
		}
		if resp.Error != "" {
		...
		path := fmt.Sprintf("/public?command=returnOrderBook&%s", vals.Encode())
		err := p.SendHTTPRequest(defaultRest, path, &resp.Data)
		if err != nil {
			return oba, err
		}
...
func (p *Poloniex) GetChartData(currencyPair string, start, end time.Time, period string) ([]ChartData, error) {
	...
	err := p.SendHTTPRequest(defaultRest, path, &temp)
	if err != nil {
		return nil, err
	}
...
func (p *Poloniex) GetBalances() (Balance, error) {
	...
	err := p.SendAuthenticatedHTTPRequest(defaultRest, http.MethodPost, poloniexBalances, url.Values{}, &result)
	if err != nil {
		return Balance{}, err
	}
...
func (p *Poloniex) GetCompleteBalances() (CompleteBalances, error) {
	...
	err := p.SendAuthenticatedHTTPRequest(defaultRest, http.MethodPost, poloniexBalancesComplete, url.Values{}, &result)
	if err != nil {
...
func (p *Poloniex) GetDepositAddresses() (DepositAddresses, error) {
	...
	err := p.SendAuthenticatedHTTPRequest(defaultRest, http.MethodPost, poloniexDepositAddresses, url.Values{}, &result)
	if err != nil {
...
func (p *Poloniex) GenerateNewAddress(currency string) (string, error) {
	...
	err := p.SendAuthenticatedHTTPRequest(defaultRest, http.MethodPost, poloniexGenerateNewAddress, values, &resp)
	if err != nil {
		return "", err
	}
...
func (p *Poloniex) GetDepositsWithdrawals(start, end string) (DepositsWithdrawals, error) {
	...
	return resp, p.SendAuthenticatedHTTPRequest(defaultRest, http.MethodPost, poloniexDepositsWithdrawals, values, &resp)
}
...
func (p *Poloniex) GetOpenOrders(currency string) (OpenOrdersResponse, error) {
	...
	return result, p.SendAuthenticatedHTTPRequest(defaultRest, http.MethodPost, poloniexOrders, values, &result.Data)
}
...
func (p *Poloniex) GetAuthenticatedTradeHistoryForCurrency(currency string, start, end, limit int64) (AuthenticatedTradeHistoryResponse, error) {
	...
	return result, p.SendAuthenticatedHTTPRequest(defaultRest, http.MethodPost, poloniexTradeHistory, values, &result.Data)
}
...
func (p *Poloniex) GetAuthenticatedTradeHistory(start, end, limit int64) (AuthenticatedTradeHistoryAll, error) {
	...
	err := p.SendAuthenticatedHTTPRequest(defaultRest, http.MethodPost, poloniexTradeHistory, values, &result)
	if err != nil {
...
func (p *Poloniex) PlaceOrder(currency string, rate, amount float64, immediate, fillOrKill, buy bool) (OrderResponse, error) {
	...
	return result, p.SendAuthenticatedHTTPRequest(defaultRest, http.MethodPost, orderType, values, &result)
}
...
func (p *Poloniex) CancelExistingOrder(orderID int64) error {
	...
	err := p.SendAuthenticatedHTTPRequest(defaultRest, http.MethodPost, poloniexOrderCancel, values, &result)
	if err != nil {
		return err
	}
...
func (p *Poloniex) MoveOrder(orderID int64, rate, amount float64, postOnly, immediateOrCancel bool) (MoveOrderResponse, error) {
	...
	err := p.SendAuthenticatedHTTPRequest(defaultRest, http.MethodPost,
		poloniexOrderMove,
		values,
		&result)
	if err != nil {
...
func (p *Poloniex) Withdraw(currency, address string, amount float64) (*Withdraw, error) {
	...
	err := p.SendAuthenticatedHTTPRequest(defaultRest, http.MethodPost, poloniexWithdraw, values, &result)
	if err != nil {
		return nil, err
	}
...
func (p *Poloniex) GetFeeInfo() (Fee, error) {
	...
	return result, p.SendAuthenticatedHTTPRequest(defaultRest, http.MethodPost, poloniexFeeInfo, url.Values{}, &result)
}
...
func (p *Poloniex) GetTradableBalances() (map[string]map[string]float64, error) {
	...
	err := p.SendAuthenticatedHTTPRequest(defaultRest, http.MethodPost, poloniexTradableBalances, url.Values{}, &result.Data)
	if err != nil {
		return nil, err
	}
...
func (p *Poloniex) TransferBalance(currency, from, to string, amount float64) (bool, error) {
	...
	err := p.SendAuthenticatedHTTPRequest(defaultRest, http.MethodPost, poloniexTransferBalance, values, &result)
	if err != nil {
		return false, err
	}
...
func (p *Poloniex) GetMarginAccountSummary() (Margin, error) {
	result := Margin{}
	return result, p.SendAuthenticatedHTTPRequest(defaultRest, http.MethodPost, poloniexMarginAccountSummary, url.Values{}, &result)
}
...
func (p *Poloniex) GetMarginPosition(currency string) (interface{}, error) {
	...
	if currency != "" && currency != "all" {
		...
		return result, p.SendAuthenticatedHTTPRequest(defaultRest, http.MethodPost, poloniexMarginPosition, values, &result)
	}
	values.Set("currencyPair", "all")
	...
	result := Response{}
	return result, p.SendAuthenticatedHTTPRequest(defaultRest, http.MethodPost, poloniexMarginPosition, values, &result.Data)
}
...
func (p *Poloniex) CloseMarginPosition(currency string) (bool, error) {
	...
	err := p.SendAuthenticatedHTTPRequest(defaultRest, http.MethodPost, poloniexMarginPositionClose, values, &result)
	if err != nil {
		return false, err
	}
...
func (p *Poloniex) CreateLoanOffer(currency string, amount, rate float64, duration int, autoRenew bool) (int64, error) {
	...
	err := p.SendAuthenticatedHTTPRequest(defaultRest, http.MethodPost, poloniexCreateLoanOffer, values, &result)
	if err != nil {
		return 0, err
	}
...
func (p *Poloniex) CancelLoanOffer(orderNumber int64) (bool, error) {
	...
	err := p.SendAuthenticatedHTTPRequest(defaultRest, http.MethodPost, poloniexCancelLoanOffer, values, &result)
	if err != nil {
		return false, err
	}
...
func (p *Poloniex) GetOpenLoanOffers() (map[string][]LoanOffer, error) {
	...
	err := p.SendAuthenticatedHTTPRequest(defaultRest, http.MethodPost, poloniexOpenLoanOffers, url.Values{}, &result.Data)
	if err != nil {
		return nil, err
	}
...
func (p *Poloniex) GetActiveLoans() (ActiveLoans, error) {
	result := ActiveLoans{}
	return result, p.SendAuthenticatedHTTPRequest(defaultRest, http.MethodPost, poloniexActiveLoans, url.Values{}, &result)
}
...
func (p *Poloniex) GetLendingHistory(start, end string) ([]LendingHistory, error) {
	...
	return resp, p.SendAuthenticatedHTTPRequest(defaultRest, http.MethodPost,
