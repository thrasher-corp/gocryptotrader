...
// analysis system
func (b *Exchange) GetLatestBlockCA(ctx context.Context) (ChainAnalysisBlock, error) {
...
// analysis system
func (b *Exchange) GetBlockCA(ctx context.Context, blockhash string) (ChainAnalysisBlock, error) {
	var resp ChainAnalysisBlock
...
// analysis system
func (b *Exchange) GetBlockbyHeightCA(ctx context.Context, height int64) (ChainAnalysisBlock, error) {
	var resp ChainAnalysisBlock
...
func (b *Exchange) GetTransactionByHashCA(ctx context.Context, txHash string) (ChainAnalysisTransaction, error) {
...
func (b *Exchange) GetAddressInfoCA(ctx context.Context, addressln string) (ChainAnalysisAddress, error) {
...
func (b *Exchange) GetMarkets(ctx context.Context) ([]MarketInfo, error) {
	var resp []MarketInfo
...
func (b *Exchange) GetExecutionHistory(ctx context.Context, symbol string) ([]ExecutedTrade, error) {
...
func (b *Exchange) GetExchangeStatus(ctx context.Context) (string, error) {
...
func (b *Exchange) GetChats(ctx context.Context, fromDate string) ([]ChatLog, error) {
	var resp []ChatLog
	v := url.Values{}
...
func (b *Exchange) SendAuthHTTPRequest() {
