...
func GetCollatedExchangeAccountInfoByCoin(exchAccounts []account.Holdings) map[currency.Code]account.Balance {
...
func SeedExchangeAccountInfo(data []account.Holdings) {
	if len(data) == 0 {
		return
	}
