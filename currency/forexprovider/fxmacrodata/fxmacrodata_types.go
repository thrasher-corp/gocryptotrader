...
type RateDifferentialPoint struct {
	...
	BaseEndAnnouncementDatetime    types.Time `json:"base_end_announcement_datetime"`
	QuoteStartAnnouncementDatetime types.Time `json:"quote_start_announcement_datetime"`
	QuoteEndAnnouncementDatetime   types.Time `json:"quote_end_announcement_datetime"`
}
...
type MarketSessionsResponse struct {
	...
	NowUnix     types.Time             `json:"now_unix"`
