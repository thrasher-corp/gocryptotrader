...
type ModifyOrderRequest struct {
	...
	ModifyRequestId int64   `protobuf:"varint,1,opt,name=modify_request_id,json=modifyRequestId,proto3" json:"modify_request_id,omitempty"`
	Exchange        string  `protobuf:"bytes,2,opt,name=exchange,proto3" json:"exchange,omitempty"`
...
func (x *ModifyOrderRequest) GetModifyRequestId() int64 {
	if x != nil {
		return x.ModifyRequestId
	}
	return 0
}
...
type ModifyOrderResponse struct {
	...
	ModifyRequestId int64 `protobuf:"varint,1,opt,name=modify_request_id,json=modifyRequestId,proto3" json:"modify_request_id,omitempty"`
	OrderModified   bool  `protobuf:"varint,2,opt,name=order_modified,json=orderModified,proto3" json:"order_modified,omitempty"`
}
...
func (x *ModifyOrderResponse) GetModifyRequestId() int64 {
	if x != nil {
		return x.ModifyRequestId
	}
	return 0
...
func (x *ModifyOrderResponse) GetOrderModified() bool {
	if x != nil {
		return x.OrderModified
	}
	return false
}
...
var file_rpc_proto_rawDesc = []byte{
	...
	,
	...
	0x6e, 0x74, 0x22, 0x68, 0x0a, 0x13, 0x4d, 0x6f, 0x64, 0x69, 0x66, 0x79, 0x4f, 0x72, 0x64, 0x65,
	0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x2a, 0x0a, 0x11, 0x6d, 0x6f, 0x64,
	0x69, 0x66, 0x79, 0x5f, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x03, 0x52, 0x0f, 0x6d, 0x6f, 0x64, 0x69, 0x66, 0x79, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x49, 0x64, 0x12, 0x25, 0x0a, 0x0e, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x5f, 0x6d,
	0x6f, 0x64, 0x69, 0x66, 0x69, 0x65, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0d, 0x6f,
	0x72, 0x64, 0x65, 0x72, 0x4d, 0x6f, 0x64, 0x69, 0x66, 0x69, 0x65, 0x64, 0x32, 0x8c, 0x51, 0x0a,
	...
	0x6d, 0x6f, 0x64, 0x69, 0x66, 0x79, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x42, 0x30, 0x5a, 0x2e, 0x67,
...
var file_rpc_proto_depIdxs = []int32{
	...
	169, // 90: gctrpc.CancelBatchOrdersResponse.Orders.order_status:type_name -> gctrpc.CancelBatchOrdersResponse.Orders.OrderStatusEntry
	171, // 91: gctrpc.CancelAllOrdersResponse.Orders.order_status:type_name -> gctrpc.CancelAllOrdersResponse.Orders.OrderStatusEntry
	...
	156, // 180: gctrpc.GoCryptoTrader.ModifyOrder:input_type -> gctrpc.ModifyOrderRequest
	1,   // 181: gctrpc.GoCryptoTrader.GetInfo:output_type -> gctrpc.GetInfoResponse
	7,   // 182: gctrpc.GoCryptoTrader.GetSubsystems:output_type -> gctrpc.GetSusbsytemsResponse
	127, // 183: gctrpc.GoCryptoTrader.EnableSubsystem:output_type -> gctrpc.GenericResponse
	127, // 184: gctrpc.GoCryptoTrader.DisableSubsystem:output_type -> gctrpc.GenericResponse
	10,  // 185: gctrpc.GoCryptoTrader.GetRPCEndpoints:output_type -> gctrpc.GetRPCEndpointsResponse
	4,   // 186: gctrpc.GoCryptoTrader.GetCommunicationRelayers:output_type -> gctrpc.GetCommunicationRelayersResponse
	13,  // 187: gctrpc.GoCryptoTrader.GetExchanges:output_type -> gctrpc.GetExchangesResponse
	127, // 188: gctrpc.GoCryptoTrader.DisableExchange:output_type -> gctrpc.GenericResponse
	19,  // 189: gctrpc.GoCryptoTrader.GetExchangeInfo:output_type -> gctrpc.GetExchangeInfoResponse
	14,  // 190: gctrpc.GoCryptoTrader.GetExchangeOTPCode:output_type -> gctrpc.GetExchangeOTPReponse
	16,  // 191: gctrpc.GoCryptoTrader.GetExchangeOTPCodes:output_type -> gctrpc.GetExchangeOTPsResponse
	127, // 192: gctrpc.GoCryptoTrader.EnableExchange:output_type -> gctrpc.GenericResponse
	22,  // 193: gctrpc.GoCryptoTrader.GetTicker:output_type -> gctrpc.TickerResponse
	25,  // 194: gctrpc.GoCryptoTrader.GetTickers:output_type -> gctrpc.GetTickersResponse
	28,  // 195: gctrpc.GoCryptoTrader.GetOrderbook:output_type -> gctrpc.OrderbookResponse
	31,  // 196: gctrpc.GoCryptoTrader.GetOrderbooks:output_type -> gctrpc.GetOrderbooksResponse
	35,  // 197: gctrpc.GoCryptoTrader.GetAccountInfo:output_type -> gctrpc.GetAccountInfoResponse
	35,  // 198: gctrpc.GoCryptoTrader.UpdateAccountInfo:output_type -> gctrpc.GetAccountInfoResponse
	35,  // 199: gctrpc.GoCryptoTrader.GetAccountInfoStream:output_type -> gctrpc.GetAccountInfoResponse
	37,  // 200: gctrpc.GoCryptoTrader.GetConfig:output_type -> gctrpc.GetConfigResponse
	40,  // 201: gctrpc.GoCryptoTrader.GetPortfolio:output_type -> gctrpc.GetPortfolioResponse
	47,  // 202: gctrpc.GoCryptoTrader.GetPortfolioSummary:output_type -> gctrpc.GetPortfolioSummaryResponse
	127, // 203: gctrpc.GoCryptoTrader.AddPortfolioAddress:output_type -> gctrpc.GenericResponse
	127, // 204: gctrpc.GoCryptoTrader.RemovePortfolioAddress:output_type -> gctrpc.GenericResponse
	52,  // 205: gctrpc.GoCryptoTrader.GetForexProviders:output_type -> gctrpc.GetForexProvidersResponse
	55,  // 206: gctrpc.GoCryptoTrader.GetForexRates:output_type -> gctrpc.GetForexRatesResponse
	59,  // 207: gctrpc.GoCryptoTrader.GetOrders:output_type -> gctrpc.GetOrdersResponse
	56,  // 208: gctrpc.GoCryptoTrader.GetOrder:output_type -> gctrpc.OrderDetails
	63,  // 209: gctrpc.GoCryptoTrader.SubmitOrder:output_type -> gctrpc.SubmitOrderResponse
	65,  // 210: gctrpc.GoCryptoTrader.SimulateOrder:output_type -> gctrpc.SimulateOrderResponse
	65,  // 211: gctrpc.GoCryptoTrader.WhaleBomb:output_type -> gctrpc.SimulateOrderResponse
	127, // 212: gctrpc.GoCryptoTrader.CancelOrder:output_type -> gctrpc.GenericResponse
	69,  // 213: gctrpc.GoCryptoTrader.CancelBatchOrders:output_type -> gctrpc.CancelBatchOrdersResponse
	71,  // 214: gctrpc.GoCryptoTrader.CancelAllOrders:output_type -> gctrpc.CancelAllOrdersResponse
	74,  // 215: gctrpc.GoCryptoTrader.GetEvents:output_type -> gctrpc.GetEventsResponse
	76,  // 216: gctrpc.GoCryptoTrader.AddEvent:output_type -> gctrpc.AddEventResponse
	127, // 217: gctrpc.GoCryptoTrader.RemoveEvent:output_type -> gctrpc.GenericResponse
	79,  // 218: gctrpc.GoCryptoTrader.GetCryptocurrencyDepositAddresses:output_type -> gctrpc.GetCryptocurrencyDepositAddressesResponse
	81,  // 219: gctrpc.GoCryptoTrader.GetCryptocurrencyDepositAddress:output_type -> gctrpc.GetCryptocurrencyDepositAddressResponse
	84,  // 220: gctrpc.GoCryptoTrader.WithdrawFiatFunds:output_type -> gctrpc.WithdrawResponse
	84,  // 221: gctrpc.GoCryptoTrader.WithdrawCryptocurrencyFunds:output_type -> gctrpc.WithdrawResponse
	86,  // 222: gctrpc.GoCryptoTrader.WithdrawalEventByID:output_type -> gctrpc.WithdrawalEventByIDResponse
	89,  // 223: gctrpc.GoCryptoTrader.WithdrawalEventsByExchange:output_type -> gctrpc.WithdrawalEventsByExchangeResponse
	89,  // 224: gctrpc.GoCryptoTrader.WithdrawalEventsByDate:output_type -> gctrpc.WithdrawalEventsByExchangeResponse
	96,  // 225: gctrpc.GoCryptoTrader.GetLoggerDetails:output_type -> gctrpc.GetLoggerDetailsResponse
	96,  // 226: gctrpc.GoCryptoTrader.SetLoggerDetails:output_type -> gctrpc.GetLoggerDetailsResponse
	99,  // 227: gctrpc.GoCryptoTrader.GetExchangePairs:output_type -> gctrpc.GetExchangePairsResponse
	127, // 228: gctrpc.GoCryptoTrader.SetExchangePair:output_type -> gctrpc.GenericResponse
	28,  // 229: gctrpc.GoCryptoTrader.GetOrderbookStream:output_type -> gctrpc.OrderbookResponse
	28,  // 230: gctrpc.GoCryptoTrader.GetExchangeOrderbookStream:output_type -> gctrpc.OrderbookResponse
	22,  // 231: gctrpc.GoCryptoTrader.GetTickerStream:output_type -> gctrpc.TickerResponse
	22,  // 232: gctrpc.GoCryptoTrader.GetExchangeTickerStream:output_type -> gctrpc.TickerResponse
	106, // 233: gctrpc.GoCryptoTrader.GetAuditEvent:output_type -> gctrpc.GetAuditEventResponse
	127, // 234: gctrpc.GoCryptoTrader.GCTScriptExecute:output_type -> gctrpc.GenericResponse
	127, // 235: gctrpc.GoCryptoTrader.GCTScriptUpload:output_type -> gctrpc.GenericResponse
	126, // 236: gctrpc.GoCryptoTrader.GCTScriptReadScript:output_type -> gctrpc.GCTScriptQueryResponse
	125, // 237: gctrpc.GoCryptoTrader.GCTScriptStatus:output_type -> gctrpc.GCTScriptStatusResponse
	126, // 238: gctrpc.GoCryptoTrader.GCTScriptQuery:output_type -> gctrpc.GCTScriptQueryResponse
	127, // 239: gctrpc.GoCryptoTrader.GCTScriptStop:output_type -> gctrpc.GenericResponse
	127, // 240: gctrpc.GoCryptoTrader.GCTScriptStopAll:output_type -> gctrpc.GenericResponse
	125, // 241: gctrpc.GoCryptoTrader.GCTScriptListAll:output_type -> gctrpc.GCTScriptStatusResponse
	127, // 242: gctrpc.GoCryptoTrader.GCTScriptAutoLoadToggle:output_type -> gctrpc.GenericResponse
	112, // 243: gctrpc.GoCryptoTrader.GetHistoricCandles:output_type -> gctrpc.GetHistoricCandlesResponse
	127, // 244: gctrpc.GoCryptoTrader.SetExchangeAsset:output_type -> gctrpc.GenericResponse
	127, // 245: gctrpc.GoCryptoTrader.SetAllExchangePairs:output_type -> gctrpc.GenericResponse
	127, // 246: gctrpc.GoCryptoTrader.UpdateExchangeSupportedPairs:output_type -> gctrpc.GenericResponse
	132, // 247: gctrpc.GoCryptoTrader.GetExchangeAssets:output_type -> gctrpc.GetExchangeAssetsResponse
	134, // 248: gctrpc.GoCryptoTrader.WebsocketGetInfo:output_type -> gctrpc.WebsocketGetInfoResponse
	127, // 249: gctrpc.GoCryptoTrader.WebsocketSetEnabled:output_type -> gctrpc.GenericResponse
	138, // 250: gctrpc.GoCryptoTrader.WebsocketGetSubscriptions:output_type -> gctrpc.WebsocketGetSubscriptionsResponse
	127, // 251: gctrpc.GoCryptoTrader.WebsocketSetProxy:output_type -> gctrpc.GenericResponse
	127, // 252: gctrpc.GoCryptoTrader.WebsocketSetURL:output_type -> gctrpc.GenericResponse
	109, // 253: gctrpc.GoCryptoTrader.GetRecentTrades:output_type -> gctrpc.SavedTradesResponse
	109, // 254: gctrpc.GoCryptoTrader.GetHistoricTrades:output_type -> gctrpc.SavedTradesResponse
	109, // 255: gctrpc.GoCryptoTrader.GetSavedTrades:output_type -> gctrpc.SavedTradesResponse
	112, // 256: gctrpc.GoCryptoTrader.ConvertTradesToCandles:output_type -> gctrpc.GetHistoricCandlesResponse
	143, // 257: gctrpc.GoCryptoTrader.FindMissingSavedCandleIntervals:output_type -> gctrpc.FindMissingIntervalsResponse
	143, // 258: gctrpc.GoCryptoTrader.FindMissingSavedTradeIntervals:output_type -> gctrpc.FindMissingIntervalsResponse
	127, // 259: gctrpc.GoCryptoTrader.SetExchangeTradeProcessing:output_type -> gctrpc.GenericResponse
	148, // 260: gctrpc.GoCryptoTrader.UpsertDataHistoryJob:output_type -> gctrpc.UpsertDataHistoryJobResponse
	150, // 261: gctrpc.GoCryptoTrader.GetDataHistoryJobDetails:output_type -> gctrpc.DataHistoryJob
	152, // 262: gctrpc.GoCryptoTrader.GetActiveDataHistoryJobs:output_type -> gctrpc.DataHistoryJobs
	152, // 263: gctrpc.GoCryptoTrader.GetDataHistoryJobsBetween:output_type -> gctrpc.DataHistoryJobs
	150, // 264: gctrpc.GoCryptoTrader.GetDataHistoryJobSummary:output_type -> gctrpc.DataHistoryJob
	127, // 265: gctrpc.GoCryptoTrader.SetDataHistoryJobStatus:output_type -> gctrpc.GenericResponse
	127, // 266: gctrpc.GoCryptoTrader.UpdateDataHistoryJobPrerequisite:output_type -> gctrpc.GenericResponse
	59,  // 267: gctrpc.GoCryptoTrader.GetManagedOrders:output_type -> gctrpc.GetOrdersResponse
	157, // 268: gctrpc.GoCryptoTrader.ModifyOrder:output_type -> gctrpc.ModifyOrderResponse
