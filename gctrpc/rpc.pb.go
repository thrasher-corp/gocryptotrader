...
type GetMarginRatesHistoryRequest struct {
	...
	GetBorrowRates     bool                   `protobuf:"varint,7,opt,name=get_borrow_rates,json=getBorrowRates,proto3" json:"get_borrow_rates,omitempty"`
...
const file_rpc_proto_rawDesc = "" +
	...
	"\x03key\x18\x01 \x01(\tR\x03key\x12+\n" +
	"\x05value\x18\x02 \x01(\v2\x15.gctrpc.ListOfSignalsR\x05value:\x028\x01\"\xd5\x03\n" +
	...
	"\x10get_borrow_rates\x18\a \x01(\bR\x0egetBorrowRates\x12(\n" +
