...
func (x *CancelAllOrdersRequest) GetAssetType() string {
	if x != nil {
		return x.AssetType
	}
	return ""
...
func (x *CancelAllOrdersRequest) GetPair() *CurrencyPair {
	if x != nil {
		return x.Pair
	}
	return nil
...
const file_rpc_proto_rawDesc = "" +
	...
	"\x06orders\x18\x01 \x03(\v2\x0e.gctrpc.OrdersR\x06orders\"}\n" +
	"\x16CancelAllOrdersRequest\x12\x1a\n" +
	"\bexchange\x18\x01 \x01(\tR\bexchange\x12\x1d\n" +
	"\n" +
	"asset_type\x18\x02 \x01(\tR\tassetType\x12(\n" +
	"\x04pair\x18\x03 \x01(\v2\x14.gctrpc.CurrencyPairR\x04pair\"W\n" +
...
var file_rpc_proto_depIdxs = []int32{
	...
	74,  // 45: gctrpc.GetEventsResponse.condition_params:type_name -> gctrpc.ConditionParams
	21,  // 46: gctrpc.GetEventsResponse.pair:type_name -> gctrpc.CurrencyPair
	...
	119, // 63: gctrpc.GetAuditEventResponse.events:type_name -> gctrpc.AuditEvent
	21,  // 64: gctrpc.GetSavedTradesRequest.pair:type_name -> gctrpc.CurrencyPair
	21,  // 65: gctrpc.SavedTradesResponse.pair:type_name -> gctrpc.CurrencyPair
	113, // 66: gctrpc.SavedTradesResponse.trades:type_name -> gctrpc.SavedTrades
	21,  // 67: gctrpc.ConvertTradesToCandlesRequest.pair:type_name -> gctrpc.CurrencyPair
