...
type GoCryptoTraderClient interface {
	...
	GetFunctionality(ctx context.Context, in *FunctionalityGetRequest, opts ...grpc.CallOption) (*FunctionalityGetResponse, error)
	SetFunctionality(ctx context.Context, in *FunctionalitySetRequest, opts ...grpc.CallOption) (*GenericResponse, error)
}
...
func (c *goCryptoTraderClient) GetFunctionality(ctx context.Context, in *FunctionalityGetRequest, opts ...grpc.CallOption) (*FunctionalityGetResponse, error) {
	out := new(FunctionalityGetResponse)
	err := c.cc.Invoke(ctx, "/gctrpc.GoCryptoTrader/GetFunctionality", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *goCryptoTraderClient) SetFunctionality(ctx context.Context, in *FunctionalitySetRequest, opts ...grpc.CallOption) (*GenericResponse, error) {
	out := new(GenericResponse)
	err := c.cc.Invoke(ctx, "/gctrpc.GoCryptoTrader/SetFunctionality", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GoCryptoTraderServer interface {
	...
	GetFunctionality(context.Context, *FunctionalityGetRequest) (*FunctionalityGetResponse, error)
	SetFunctionality(context.Context, *FunctionalitySetRequest) (*GenericResponse, error)
...
func (UnimplementedGoCryptoTraderServer) GetFunctionality(context.Context, *FunctionalityGetRequest) (*FunctionalityGetResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetFunctionality not implemented")
}
func (UnimplementedGoCryptoTraderServer) SetFunctionality(context.Context, *FunctionalitySetRequest) (*GenericResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SetFunctionality not implemented")
}
...
func _GoCryptoTrader_GetFunctionality_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FunctionalityGetRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GoCryptoTraderServer).GetFunctionality(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gctrpc.GoCryptoTrader/GetFunctionality",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GoCryptoTraderServer).GetFunctionality(ctx, req.(*FunctionalityGetRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _GoCryptoTrader_SetFunctionality_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FunctionalitySetRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GoCryptoTraderServer).SetFunctionality(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gctrpc.GoCryptoTrader/SetFunctionality",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GoCryptoTraderServer).SetFunctionality(ctx, req.(*FunctionalitySetRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _GoCryptoTrader_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetFunctionality",
			Handler:    _GoCryptoTrader_GetFunctionality_Handler,
		},
		{
			MethodName: "SetFunctionality",
			Handler:    _GoCryptoTrader_SetFunctionality_Handler,
		},
	},
