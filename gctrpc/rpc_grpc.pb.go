...
type GoCryptoTraderServiceClient interface {
	...
	GetAccountInfoStream(ctx context.Context, in *GetAccountInfoRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[GetAccountInfoResponse], error)
...
func (c *goCryptoTraderServiceClient) GetAccountInfo(ctx context.Context, in *GetAccountInfoRequest, opts ...grpc.CallOption) (*GetAccountInfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, GoCryptoTraderService_GetAccountInfo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *goCryptoTraderServiceClient) UpdateAccountInfo(ctx context.Context, in *GetAccountInfoRequest, opts ...grpc.CallOption) (*GetAccountInfoResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetAccountInfoResponse)
	err := c.cc.Invoke(ctx, GoCryptoTraderService_UpdateAccountInfo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *goCryptoTraderServiceClient) GetAccountInfoStream(ctx context.Context, in *GetAccountInfoRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[GetAccountInfoResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &GoCryptoTraderService_ServiceDesc.Streams[0], GoCryptoTraderService_GetAccountInfoStream_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[GetAccountInfoRequest, GetAccountInfoResponse]{ClientStream: stream}
...
type GoCryptoTraderService_GetAccountInfoStreamClient = grpc.ServerStreamingClient[GetAccountInfoResponse]
...
type GoCryptoTraderServiceServer interface {
	...
	GetAccountInfoStream(*GetAccountInfoRequest, grpc.ServerStreamingServer[GetAccountInfoResponse]) error
...
func _GoCryptoTraderService_GetAccountBalancesStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(GoCryptoTraderServiceServer).GetAccountInfoStream(m, &grpc.GenericServerStream[GetAccountInfoRequest, GetAccountInfoResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type GoCryptoTraderService_GetAccountInfoStreamServer = grpc.ServerStreamingServer[GetAccountInfoResponse]
