...
func CalculateSlippageByOrderbook(ob *orderbook.Snapshot, side gctorder.Side, allocatedFunds, feeRate decimal.Decimal) (price, amount decimal.Decimal, err error) {
