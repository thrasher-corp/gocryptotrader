...
func (s *Strategy) OnSignal(d data.Handler, _ funding.IFundTransferer, _ portfolio.IStrategyHelper) (signal.Event, error) {
	if d == nil {
...
func (s *Strategy) OnSimultaneousSignals(d []data.Handler, _ funding.IFundTransferer, _ portfolio.IStrategyHelper) ([]signal.Event, error) {
