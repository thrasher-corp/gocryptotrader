...
func (s *Strategy) OnSignal(_ data.Handler, _ funding.IFundTransferer, _ portfolio.IStrategyHelper) (signal.Event, error) {
...
func (s *Strategy) OnSimultaneousSignals(d []data.Handler, f funding.IFundTransferer, _ portfolio.IStrategyHelper) ([]signal.Event, error) {
	if len(d) < 4 {
