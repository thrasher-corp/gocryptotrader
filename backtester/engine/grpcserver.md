...
The GRPC server is responsible for handling requests from the client. All GRPC functionality as defined in the proto file is implemented in the [backtester RPC package](../../backtester/btrpc).
