...
| asset         | The asset type to set funds. Typically, this will be `spot`, however, see [this package](../../exchanges/asset/asset.go) for the various asset types GoCryptoTrader supports | `spot`    |
