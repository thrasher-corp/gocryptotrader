...
| Key           | Description                                                                                                                                                                                                                        | Example   |
|---------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------|
| exchange-name | The exchange to set funds. See the [supported exchange list](../../README.md)                                                                                                      | `Binance` |
| asset         | The asset type to set funds. Typically, this will be `spot`; see the [asset package](../../exchanges/asset/asset.go) for the various asset types GoCryptoTrader supports | `spot`    |
...
| Key                          | Description                                                                                                                                                                                                                                                            | Example                         |
|------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|
| exchange-name                | The exchange to load. See the [supported exchange list](../../README.md)                                                                                                                                           | `Binance`                       |
| asset                        | The asset type. Typically, this will be `spot`; see the [asset package](../../exchanges/asset/asset.go) for the various asset types GoCryptoTrader supports                                                          | `spot`                          |
