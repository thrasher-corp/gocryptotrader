...
func RegisterBacktesterHandlerServer(ctx context.Context, mux *runtime.ServeMux, server BacktesterServer) error {
	...
	mux.Handle("GET", pattern_Backtester_ExecuteStrategyFromFile_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/btrpc.Backtester/ExecuteStrategyFromFile", runtime.WithHTTPPathPattern("/v1/executestrategy"))
		if err != nil {
...
func RegisterBacktesterHandlerClient(ctx context.Context, mux *runtime.ServeMux, client BacktesterClient) error {
	...
	mux.Handle("GET", pattern_Backtester_ExecuteStrategyFromFile_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/btrpc.Backtester/ExecuteStrategyFromFile", runtime.WithHTTPPathPattern("/v1/executestrategy"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_Backtester_ExecuteStrategyFromFile_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "executestrategy"}, ""))
)
