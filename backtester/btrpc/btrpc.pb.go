...
func (x *DatabaseConnectionDetails) GetPort() int64 {
	if x != nil {
		return x.Port
	}
	return 0
...
var file_btrpc_proto_rawDesc = []byte{
	...
	0x61, 0x6e, 0x67, 0x65, 0x5f, 0x50, 0x4e, 0x4c, 0x5f, 0x63, 0x61, 0x6c, 0x63, 0x75, 0x6c, 0x61,
	0x74, 0x69, 0x6f, 0x6e, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x08, 0x52, 0x19, 0x75, 0x73, 0x65, 0x45,
	0x78, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x50, 0x4e, 0x4c, 0x43, 0x61, 0x6c, 0x63, 0x75, 0x6c,
	...
	0xa2, 0x02, 0x0a, 0x0a, 0x42, 0x61, 0x63, 0x6b, 0x74, 0x65, 0x73, 0x74, 0x65, 0x72, 0x12, 0x85,
	...
	0xd3, 0xe4, 0x93, 0x02, 0x1f, 0x12, 0x1d, 0x2f, 0x76, 0x31, 0x2f, 0x65, 0x78, 0x65, 0x63, 0x75,
...
var file_btrpc_proto_depIdxs = []int32{
	...
	22, // 30: btrpc.Backtester.ExecuteStrategyFromFile:input_type -> btrpc.ExecuteStrategyFromFileRequest
	24, // 31: btrpc.Backtester.ExecuteStrategyFromConfig:input_type -> btrpc.ExecuteStrategyFromConfigRequest
	23, // 32: btrpc.Backtester.ExecuteStrategyFromFile:output_type -> btrpc.ExecuteStrategyResponse
	23, // 33: btrpc.Backtester.ExecuteStrategyFromConfig:output_type -> btrpc.ExecuteStrategyResponse
