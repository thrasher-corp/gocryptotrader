...
[![GoDoc](https://godoc.org/github.com/thrasher-corp/gocryptotrader?status.svg)](https://godoc.org/github.com/thrasher-corp/gocryptotrader/database)
...
Generate a new model that gets placed in the `./database/models/<databasetype>` folder.
...
_**bc1qk0jareu4jytc0cfrhr5wgshsq8282awpavfahc**_
