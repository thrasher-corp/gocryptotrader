...
var (
	datahistoryjobrelationDBTypes = map[string]string{`ID`: `integer`, `PrerequisiteJobID`: `uuid`, `FollowingJobID`: `uuid`}
	_                             = bytes.MinRead
)
...
func testDatahistoryjobrelationsUpsert(t *testing.T) {
	t.Parallel()
	...
	if err = o.Upsert(ctx, tx, false, nil, boil.Infer(), boil.Infer()); err != nil {
		t.Errorf("Unable to upsert Datahistoryjobrelation: %s", err)
	}
	...
	if err = randomize.Struct(seed, &o, datahistoryjobrelationDBTypes, false, datahistoryjobrelationPrimaryKeyColumns...); err != nil {
		t.Errorf("Unable to randomize Datahistoryjobrelation struct: %s", err)
	}
