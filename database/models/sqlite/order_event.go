...
var OrderEventWhere = struct {
	...
	UpdatedAt:       whereHelperstring{field: "\"order_event\".\"updated_at\""},
	CreatedAt:       whereHelperstring{field: "\"order_event\".\"created_at\""},
}
...
var (
	...
	orderEventColumnsWithoutDefault = []string{"id", "exchange_order_id", "client_id", "exchange", "currency_pair", "asset_type", "order_type", "order_side", "order_status", "amount", "price", "updated_at"}
	orderEventColumnsWithDefault    = []string{"created_at"}
...
func (q orderEventQuery) One(ctx context.Context, exec boil.ContextExecutor) (*OrderEvent, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "sqlite: failed to execute a one query for order_event")
	}
...
func (q orderEventQuery) All(ctx context.Context, exec boil.ContextExecutor) (OrderEventSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "sqlite: failed to assign all query results to OrderEvent slice")
	}
...
func (q orderEventQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "sqlite: failed to count order_event rows")
	}
...
func (q orderEventQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "sqlite: failed to check if order_event exists")
	}
...
func FindOrderEvent(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*OrderEvent, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"order_event\" where \"id\"=?", sel,
	)
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "sqlite: unable to select from order_event")
	}
...
func (o *OrderEvent) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("sqlite: no order_event provided for insertion")
	}
	...
	if !cached {
		...
		if len(wl) != 0 {
			...
			cache.query = "INSERT INTO \"order_event\" () VALUES ()%s%s"
		}

		var queryOutput, queryReturning string

		if len(cache.retMapping) != 0 {
			cache.retQuery = fmt.Sprintf("SELECT \"%s\" FROM \"order_event\" WHERE %s", strings.Join(returnColumns, "\",\""), strmangle.WhereClause("\"", "\"", 0, orderEventPrimaryKeyColumns))
		}
	...
	if err != nil {
		return errors.Wrap(err, "sqlite: unable to insert into order_event")
	}
	...
	if err != nil {
		return errors.Wrap(err, "sqlite: unable to populate default values for order_event")
	}
...
func (o *OrderEvent) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("sqlite: unable to update order_event, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "sqlite: unable to update order_event row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "sqlite: failed to get rows affected by update for order_event")
	}
...
func (q orderEventQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "sqlite: unable to update all for order_event")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "sqlite: unable to retrieve rows affected for order_event")
	}
...
func (o OrderEventSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"order_event\" SET %s WHERE %s",
		...
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 0, orderEventPrimaryKeyColumns, len(o)))
	...
	if err != nil {
		return 0, errors.Wrap(err, "sqlite: unable to update all in orderEvent slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "sqlite: unable to retrieve rows affected all in update all orderEvent")
	}
	return rowsAff, nil
}
...
func (o *OrderEvent) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("sqlite: no OrderEvent provided for delete")
	}
	...
	sql := "DELETE FROM \"order_event\" WHERE \"id\"=?"
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "sqlite: unable to delete from order_event")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "sqlite: failed to get rows affected by delete for order_event")
	}
...
func (q orderEventQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("sqlite: no orderEventQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "sqlite: unable to delete all from order_event")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "sqlite: failed to get rows affected by deleteall for order_event")
	}
...
func (o OrderEventSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "sqlite: unable to delete all from orderEvent slice")
	}
...
func (o *OrderEventSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "sqlite: unable to reload all in OrderEventSlice")
	}
...
func OrderEventExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"order_event\" where \"id\"=? limit 1)"
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "sqlite: unable to check if order_event exists")
	}
