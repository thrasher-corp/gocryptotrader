...
var (
	clientDBTypes = map[string]string{`ID`: `UUID`, `UserName`: `VARCHAR(255)`, `Password`: `VARCHAR(255)`, `Email`: `VARCHAR(255)`, `OneTimePassword`: `TEXT`, `Enabled`: `BOOLEAN`, `UpdatedAt`: `TIMESTAMP`, `CreatedAt`: `TIMESTAMP`}
	_             = bytes.MinRead
)
