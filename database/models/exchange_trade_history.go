...
func (o *ExchangeTradeHistory) ExchangeG(mods ...qm.QueryMod) exchangeQuery {
	return o.Exchange(boil.GetDB(), mods...)
}

// Exchange pointed to by the foreign key.
func (o *ExchangeTradeHistory) Exchange(exec boil.Executor, mods ...qm.QueryMod) exchangeQuery {
...
func (exchangeTradeHistoryL) LoadExchange(e boil.Executor, singular bool, maybeExchangeTradeHistory interface{}) error {
...
// SetExchangeG of the exchange_trade_history to the related item.
// Sets o.R.Exchange to related.
// Adds o to related.R.ExchangeTradeHistories.
// Uses the global database handle.
func (o *ExchangeTradeHistory) SetExchangeG(insert bool, related *Exchange) error {
	return o.SetExchange(boil.GetDB(), insert, related)
}

// SetExchangeP of the exchange_trade_history to the related item.
// Sets o.R.Exchange to related.
// Adds o to related.R.ExchangeTradeHistories.
// Panics on error.
func (o *ExchangeTradeHistory) SetExchangeP(exec boil.Executor, insert bool, related *Exchange) {
	if err := o.SetExchange(exec, insert, related); err != nil {
		panic(boil.WrapErr(err))
	}
}

// SetExchangeGP of the exchange_trade_history to the related item.
// Sets o.R.Exchange to related.
// Adds o to related.R.ExchangeTradeHistories.
// Uses the global database handle and panics on error.
func (o *ExchangeTradeHistory) SetExchangeGP(insert bool, related *Exchange) {
	if err := o.SetExchange(boil.GetDB(), insert, related); err != nil {
		panic(boil.WrapErr(err))
	}
}

// SetExchange of the exchange_trade_history to the related item.
// Sets o.R.Exchange to related.
// Adds o to related.R.ExchangeTradeHistories.
func (o *ExchangeTradeHistory) SetExchange(exec boil.Executor, insert bool, related *Exchange) error {
	var err error
	if insert {
	...
	values := []interface{}{related.ExchangeID, o.ExchangeTradeHistoryID}
	...
	if related.R == nil {
		related.R = &exchangeR{
			ExchangeTradeHistories: ExchangeTradeHistorySlice{o},
		}
	} else {
		related.R.ExchangeTradeHistories = append(related.R.ExchangeTradeHistories, o)
	}
