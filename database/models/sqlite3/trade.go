...
var TradeWhere = struct {
	...
	Price:      whereHelperstring{field: "\"trade\".\"price\""},
	Amount:     whereHelperstring{field: "\"trade\".\"amount\""},
...
var (
	...
	tradeColumnsWithoutDefault = []string{"id", "exchange_id", "currency", "asset", "event", "price", "amount", "side"}
