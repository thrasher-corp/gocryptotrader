...
var DatahistoryjobrelationWhere = struct {
	...
	ID:                whereHelpernull_Int64{field: "\"datahistoryjobrelations\".\"id\""},
...
func (q datahistoryjobrelationQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Datahistoryjobrelation, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "sqlite3: failed to execute a one query for datahistoryjobrelations")
	}
...
func (q datahistoryjobrelationQuery) All(ctx context.Context, exec boil.ContextExecutor) (DatahistoryjobrelationSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "sqlite3: failed to assign all query results to Datahistoryjobrelation slice")
	}
...
func (q datahistoryjobrelationQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "sqlite3: failed to count datahistoryjobrelations rows")
	}
...
func (q datahistoryjobrelationQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "sqlite3: failed to check if datahistoryjobrelations exists")
	}
...
func FindDatahistoryjobrelation(ctx context.Context, exec boil.ContextExecutor, iD null.Int64, selectCols ...string) (*Datahistoryjobrelation, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"datahistoryjobrelations\" where \"id\"=?", sel,
	)
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "sqlite3: unable to select from datahistoryjobrelations")
	}
...
func (o *Datahistoryjobrelation) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("sqlite3: no datahistoryjobrelations provided for insertion")
	}
	...
	if !cached {
		...
		if len(wl) != 0 {
			...
			cache.query = "INSERT INTO \"datahistoryjobrelations\" () VALUES ()%s%s"
		}

		var queryOutput, queryReturning string

		if len(cache.retMapping) != 0 {
			cache.retQuery = fmt.Sprintf("SELECT \"%s\" FROM \"datahistoryjobrelations\" WHERE %s", strings.Join(returnColumns, "\",\""), strmangle.WhereClause("\"", "\"", 0, datahistoryjobrelationPrimaryKeyColumns))
		}
	...
	if err != nil {
		return errors.Wrap(err, "sqlite3: unable to insert into datahistoryjobrelations")
	}
	...
	if err != nil {
		return errors.Wrap(err, "sqlite3: unable to populate default values for datahistoryjobrelations")
	}
...
func (o *Datahistoryjobrelation) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("sqlite3: unable to update datahistoryjobrelations, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "sqlite3: unable to update datahistoryjobrelations row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "sqlite3: failed to get rows affected by update for datahistoryjobrelations")
	}
...
func (q datahistoryjobrelationQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "sqlite3: unable to update all for datahistoryjobrelations")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "sqlite3: unable to retrieve rows affected for datahistoryjobrelations")
	}
...
func (o DatahistoryjobrelationSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"datahistoryjobrelations\" SET %s WHERE %s",
		...
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 0, datahistoryjobrelationPrimaryKeyColumns, len(o)))
	...
	if err != nil {
		return 0, errors.Wrap(err, "sqlite3: unable to update all in datahistoryjobrelation slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "sqlite3: unable to retrieve rows affected all in update all datahistoryjobrelation")
	}
	return rowsAff, nil
}
...
func (o *Datahistoryjobrelation) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("sqlite3: no Datahistoryjobrelation provided for delete")
	}
	...
	sql := "DELETE FROM \"datahistoryjobrelations\" WHERE \"id\"=?"
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "sqlite3: unable to delete from datahistoryjobrelations")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "sqlite3: failed to get rows affected by delete for datahistoryjobrelations")
	}
...
func (q datahistoryjobrelationQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("sqlite3: no datahistoryjobrelationQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "sqlite3: unable to delete all from datahistoryjobrelations")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "sqlite3: failed to get rows affected by deleteall for datahistoryjobrelations")
	}
...
func (o DatahistoryjobrelationSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "sqlite3: unable to delete all from datahistoryjobrelation slice")
	}
...
func (o *DatahistoryjobrelationSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "sqlite3: unable to reload all in DatahistoryjobrelationSlice")
	}
...
func DatahistoryjobrelationExists(ctx context.Context, exec boil.ContextExecutor, iD null.Int64) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"datahistoryjobrelations\" where \"id\"=? limit 1)"
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "sqlite3: unable to check if datahistoryjobrelations exists")
	}
