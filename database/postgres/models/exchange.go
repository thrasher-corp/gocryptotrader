...
func (o *Exchange) ClientOrderHistories(mods ...qm.QueryMod) clientOrderHistoryQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"client_order_history\".\"exchange_id\"=?", o.ID),
	)
...
func (exchangeL) LoadClientOrderHistories(ctx context.Context, e boil.ContextExecutor, singular bool, maybeExchange interface{}, mods queries.Applicator) error {
	var slice []*Exchange
	var object *Exchange
	...
	query := NewQuery(qm.From(`client_order_history`), qm.WhereIn(`exchange_id in ?`, args...))
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *Exchange) AddClientOrderHistories(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*ClientOrderHistory) error {
	var err error
