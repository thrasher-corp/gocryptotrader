...
func TestUpdateAccountInfo(t *testing.T) {
	...
	updateResponse, err := s.UpdateAccountInfo(context.Background(), &gctrpc.GetAccountInfoRequest{Exchange: engine.fakePassExchange, AssetType: asset.Futures.String()})
	if err != nil {
