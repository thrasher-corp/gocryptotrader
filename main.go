...
func main() {
	...
	err = currency.SeedCryptocurrencyMarketData(coinmarketcap.Settings(bot.config.GetCurrencyProviderConfig()))
	if err != nil {
	...
	err = currency.SeedExchangeMarketData(coinmarketcap.Settings(bot.config.GetCurrencyProviderConfig()))
	if err != nil {
