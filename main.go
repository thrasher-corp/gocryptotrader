...
func main() {
	...
	flag.DurationVar(&settings.ExchangeShutdownTimeout, "exchangeshutdowntimeout", time.Second*10, "flag defines the maximum amount of time the program will wait for an exchange to shut down gracefully")
