...
LINTPKG = github.com/golangci/golangci-lint/v2/cmd/golangci-lint@v2.13.0
...
lint_docker:
	...
	docker run --rm -t -v $(CURDIR):/app -w /app golangci/golangci-lint:v2.13.0 golangci-lint run --verbose
