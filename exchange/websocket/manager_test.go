...
func TestDial(t *testing.T) {
	...
	for i := range testCases {
		...
		err := testCases[i].WC.DialContext(t.Context(), &gws.Dialer{}, http.Header{})
		if err != nil {
...
func TestSendMessage(t *testing.T) {
	...
	for x := range testCases {
		...
		err := testCases[x].WC.DialContext(t.Context(), &gws.Dialer{}, http.Header{})
		if err != nil {
...
func TestSendMessageReturnResponse(t *testing.T) {
	...
	err := wc.DialContext(t.Context(), &gws.Dialer{}, http.Header{})
	if err != nil {
		t.Fatal(err)
	}
...
func TestConnectionShutdown(t *testing.T) {
	...
	err = wc.DialContext(t.Context(), &gws.Dialer{}, nil)
